<?php
/* Template Name: PageAlyuminijPeregorodki */
get_header();
?>
...
<div class="main page-aluminum-product">
   ...
   <section class="section-top-page">
      <div class="container">
         ...
         <h2 class="title-section">Алюминиевые перегородки в Киеве</h2>
         <div class="block-img-flout clearfix">
            <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/alyuminievye-peregorodki.ab4682aa.jpg" class="img-fluid" alt="photo-product"></div>
             <p>
                 Алюминиевые перегородки выглядят презентабельно и изящно. Они могут устанавливаться в квартирах, жилых домах,
                 офисных помещениях, административных учреждениях. Компания «Виндовс Груп» предлагает купить алюминиевые перегородки в Киеве
                 и области по лучшим ценам. В каталогах представлены практичные и надежные модели разных цветов и размеров, с индивидуальным дизайном.
             </p>
             <p>
                 Прочные алюминиевые конструкции используются в жилых помещениях в качестве межкомнатных перекрытий, в офисах для разделения рабочих мест. Также ограждения применяются для разделения пространства в торговых центрах, шоу-румах, художественных галереях, санитарных узлах, на складских и выставочных площадках.
             </p>
         </div>
   ...
   <section class="section-preference">
      <div class="container">
         <h2 class="title-section">Преимущества Алюминиевых Перегородок</h2>
   ...
   <section class="section-text">
      <div class="container">
          <h2 class="title-section">Особенности</h2>
          <p>
              Перегородки состоят из нескольких самостоятельно передвигаемых секций. При помощи отдельных элементов создается изолируемое пространство, позволяющее эффективно разделить площадь.
          </p>
          <p>
              Секции из алюминия поддерживаются штекерами, прикрепленными к полу, потолку, стенам помещения. Удобство профилей заключается в безтрековом передвижении. Устройство может быть подвесным, что исключает затрагивание напольного покрытия.
          </p>
          <p>
              Алюминиевый профиль может заполняться полотном со сниженной прозрачностью. Для усиления прочности и звукоизоляции используется закаленное стекло. Такое наполнение делает внутреннее пространство не просматриваемым. Для большей декоративности применяется стекло с тонировкой, разными узорами и рисунками.
          </p>
      </div>
   </section>
    ...
    <section class="section-post section-post-windows section-other-type-windows">
        <div class="container">
            ...
            <div class="text-custom-page">
                <p>Алюминиевые перегородки обладают несколькими преимуществами:</p>
                <ol>
                    <li>	Эстетичностью (легкостью и изящностью).</li>
                    <li>	Высокими эксплуатационными свойствами.</li>
                    <li>	Легкой разборкой и монтажом.</li>
                    <li>	Простотой ухода.</li>
                    <li>	Долговечностью и надежностью.</li>
                </ol>
                <p>Перегородки из алюминия имеют низкую стоимость в сравнении с изделиями из другого материала.</p>
                <h2 class="title-post">Виды</h2>
                <p>Различаются несколько видов алюминиевых перегородок по способу крепления и виду заполнения.</p>
                ...
                <p>
                    Безрамные перегородки представляют собой стеклянную вставку в зажимном профиле, прикрепленном по периметру рабочей зоны. Стеклянное полотно больших размеров дополнительно фиксируется горизонтальными ребрами жесткости.
                </p>
                <p>
                    Передвижные конструкции перемещаются по нижней направляющей каркаса. Фиксация ограждения осуществляется посредством стопоров. Передвижной тип используется для разделения рабочих зон в офисных помещениях.
                </p>
                <p>
                    Стационарные разновидности ограждения прикрепляются плотно по всему предполагаемому периметру. Бывают одно- и двухслойными. Однослойный вид может заполняться сплошными или частично непрозрачными вставками. В двухслойном типе присутствует утолщенный жесткий алюминиевый профиль. Имеется прозрачное, глухое или комбинированное заполнение.
                </p>
                <p>
                    Мобильные перегородки бывают ровными или ломаными. Конструкции применяются в офисах, квартирах-студиях, когда требуется оперативное разделение помещения на зоны. При отделении пространства сохраняется простота коммуникации. Перемещение мобильных ограждений осуществляется за счет передвижения шасси, которое при необходимости можно заблокировать.
                </p>
                <p>
                    Раздвижные перегородки открываются путем складывания вдвое по принципу дверей-купе, механизма «гармошки». При перемещении полотно отодвигается вдоль стены или складывается в установленную специальную кассету. Раздвижные конструкции отличаются высокой функциональностью и умеренной стоимостью.
                </p>
                <h2 class="title-post"> Габариты</h2>
                <p>
                    Изготовить перегородки из алюминия можно по индивидуальному эскизу с учетом размеров проема. Вес зависит от используемого материала и стекла.
                </p>
                <p>
                    Стационарные перегородки достигают в высоту от 6 до 7 м. Мобильные конструкции изготавливаются высотой более 2,2 м.
                </p>
                <p>
                    Для широких проемов подбирается раздвижная телескопическая система длиной 6 м. При перемещении задействовано несколько полотен. Установка конструкции позволяет заполнить длину проема до 10 м. Перегородки отличаются большим весом. Длина направляющих составляет до 3 м.
                </p>


                <h2 class="title-post">Изготовление и монтаж</h2>
                <p>
                    Алюминиевая перегородка состоит из нескольких профилей, зафиксированных между собой стальными уголками. Конструкция выполняет функцию несущего элемента. Прочность металла достигается путем его уплотнения под высоким давлением. Декоративный профиль окрашивается износостойкой полимерной краской. Для заполнения алюминиевых модулей применяются прозрачные модули (поликарбонат, закаленное стекло, стекло), глухие модули (гипсоламин, гипсокартон, ЛДСП).
                </p>
                <p>
                    Для уличных алюминиевых ограждений и входных групп применяется двойное или тройное остекление. По уровню тепло- и шумоизоляции практически не отличается от стационарных конструкций. Установка резинового уплотнителя позволяет обустроить тихую отдельную зону.
                </p>
                <p>
                    Использование качественной фурнитуры обеспечивает долговечность конструкции при интенсивной эксплуатации. Мы предлагаем заказать изготовление алюминиевых перегородок в Киеве с гарантией, монтажом по выгодной стоимости. Узнать цены можно в прайсе на сайте или позвонив по телефону.
                </p>
            </div>
        </div>
    </section>
   <section class="section-other-section windows">
      <div class="container">
         ...
         <ul class="list">
            <li>
               <a href="<?=get_bloginfo('home')?>/alyuminij/okna/">
                  <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/alyuminievye-okna.04000dca.jpg" class="img-fluid" alt="product"></div>
                  <span class="block-title">Алюминиевые<br/>окна</span>
               </a>
            </li>
            <li>
