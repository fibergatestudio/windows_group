...
<div class="main page-windows">
    ...
    <section class="section-calculator">
        <div class="container">
            <div class="top-post-page">
                <h1 class="title-post  mb-lg-3">Пластиковые окна в Броварах: цена с установкой</h1>
                <p class="text-custom-page">Компания «Windows Group» предлагает установку <span class="strong-text">пластиковых окон в Броварах</span> «под ключ». Ежегодно спрос на металлопластиковые конструкции увеличивается на 3-5%. Их ставят в частных и многоквартирных домах, коммерческих и офисных зданиях. Мы предлагаем быстрый монтаж и доступные цены на металлопластиковые окна и двери с гарантией качества. Для всех жителей Украины – бесплатная консультация. </p>
                <p class="text-custom-page">Поменять окна при ремонте – важный шаг, позволяющий обновить жилье и сделать пребывание в нем более комфортным. Выбору ПВХ конструкций необходимо уделить особое внимание, поскольку оконные конфигурации отвечают не только за визуальное оформление, но и за энергосбережение дома.</p>
            </div>
            <h2 class="title-section">Калькулятор Окон в Броварах</h2>
    ...
    <section class="section-slider-type-profil">
        ...
        <?php 
            ...
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_v_brovarakh' ");
    ...
    <section class="section-post section-post-windows  post-page-agency">
        <div class="container">
            <h2 class="title-section">Преимущества пластиковых окон</h2>
            <p class="mb-2">Оконные системы из ПВХ характеризуются следующими преимуществами:</p>
            <ol>
                <li>Лояльные цены на пластиковые окна. Поливинилхлоридные конструкции – более доступный вариант, по сравнению с деревянными или алюминиевыми вариантами. Стоимость металлопластиковых окон может быть в 3-4 раза ниже.</li>
                <li>Энергоэффективность. Установка окон ПВХ позволяет сохранить тепло в квартире, не пропуская его наружу. При правильном выборе стеклопакета, дверей (если речь идет об установке модуля на балкон), можно снизить расходы на отопление дома.  </li>
                <li>Долговечность. Наши оконные системы устойчивы к любым внешним воздействиям, в том числе температурным перепадам. Высокопрочный металлопластик не восприимчив к ультрафиолетовому излучению и атмосферным осадкам. При правильном и своевременном обслуживании наши профильные системы прослужат не менее 20 лет.</li>
                <li>Звукоизоляция. Заказать металлопластиковые окна в «Windows Group» - значит защитить свое жилье от проникновения шума с улицы. Наличие нескольких контуров уплотнения обеспечивает высокие звукоизоляционные качества.</li>
                <li>Большой выбор декоративных покрытий и форм. Это могут быть как классические прямоугольные, так и квадратные окна, стандартные белые или коричневые, серые, зеленые и т. д. Наш дизайнер поможет подобрать цвет с учетом экстерьера и интерьера вашего помещения.</li>
            </ol>
            <p class="mb-2">Пластиковые конструкции позволяют воплотить в жизнь практически любые дизайнерские решения. Цена на оконные рамы в Украине будет зависеть от особенностей и сложности проекта.</p>
            <h2 class="title-post">Как заменить металлопластиковые окна</h2>
            <p class="mb-2">Если вы решили купить металлопластиковые окна, мы будем сотрудничать по следующему алгоритму:</p>
            <ol>
                <li>Оформление заявки. Клиент оставляет заявку на сайте или связывается с менеджером. Наш специалист перезванивает заказчику для уточнения деталей.</li>
                <li>Снятие замеров. Замерщик «Windows Group» выезжает на объект в удобное для вас время, чтобы снять размеры и просчитать предварительную стоимость.</li>
                <li>Выбор цвета и составление проекта. Колорист нашей компании поможет с выбором цвета пластикового окна.</li>
                <li>Составление договора. Для изготовления качественных окон мы используем производственные мощности на собственном заводе. Как только мы получаем предоплату, на предприятии начинается сборка металлоконструкций по вашему проекту.  </li>
                <li>Выполнение заказа. В среднем изготовление и установка пластиковых окон в Броварах занимает не более 2-3 рабочих дней.</li>
                <li>Доставка и монтаж. Комплектующие доставляются со склада или завода на объект. При необходимости производится демонтаж старого оконного блока. Специалисты нашей компании заранее сообщат о готовности установить окна. </li>
            </ol>
            <p class="mb-2">При производстве каждого квадратного метра стеклопакетов строго соблюдаются европейские требования и стандарты качества. Мы уверены в прочности и долговечности наших ПВХ-окон, поэтому дадим гарантию не менее 10 лет на изделия и 5 лет – на работу.</p>
            <h3 class="title-post">Преимущества сотрудничества с нами</h3>
            <p class="mb-2">Причины купить пластиковые окна на балкон или в комнату в «Windows Group»:</p>
            <ol>
                <li>Качество. Наши ПВХ-конструкции надежные, практичные и долговечные. Профили Rehau и других европейских производителей выдерживают высокие нагрузки и не деформируются при длительной эксплуатации.</li>
                <li>Огромный опыт. Мы занимаемся заменой окон в Броварах и Киеве более 20 лет. За это время нашими услугами воспользовались более 100 тысяч жителей столицы и близлежащих городов. «Windows Group» является лидером в сфере продаж и установки пластиковых окон под ключ.</li>
                <li>Стоимость. Доступные цены на пластиковые окна с завода обусловлены использованием собственных мощностей при сборке, а также тесным сотрудничеством с ведущими производителями ПВХ-конструкций из Германии, Швейцарии и т. д. Мы не переплачиваем посредникам, поэтому наши окна стоят дешевле, чем продукция конкурентов.</li>
                <li>Выгодные условия сотрудничества. Мы предлагаем бесплатный расчет стоимости, скидки для постоянных клиентов и возможность покупки окон в рассрочку под 0%. «Windows Group» всегда идет навстречу своим заказчикам. </li>
                <li>Помощь в подборе. Мы остаемся лидером продаж ПВХ окон за счет того, что гарантируем индивидуальный подход к каждому клиенту. Наш менеджер проконсультирует вас по всем деталям, включая описание всех этапов установки, и поможет рассчитать стоимость услуги в соответствии с особенностями проекта. </li>
            </ol>
            <p class="mb-2">Чтобы получить бесплатную консультацию, свяжитесь с нами по указанному номеру телефона или оставьте заявку на сайте.</p>
            <h2 class="title-post">Виды и критерии выбора окон на балкон</h2>
            <p class="mb-2">Металлопластиковые окна классифицируются по следующим параметрам:</p>
            <ul class="list-style-disc">
                <li>форма (прямоугольная, квадратная, арочная, стрельчатая и т. д.);</li>
                <li>тип открывания – глухое, открывающееся, Т-образное, трехстворчатое, фрамужное;</li>
                <li>тип профиля – стеклопакеты могут быть недорогими (одно- и двухкамерные) или энергосберегающими, с возможностью сохранения тепла в помещении.</li>
            </ul>

            <h2 class="title-post">Как рассчитать стоимость остекления в Броварах</h2>
            <p class="mb-2">Чтобы рассчитать стоимость окна на заказ, воспользуйтесь калькулятором на нашем сайте. Цена услуги зависит от ряда факторов. Чтобы узнать, сколько стоит ПВХ-конструкция, укажите размеры и тип открытия.</p>
            <p class="mb-2">Если хотите недорого заменить окна, заранее определитесь со следующими критериями:</p>
            <ol>
                <li>Форма конструкции. Разумеется, стоимость панорамного остекления будет выше, чем установка одиночного окна.</li>
                <li>Конфигурация. Тип ПВХ-конструкции также зависит от назначения – для квартиры, коттеджа, коммерческого помещения, офиса.</li>
                <li>Выбор профиля и способ установки. Швейцарские профили Rehau, изделия от немецких производителей ценятся выше за счет высокого качества сборки и прочности. Для установки может использоваться монтажная пена или нестандартные материалы.</li>
                <li>Тип фурнитуры. Базовая комплектация включает стандартные оконные ручки и петли. ПВХ-окно можно комплектовать усиленной фурнитурой, москитной сеткой, тонированным стеклопакетом.</li>
            </ol>
            <p class="mb-2">Дополнительно мы предлагаем установку отливов, подоконников, роллет, систем защиты от взлома недорого и т. д.</p>
