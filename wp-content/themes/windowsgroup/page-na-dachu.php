...
<div class="main page-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
            <h1 class="title-post">ПВХ (пластиковые) окна на дачу в Киеве – цены</h1>
            <p class="text-custom-page">Пластиковые окна прекрасно дополнят интерьер дачи, делая ее комфортной и уютной.
                Оконные конструкции подбираются с учетом сезона проживания, дизайна дачного дома,
                требований безопасности, энергосбережения и шумоизоляции.</p>
             <p class="text-custom-page">Компания “Виндовс Груп” предлагает купить окна для дачи в Киеве и области по лучшим ценам с гарантией качества.
                В каталоге представлены пластиковые изделия с различными функциональными характеристиками.</p>
         </div>
         
         <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_na_dachu' ");
      ...
      <div class="container">
         ...
         <ul class="list-top-product">
            ...
            <li class="block-item-product">
               ...
               <p>Безопасность ваших детей - превыше всего</p>
            </li>
         </ul>
      </div>
   </section>
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Особенности окон для дачи</h2>
         <p>Качественные и недорогие пластиковые окна на дачу – оптимальное решение для остекления приусадебного домика. Выбирая оконные конструкции, необходимо обращать внимание на некоторые моменты:</p>
         <ol>
            <li>Перед заказом ПВХ-изделия следует учитывать материал, из которого построен дом. В постройках из блока или кирпича монтаж проводится сразу, в деревянных – требуется время для усадки строения.</li>
            <li>В выборе размера учитывается температура помещения. Панорамные конструкции используются в отапливаемых постройках с большой площадью. В неотапливаемых домиках предпочтительнее устанавливать небольшие конструкции.</li>
            <li>Защита от несанкционированного доступа обеспечивается за счет противовзломной фурнитуры. Дополнительно могут устанавливаться защитные элементы: ставни, решетки или роллеты.</li>
            <li>Наличие наружных отливов служит защитой для стен от попадания влаги. Ширина отливов подбирается с учетом толщины стены.</li>
         </ol>
         <p>Оконные конструкции могут заказываться в различном цветовом исполнении с наружной, внутренней, двусторонней ламинацией. В качестве дополнительных элементов для готовых ПВХ окон для дачи используются противомоскитные сетки, откосы, жалюзи.</p>
         <h2 class="title-post">Как выбрать окна для дачи</h2>
         <p>Пластиковые окна для дачного дома помогают сэкономить на отоплении в зимний сезон, а также защитить постройку от перегрева в летний зной. Думать о том, какие оконные конструкции подходят, необходимо на этапе проектирования приусадебного домика.</p>
         <h2 class="title-post">При выборе недорогих окон на дачу следует учитывать несколько рекомендаций:</h2>
         <ol>
            <li>Важно определиться с типом и формой будущего изделия. Для веранды или террасы используются оконные конструкции с открывающимися створками с функцией проветривания. Глухие системы актуальны в подсобных помещениях, где нет необходимости в проветривании. При обустройстве мансардного этажа применяются нестандартные оконные формы в виде круга, трапеции или треугольника.</li>
            <li>Для летних построек используются однокамерные стеклопакеты для дачи. Для отдыха зимой потребуются конструкции с двухкамерными стеклопакетами и энергосберегающими опциями.</li>
            <li>При панорамном остеклении стекла должно быть противоударными.</li>
            <li>Чтоб обезопасить детей от случайного выпадения, устанавливаются стеклопакеты с триплексом. Дополнительно осуществляется монтаж специальной фурнитуры.</li>
         </ol>
         <p>Прочность окна на дачу, срок его эксплуатации зависит от качества и жесткости пластика. Профильная система рамы должна быть многокамерной на металлическом каркасе.</p>
         <h2 class="title-post">Наши преимущества</h2>
         <p>Компания “Windows Group” предлагает купить пластиковые окна для дачи недорого со следующими преимуществами:</p>
         <ol>
            <li>Заказом качественного оконного профиля с защитой от деформации и выцветания.</li>
            <li>Использованием качественной фурнитуры, что гарантирует надежное использование оконной конструкции.</li>
            <li>Возможностью изготовления изделий разнообразной формы, дизайна и типа открывания.</li>
            <li>Осуществлением демонтажа старой и установки новой конструкции.</li>
            <li>Дополнительной установкой аксессуаров (ламинации, подоконников, отливов).</li>
         </ol>
         <p>Наши специалисты готовы осуществить замеры оконного проема для последующего изготовления евроокна.</p>
         <h2 class="title-post">Цены на пвх окна на дачу</h2>
         <p>Точные цены на окна для дачи определяются с учетом следующих особенностей:</p>
         <ul>
            <li>· размера;</li>
            <li>· расцветки;</li>
            <li>· формы;</li>
            ...
            <li>· вспомогательных опций;</li>
            <li>· условия доставки;</li>
            <li>· особенностей монтажа.</li>
         </ul>
         <p>Окончательная стоимость рассчитывается после проведения замера и составления эскиза будущего пластикового изделия, а также согласования технических нюансов. Дополнительно проконсультироваться по заказу можно на сайте или позвонив по телефону.</p>
      </div>
   </section>
