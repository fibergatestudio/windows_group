...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
             <h1 class="title-post">Треугольные ПВХ (пластиковые) окна в Киеве – цены</h1>
             <p class="text-custom-page">Треугольное окно поможет подчеркнуть современный экстерьер здания и выделить его на фоне других строений.
                 Нестандартная оконная конструкция с полноценной функциональностью является универсальной в применении.
                 Компания «Windows Group» предлагает заказать качественные треугольные окна от производителя по выгодным ценам.</p>
         </div>

         <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_treugolniye' ");
            $price_obj = json_decode($result_params[0]->data);
         
         ?>
         
         <div class="block-windows-type-1">
            <h2 class="title-block-type-windows">Треугольное Окно</h2>
            <span class="small-title">Размер 1000 х 1000 мм, Цена от <span class="min-price"><?=$price_obj->treugolnoye_1->min?></span> грн до <span class="max-price"><?=$price_obj->treugolnoye_1->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-open">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->treugolnoye_1 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-open" role="tabpanel" aria-labelledby="<?=$key_w?>-open">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/triangular-type-1.6edb6c9c.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->treugolnoye_1->$key_w;
                              $j = 0;
         ...
         <div class="block-windows-type-2">
            <h2 class="title-block-type-windows">Треугольное Окно</h2>
            <span class="small-title">Размер 1000 х 1000 мм, Цена от <span class="min-price"><?=$price_obj->treugolnoye_2->min?></span> грн до <span class="max-price"><?=$price_obj->treugolnoye_2->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->treugolnoye_2 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>" role="tabpanel" aria-labelledby="<?=$key_w?>">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/triangular-type-2.dc3a27a5.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->treugolnoye_2->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-3">
            <h2 class="title-block-type-windows">Треугольное Окно</h2>
            <span class="small-title">Размер 1000 х 700 мм, Цена от <span class="min-price"><?=$price_obj->treugolnoye_3->min?></span> грн до <span class="max-price"><?=$price_obj->treugolnoye_3->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-3">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->treugolnoye_3 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-3" role="tabpanel" aria-labelledby="<?=$key_w?>-type-3">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/triangular-type-3.0b8f8e5f.png" class="mt-lg-5 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->treugolnoye_3->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-4">
            <h2 class="title-block-type-windows">Треугольное Окно</h2>
            <span class="small-title">Размер 1000 х 700 мм, Цена от <span class="min-price"><?=$price_obj->treugolnoye_4->min?></span> грн до <span class="max-price"><?=$price_obj->treugolnoye_4->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-4">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->treugolnoye_4 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-4" role="tabpanel" aria-labelledby="<?=$key_w?>-type-4">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/triangular-type-4.ec49b7e9.png" class="mt-lg-5 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->treugolnoye_4->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-5">
            <h2 class="title-block-type-windows">Треугольное Окно</h2>
            <span class="small-title">Размер 1000 х 700 мм, Цена от <span class="min-price"><?=$price_obj->treugolnoye_5->min?></span> грн до <span class="max-price"><?=$price_obj->treugolnoye_5->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-5">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->treugolnoye_5 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-5" role="tabpanel" aria-labelledby="<?=$key_w?>-type-5">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/triangular-type-5.b8b1decc.png" class="mt-lg-5 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->treugolnoye_5->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-6">
            <h2 class="title-block-type-windows">Треугольное Окно</h2>
            <span class="small-title">Размер 1000 х 700 мм, Цена от <span class="min-price"><?=$price_obj->treugolnoye_6->min?></span> грн до <span class="max-price"><?=$price_obj->treugolnoye_6->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-6">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->treugolnoye_6 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-6" role="tabpanel" aria-labelledby="<?=$key_w?>-type-6">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/triangular-type-6.8ca6ee60.png" class="mt-lg-5 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->treugolnoye_6->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-7">
            <h2 class="title-block-type-windows">Треугольное Окно</h2>
            <span class="small-title">Размер 1000 х 1000 мм, Цена от <span class="min-price"><?=$price_obj->treugolnoye_7->min?></span> грн до <span class="max-price"><?=$price_obj->treugolnoye_7->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-7">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->treugolnoye_7 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-7" role="tabpanel" aria-labelledby="<?=$key_w?>-type-7">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/triangular-type-7.32307306.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->treugolnoye_7->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Особенности треугольных окон</h2>
         <p>Оконные конструкции бывают следующей формы:</p>
         <ul>
            <li>· прямоугольными;</li>
            <li>· в виде равностороннего треугольника;</li>
            <li>· в виде равнобедренного треугольника.</li>
         </ul>
         <p>Треугольные окна могут являться самостоятельным элементом или выступать в качестве дополнения основного оконного блока. Евроокна отличаются габаритами и разновидностью конструкции.</p>
         <p>В зависимости от способа открывания бывают следующие модели:</p>
         <ol>
            <li>Глухие – не открываются, не используются для проветривания. Главным достоинством глухих евроокон является высокая степень светопропуска. Из недостатков выделяется труднодоступность внешнего стекла для мытья. Минимальная величина глухой конструкции – 15 градусов.</li>
            <li>Распашные – оснащены двумя рабочими створками, открывающимися вниз или в стороны. По предпочтениям клиента возможна установка двух вариантов открывания. Минимальная величина угла распашных окон составляет 30 градусов.</li>
            <li>Поворотно-откидные – створки открываются в горизонтальном или вертикальном положении. Евроокна функционируют в обычном и откидном виде.</li>
         </ol>
         <p>Дополнительно могут изготавливаться конструкции фрамужного типа. Они используются исключительно для проветривания. Оконные створки распахиваются в горизонтальном и вертикальном направлении.</p>
         <h2 class="title-post">Преимущества</h2>
         <p>Треугольные пластиковые окна характеризуются следующими преимуществами:</p>
         <ul>
            <li>· высокой звуко- и теплоизоляцией;</li>
            <li>· защитой от прямых лучей солнца;</li>
            <li>· отличной герметичностью;</li>
            <li>· возможностью открывания створок в разных направлениях.</li>
         </ul>
         <p>По функциональности изделия ничем не отличаются от стандартных оконных моделей.</p>
         <h2 class="title-post">Кому подойдут и где лучше использовать</h2>
         <p>Треугольные окна ПВХ идеально подходят для домов со скатной крышей с высоким коньком. Конструкции в виде треугольника позволяют делать панорамное остекление под крышу для улучшения освещения чердака.</p>
         <p>Для современных неординарных интерьеров используются оконные модели со скошенной вершиной, без установки подоконника.</p>
         <p>Конструкции сочетаются с затемненными и силуэтными жалюзи-плиссе. Стеклопакеты идеально смотрятся с классическими шторами, закрепленными на прямом карнизе.</p>
         <h2 class="title-post">Стоимость</h2>
         <p>Цена треугольного окна складывается с учетом нескольких факторов:</p>
         <ul>
            <li>· материала профиля;</li>
            <li>· фурнитуры;</li>
            <li>· стеклопакета;</li>
            <li>· способа декорирования;</li>
            <li>· дополнительных элементов.</li>
         </ul>
         <p>Наша компания «Виндовс Груп» предлагает купить треугольные окна в Киеве и Киевской области по лучшей цене. Узнать предварительную стоимость можно в прайс-листе на сайте или, позвонив по телефону.</p>
      </div>
   </section>
      ...
      <div class="container">
         ...
         <ul class="list-other-type-windows">
            <li class="item-other-type-windows">
               <div class="block-img-other p-0"><img src="<?php bloginfo('template_url') ?>/images/plastikovye-okna.8caa82bf.webp" class="p-4 img-fluid" alt="photo"></div>
               <a href="<?=get_bloginfo('home')?>/plastikovye-okna/" class="title-footer">Окна</a>
            </li>
