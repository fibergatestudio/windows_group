...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
            <h1 class="title-post">Овальные ПВХ (пластиковые) окна в Киеве – цены</h1>
            <p class="text-custom-page">Овальные окна являются нестандартным и неброским дизайнерским решением.
                При этом изделия полностью соответствуют необходимым требованиям безопасности и качества.
                Компания «Виндовс Груп» предлагает купить овальные окна с гарантией в Киеве и Киевской области по выгодным ценам.</p>
         </div>

         <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_ovalniye' ");
            $price_obj = json_decode($result_params[0]->data);
         
         ?>
         
         <div class="block-windows-type-1">
            <h2 class="title-block-type-windows">Овальное Глухое Окно</h2>
            <span class="small-title">Размер 2000 х 1000 мм, Цена от <span class="min-price"><?=$price_obj->ovalnoye_gluhoe->min?></span> грн до <span class="max-price"><?=$price_obj->ovalnoye_gluhoe->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-open">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->ovalnoye_gluhoe as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-open" role="tabpanel" aria-labelledby="<?=$key_w?>-open">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/oval-windows-close.8791fe72.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->ovalnoye_gluhoe->$key_w;
                              $j = 0;
         ...
         <div class="block-windows-type-2">
            <h2 class="title-block-type-windows">Овальное Окно с Одним Открытием</h2>
            <span class="small-title">Размер 2000 х 1000 мм, Цена от <span class="min-price"><?=$price_obj->ovalnoye_1->min?></span> грн до <span class="max-price"><?=$price_obj->ovalnoye_1->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->ovalnoye_1 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>" role="tabpanel" aria-labelledby="<?=$key_w?>">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/oval-windows-one-open.71bdb715.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->ovalnoye_1->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <!-- <div class="block-windows-type-3">
            <h2 class="title-block-type-windows">Овальное Окно с Двумя Открываниями</h2>
            ...
            <div class="tab-content" id="myTabContent-type-3">
               <div class="tab-pane fade show active" id="wds-type-3" role="tabpanel" aria-labelledby="wds-type-3">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/oval-windows-two-open.30a122d0.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-windows-type-4">
            <h2 class="title-block-type-windows">Овальное Окно</h2>
            <span class="small-title">Размер 2000 х 1000 мм, Цена от <span class="min-price"><?=$price_obj->ovalnoye->min?></span> грн до <span class="max-price"><?=$price_obj->ovalnoye->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-4">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->ovalnoye as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-4" role="tabpanel" aria-labelledby="<?=$key_w?>-type-4">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/oval-windows.8641252c.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->ovalnoye->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Особенности овальных окон</h2>
         <p>При производстве рам ПВХ применяется сгибание профиля. Изгибы делаются в двух профилях по центру, а края запаиваются. Для защиты от внешней деформации присутствуют ограничения по минимальному диаметру створок: для глухих– 0,7 м, для активных– 0,8 м.</p>
         <p>Окна овальной формы вытягиваются по вертикали и горизонтали, в зависимости от предпочтений клиента и особенностей помещения.</p>
         <h2 class="title-post">Преимущества</h2>
         <p>Овальные пластиковые окна характеризуются следующими преимуществами:</p>
         <ul>
            <li>· высоким уровнем шумоизоляции и герметичности;</li>
            <li>· прочностью;</li>
            <li>· надежностью;</li>
            <li>· длительным сроком эксплуатации.</li>
         </ul>
         <p>ПВХ изделия могут окрашиваться в различные цвета. Ламинация пластиковых оконных конструкций защитит поверхность от температурных перепадов и попадания влаги.</p>
         <h2 class="title-post">Кому подойдут и где лучше использовать</h2>
         <p>Овальные окна ПВХ бывают следующих видов:</p>
         <ul>
            <li>· цельные или глухие;</li>
            <li>· разделенные;</li>
            <li>· полукруглые;</li>
            <li>· дуплексные окна-овал.</li>
         </ul>
         <p>Глухие конструкции не открываются и не применяются для проветривания. Используются в качестве дополнения основного оконного блока и по цене дешевле остальных овальных евроокон. Встречаются в санитарных узлах, на мансардных этажах и лестничных проемах.</p>
         <p>В разделенных моделях оконная система разделяется на части с помощью импостов. Одна половина конструкции представлена глухой, а другая – рабочей. Данный тип применяется в небольших кабинетах.</p>
         <p>Полукруглые пластиковые изделия чаще применяются в виде декоративного элемента. В основном, устанавливаются над стандартной оконной системой для получения арки. Большие створки изготавливаются активными, а маленькие – глухими.</p>
         <p>Полукруглые евроокна размещаются в гаражах, библиотеках, офисах, на цокольных этажах зданий.</p>
         <p>Дуплексные окна-овалы чаще всего глухие, оснащены двумя импостами, размещающимися параллельно друг другу. При этом импосты разделяют оконный блок на четыре функциональных части. Дуплексные модели применяются в торговых и бизнес-центрах, административных учреждениях.</p>
         <h2 class="title-post">Стоимость</h2>
         <p>Цена овального окна зависит от нескольких критериев:</p>
         <ul>
            <li>· вида профильной системы;</li>
            <li>· механизма открывания створок;</li>
            <li>· разновидности декора;</li>
            <li>· типа стеклопакета;</li>
            <li>· дополнительных элементов (рольшторы, жалюзи, решетки, откосы, подоконники, защита от детей).</li>
         </ul>
         <p>Наша компания «Windows Group» предлагает купить овальные окна в Киеве от лучших производителей по доступным ценам. Узнать стоимость на оконные конструкции можно на сайте или, позвонив по телефону.</p>
      </div>
   </section>
   <section class="section-other-type-windows">
      <div class="container">
         ...
         <ul class="list-other-type-windows">
            ...
            <li class="item-other-type-windows">
               <div class="block-img-other"><img src="<?php bloginfo('template_url') ?>/images/plastikovye-okna.8caa82bf.webp" class="not-all-img img-fluid" alt="photo"></div>
