...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
            <h1 class="title-post">Эркерные ПВХ (пластиковые) окна в Киеве – цены</h1>
             <p class="text-custom-page">Эркерное окно – это выступающая часть фасада, остекленная частично или полностью. Особенностью конструкции является две и более застекленных и соединенных между собой створки. По форме эркеры бывают разными: от треугольных до многогранных. Дизайн архитектурных элементов является элегантным и усложненным.</p>
             <p class="text-custom-page">Наша компания «Виндовс Груп» предлагает заказать эркерные оконные модели в Киеве и области по лучшим ценам.
                 Мы гарантируем широкий выбор, качество товара и лучшее обслуживание клиентов.</p>
         </div>

         <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_erkerniye' ");
            $price_obj = json_decode($result_params[0]->data);
         
         ?>
         
         <div class="block-windows-type-1">
            <h2 class="title-block-type-windows">Эркерные Окна</h2>
            <span class="small-title">Размер 3900 х 1350 мм, Цена от <span class="min-price"><?=$price_obj->erkernoye_1->min?></span> грн до <span class="max-price"><?=$price_obj->erkernoye_1->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-open">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->erkernoye_1 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-open" role="tabpanel" aria-labelledby="<?=$key_w?>-open">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/erker-type-1.db32659f.png" class="mt-lg-5 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->erkernoye_1->$key_w;
                              $j = 0;
         ...
         <div class="block-windows-type-2">
            <h2 class="title-block-type-windows">Эркерные Окна</h2>
            <span class="small-title">Размер 3900 х 1750 мм, Цена от <span class="min-price"><?=$price_obj->erkernoye_2->min?></span> грн до <span class="max-price"><?=$price_obj->erkernoye_2->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->erkernoye_2 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>" role="tabpanel" aria-labelledby="<?=$key_w?>">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/erker-type-2.5ceb4901.png" class="mt-lg-5 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->erkernoye_2->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-3">
            <h2 class="title-block-type-windows">Эркерные Окна</h2>
            <span class="small-title">Размер 1100 х 1350 мм, Цена от <span class="min-price"><?=$price_obj->erkernoye_3->min?></span> грн до <span class="max-price"><?=$price_obj->erkernoye_3->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-3">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->erkernoye_3 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-3" role="tabpanel" aria-labelledby="<?=$key_w?>-type-3">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/erker-type-3.a1b1fb08.png" class="mt-lg-5 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->erkernoye_3->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-4">
            <h2 class="title-block-type-windows">Эркерные Окна</h2>
            <span class="small-title">Размер 1100 х 1350 мм, Цена от <span class="min-price"><?=$price_obj->erkernoye_4->min?></span> грн до <span class="max-price"><?=$price_obj->erkernoye_4->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-4">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->erkernoye_4 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-4" role="tabpanel" aria-labelledby="<?=$key_w?>-type-4">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/erker-type-4.32f10909.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->erkernoye_4->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
      ...
      <div class="container">
         ...
         <ul class="list-top-product">
            ...
            <li class="block-item-product">
               ...
               <p>Система защиты от детей может сохранить жизнь и здоровье вашего ребенка</p>
            </li>
         </ul>
      </div>
   </section>
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Преимущества и недостатки эркерных окон</h2>
         <p>Окна эркер отличаются высокой стоимостью в сравнении с классическими окнами ПВХ. Однако этот нюанс компенсируется преимуществами:</p>
         <ol>
            <li>Эстетичностью и необычностью. Эркерные конструкции выделяются на фоне традиционных элементов фасадной части здания.</li>
            <li>Увеличенной площадью остекления с обеспечением максимального проникновения солнечного света.</li>
            <li>Зрительным увеличением жилого пространства.</li>
            <li>Повышенной прочностью и надежностью.</li>
            <li>Большой площадью подоконников, что позволяет использовать нижнюю часть эркера в качестве полки.</li>
         </ol>
         <p>Недостатком эркерной конструкции является сложный монтаж. Неправильная установка окна снижает сопротивляемость взлому и сильным ветровым нагрузкам.</p>
         <p></p>
         <h2 class="title-post">Кому подойдут</h2>
         <p>Эркерные конструкции активно используются в таких строительных объектах как:</p>
         <ul>
            <li>· таунхаус;</li>
            <li>· коттедж;</li>
            <li>· дачный дом.</li>
         </ul>
         <p>Также эркеры применяются в элитных ресторанах, гостиницах, кафе, жилых домах нового типа, офисных зданиях. Иногда в эркерной части постройки размещаются домашний кинотеатр, зимний сад, оранжерея.</p>
         <p>Варианты оформления эркерного окна следующие:</p>
         <ol>
            <li>В гостиной эркер отлично сочетается с угловым диваном и журнальным столиком.</li>
            <li>На кухне обеденная группа размещается в эркерной части дома, и визуально разделяется диваном и отдельной кухонной зоной. Для выравнивания эркера применяется зеркало и текстиль (легкие шторы или тюль).</li>
            <li>В спальне в эркерном выступе идеально размещается зона для отдыха или чтения. Сгладить дизайн поможет низкая круглая мебель неярких цветов. На окна для регулирования дневного солнечного света можно повесить легкие рулонные шторы или жалюзи. Тяжелые темные шторы помогут закрыть комнату от яркого солнечного света</li>
            <li>На балконе или лоджии с эркерным остеклением идеально поставить шезлонг или маленький диван с журнальным столиком. Такое расположение мебели позволит наслаждаться красивыми пейзажами из окна.</li>
         </ol>
         <p>Дополнительным бонусом использования эркера является возможность создания интерьера в темном цвете. При оформлении евроокна важно учитывать то, что дизайн комнаты должен быть выполнен в одном стиле.</p>
         <h2 class="title-post">Как выбрать</h2>
         <p>При выборе эркерного окна следует учитывать некоторые моменты:</p>
         <ol>
            <li>От качественного материала и фурнитуры зависит прочность и надежность оконной конструкции.</li>
            <li>Евроокна, изготовленные из пластика с армированным металлическим каркасом, обеспечивают тепловую и звуковую защиту помещения.</li>
            <li>Для холодного остекления предпочтительнее выбрать алюминиевые пластиковые окна.</li>
         </ol>
         <p>Размер изделия зависит от параметров оконного проема. Наши специалисты готовы выехать на объект, произвести замеры и установить изготовленную конструкцию.</p>
         <h2 class="title-post">Цены на эркерные окна</h2>
         <p>На стоимость эркерной модели влияет ряд факторов:</p>
         <ul>
            <li>· вид профильной системы;</li>
            <li>· фурнитура и соединители;</li>
            <li>· механизм открывания;</li>
            <li>· разновидность стеклопакета;</li>
            <li>· ламинация;</li>
            <li>· дополнительные элементы (москитные сетки, решетки, рольставни).</li>
         </ul>
         <p>Окна эркер изготавливаются на заказ в Украине по индивидуальному дизайну. Узнать цены можно на нашем сайте в прайс-листе или позвонить по указанному телефону.</p>
      </div>
   </section>
      ...
      <div class="container">
         ...
         <ul class="list-other-type-windows">
            ...
            <li class="item-other-type-windows">
               <div class="block-img-other p-0"><img src="<?php bloginfo('template_url') ?>/images/cycle.a7c36460.webp" class="p-2 p-lg-3 img-fluid" alt="photo"></div>
               <a href="<?=get_bloginfo('home')?>/plastikovye-okna/kruglye/" class="title-footer">Круглые</a>
            </li>
            <li class="item-other-type-windows">
               <div class="block-img-other p-0"><img src="<?php bloginfo('template_url') ?>/images/ovalnye-metalloplastikovye-okna.10c91d1c.jpg" class="p-2 p-lg-3 img-fluid" alt="photo"></div>
