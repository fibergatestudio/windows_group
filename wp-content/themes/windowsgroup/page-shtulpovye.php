...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
            <h1 class="title-post">Штульповые двери в Киеве</h1>
            <p class="text-custom-page">Двери со штульпом являются выгодным и перспективным решением в оформлении интерьера.
                Компания “Виндовс Груп” предлагает купить штульповые двери в Украине по лучшим ценам напрямую от производителя.
                В каталогах компании представлены актуальные модели дверных штульповых конструкций с разной расцветкой и фактурой.</p>
         </div>

        <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'dvery_shtulpovie' ");
            $price_obj = json_decode($result_params[0]->data);
         
        ?>
         
         <div class="block-windows-type-1">
            <h2 class="title-block-type-windows">Штульповые металлопластиковые двери с перемычкой</h2>
            <span class="small-title">Размер 1400 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->shtulpovie_1->min?></span> грн до <span class="max-price"><?=$price_obj->shtulpovie_1->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-open">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->shtulpovie_1 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-open" role="tabpanel" aria-labelledby="<?=$key_w?>-open">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/1-shtulpovyye-metalloplastikovyye-dveri-s-peremychkoy.5ca6faa6.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->shtulpovie_1->$key_w;
                              $j = 0;
         ...
         <div class="block-windows-type-2">
            <h2 class="title-block-type-windows">Штульповые двойные металлопластиковые двери с сэндвич панелью</h2>
            <span class="small-title">Размер 1800 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->shtulpovie_2->min?></span> грн до <span class="max-price"><?=$price_obj->shtulpovie_2->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->shtulpovie_2 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>" role="tabpanel" aria-labelledby="<?=$key_w?>">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/2-shtulpovyye-dvoynyye-metalloplastikovyye-dveri-s-sendvich-panelyu.00463b56.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->shtulpovie_2->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-3">
            <h2 class="title-block-type-windows">Штульповые металлопластиковые двери с сэндвич панелью</h2>
            <span class="small-title">Размер 1400 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->shtulpovie_3->min?></span> грн до <span class="max-price"><?=$price_obj->shtulpovie_3->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-3">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->shtulpovie_3 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-3" role="tabpanel" aria-labelledby="<?=$key_w?>-type-3">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/3-shtulpovyye-metalloplastikovyye-dveri-s-sendvich-panelyu.4f30b85a.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->shtulpovie_3->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-4">
            <h2 class="title-block-type-windows">Штульповые стеклянные металлопластиковые двери</h2>
            <span class="small-title">Размер 1400 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->shtulpovie_4->min?></span> грн до <span class="max-price"><?=$price_obj->shtulpovie_4->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-4">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->shtulpovie_4 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-4" role="tabpanel" aria-labelledby="<?=$key_w?>-type-4">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/4-shtulpovyye-steklyannyye-metalloplastikovyye-dveri.7b07acd9.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->shtulpovie_4->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-5">
            <h2 class="title-block-type-windows">Штульповые металлопластиковые двери с фрамугой</h2>
            <span class="small-title">Размер 1400 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->shtulpovie_5->min?></span> грн до <span class="max-price"><?=$price_obj->shtulpovie_5->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-5">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->shtulpovie_5 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
                  ...
                  <div class="table-tab">
                     ...
                     <table class="table-windows table-price-windows">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->shtulpovie_5->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-6">
            <h2 class="title-block-type-windows">Штульповые металлопластиковые двери с фрамугой и сэндвич панелью</h2>
            <span class="small-title">Размер 1400 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->shtulpovie_6->min?></span> грн до <span class="max-price"><?=$price_obj->shtulpovie_6->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-6">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->shtulpovie_6 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-6" role="tabpanel" aria-labelledby="<?=$key_w?>-type-6">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/6-shtulpovyye-metalloplastikovyye-dveri-s-framugoy-i-sendvich-panelyu.28308c3c.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->shtulpovie_6->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-7">
            <h2 class="title-block-type-windows">Штульповые металлопластиковые двери с окнами по бокам</h2>
            <span class="small-title">Размер 2700 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->shtulpovie_7->min?></span> грн до <span class="max-price"><?=$price_obj->shtulpovie_7->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-7">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->shtulpovie_7 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
                  ...
                  <div class="table-tab">
                     ...
                     <table class="table-windows table-price-windows">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->shtulpovie_7->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-8">
            <h2 class="title-block-type-windows">Штульповые металлопластиковые двери с одним окном сбоку</h2>
            <span class="small-title">Размер 1200 х 2100 мм, окно 750 х1350 мм, Цена от <span class="min-price"><?=$price_obj->shtulpovie_8->min?></span> грн до <span class="max-price"><?=$price_obj->shtulpovie_8->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-8">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->shtulpovie_8 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-8" role="tabpanel" aria-labelledby="<?=$key_w?>-type-8">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/8-shtulpovyye-metalloplastikovyye-dveri-s-odnim-oknom-s-boku.be9db9e6.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->shtulpovie_8->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
   ...
   <section class="section-buy-this-product doors">
      <div class="container">
         ...
         <ul class="list-top-product">
            ...
            <li class="block-item-product">
               <span class="title-header">Москитные сетки на двери</span>
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Преимущества и недостатки штульповых дверей</h2>
         <p>Штульповая дверь характеризуется рядом преимуществ:</p>
         <ol>
            <li>Созданием эффекта расширения пространства.</li>
            <li>Повышенной тепловой и звуковой защитой.</li>
            <li>Максимальным освещением помещения.</li>
            <li>Жесткостью штульпового механизма.</li>
            <li>Особой формой штульпа, скрывающей место соединения створок.</li>
            <li>Прочностью и защитой от несанкционированного доступа.</li>
            <li>Возможностью переноса габаритных грузов через большой проем.</li>
            <li>Простотой эксплуатации.</li>
         </ol>
         <p>Однако кроме достоинств отмечается недостаток штульповых моделей в виде осуществления монтажа в дверном проеме шириной не менее 90 см. Данное условие использования указывает на то, что изделия со штульпом часто применяются на балконах и лоджиях. Благодаря остеклению двух дверных створок увеличивается площадь балкона</p>
         <h2 class="title-post">Особенности</h2>
         <p>Штульповая дверь – это пластиковая конструкция, состоящая из двух створок – активной и вспомогательной. На рабочей створке фиксируется ручка, а вспомогательная надежно прикрепляется к раме. Данный вид изделия не предусматривает импоста или вертикальной перегородки между створками.</p>
         <p>Присутствие специального накладного ПВХ профиля (штульпа) обеспечивает герметичность конструкции, плотно прижимая створки. Обычно в штульповом запорном механизме применяются микролифты, выполняющие следующие функции:</p>
         <ul>
            <li>· плавное приподнимание при закрывании дверной створки, что значительно снижает нагрузку с петель;</li>
            <li>· защита штульпового механизма от повреждений;</li>
            <li>· быстрая ручная регулировка петель по высоте;</li>
            <li>· предотвращение случайного поворота ручки ребенком.</li>
         </ul>
         <p>В зависимости от параметров, особенностей проема и желания клиента двери штульп изготавливаются со створками одинаковой или разной ширины. Одна часть конструкции может открываться в разных плоскостях, вторая –распахиваться.</p>
         <h2 class="title-post">Кому подойдут</h2>
         <p>Дверные конструкции со штульповым запорным механизмом оптимальный вариант для помещений с нетиповой планировкой. Дверь со штульпом применяется в широких проемах в квартирах, загородных домах, магазинах, ресторанах.</p>
         <p>Двухстворчатые дверные модели в интерьере помогают реализовать варианты французского остекления. Поэтому штульповая балконная дверь смотрится стильно и изящно, визуально расширяя лоджию. Незначительно высокая стоимость данного типа изделий компенсируется отличными эстетичными и функциональными характеристиками.</p>
         <h2 class="title-post">Как выбрать профиль</h2>
         <p>Чтобы выбрать профиль, необходимо учитывать следующие моменты:</p>
         <ol>
            <li>Место, где будет устанавливаться дверная конструкция. Для частных домов рекомендуется использовать противовзломную фурнитуру.</li>
            <li>От качества фурнитуры зависит долговечность функционирования створок. Традиционный метод установки – с защелками внизу и вверху. Для межкомнатных дверей предпочтительнее выбирать монтаж ручки с защелкой.</li>
            <li>Профиль может быть белого цвета или ламинироваться под разные фактуры.</li>
            <li>В дверное полотно по предпочтениям используется сэндвич-панель или стеклопакет.</li>
            <li>Для магазинов рекомендуется сделать рабочую створку широкой и установить доводчик.</li>
         </ol>
         <p>Монтаж штульповых дверных моделей необходимо доверять профессионалам. Самостоятельная установка способна перечеркнуть все преимущества конструкции со штульпом. Наши специалисты готовы произвести замеры проема и грамотно установить готовый дверной блок.</p>
         <h2 class="title-post">Цены на штульповые двери</h2>
         <p>Цена штульповых дверей на балкон в Киеве и области зависит от выбранного типа конструкции, цвета и ламинации профиля, ручки, а также наличия доводчика. Узнать цены можно на нашем сайте или позвонить по указанному телефону.</p>
      </div>
   </section>
