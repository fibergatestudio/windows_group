...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
            <h1 class="title-post">Балконный блок в Киеве</h1>
            <p class="text-custom-page">
                Современные направления и технологии позволяют совместить балконное пространство с помещением жилой комнаты или создать отдельное
                уютное помещение. Наша компания WindowsGroup предлагает купить балконный блок в Киеве для квартир
                и домов по выгодной цене от производителя.
            </p>
         </div>
         ...
         <?php 
            ...
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'balkonnye_bloki' ");
            $price_obj = json_decode($result_params[0]->data);
         
         ?>
         
         <div class="block-windows-type-1">
            <h2 class="title-block-type-windows">Балконный блок с одностворчастой стеклянной дверью и глухим окном</h2>
            <span class="small-title">Размер 600 х 2000 мм + 1100 х 1350 мм, Цена от <span class="min-price"><?=$price_obj->balkonnye_bloki_1->min?></span> грн до <span class="max-price"><?=$price_obj->balkonnye_bloki_1->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-open">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->balkonnye_bloki_1 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-open" role="tabpanel" aria-labelledby="<?=$key_w?>-open">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/1-balkonnyy-blok-s-odnostvorchatoy-steklyannoy-dveryu-i-glukhim-oknom.063d4237.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->balkonnye_bloki_1->$key_w;
                              $j = 0;
         ...
         <div class="block-windows-type-2">
            <h2 class="title-block-type-windows">Балконный блок с одностворчастой стеклянной дверью и открывающимся окном</h2>
            <span class="small-title">Размер 600 х 2000 мм + 1100 х 1350 мм, Цена от <span class="min-price"><?=$price_obj->balkonnye_bloki_2->min?></span> грн до <span class="max-price"><?=$price_obj->balkonnye_bloki_2->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->balkonnye_bloki_2 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>" role="tabpanel" aria-labelledby="<?=$key_w?>">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/2-balkonnyy-blok-s-odnostvorchatoy-steklyannoy-dveryu-i-otkryvayushchimsya-oknom.2b37d538.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->balkonnye_bloki_2->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-3">
            <h2 class="title-block-type-windows">Балконный блок с одностворчастой стеклянной дверью с сэндвич панелью и глухим окном</h2>
            <span class="small-title">Размер 600 х 2000 мм + 1100 х 1350 мм, Цена от <span class="min-price"><?=$price_obj->balkonnye_bloki_4->min?></span> грн до <span class="max-price"><?=$price_obj->balkonnye_bloki_4->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-3">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->balkonnye_bloki_4 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-3" role="tabpanel" aria-labelledby="<?=$key_w?>-type-3">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/3-balkonnyy-blok-s-odnostvorchatoy-dveryu-s-sendvich-panelyu-i-glukhim-oknom.e55876f6.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->balkonnye_bloki_4->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-4">
            <h2 class="title-block-type-windows">Балконный блок с одностворчастой стеклянной дверью с сэндвич панелью и открывающимся окном</h2>
            <span class="small-title">Размер 600 х 2000 мм + 1100 х 1350 мм, Цена от <span class="min-price"><?=$price_obj->balkonnye_bloki_5->min?></span> грн до <span class="max-price"><?=$price_obj->balkonnye_bloki_5->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-4">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->balkonnye_bloki_5 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-4" role="tabpanel" aria-labelledby="<?=$key_w?>-type-4">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/4-balkonnyy-blok-s-odnostvorchatoy-dveryu-s-sendvich-panelyu-i-otkryvayushchimsya-oknom.e4e5322b.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->balkonnye_bloki_5->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-5">
            <h2 class="title-block-type-windows">Панорамный балконный блок с одностворчатой дверью</h2>
            <span class="small-title">Размер 600 х 2000 мм + 1100 х 2000 мм, Цена от <span class="min-price"><?=$price_obj->balkonnye_bloki_3->min?></span> грн до <span class="max-price"><?=$price_obj->balkonnye_bloki_3->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-5">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->balkonnye_bloki_3 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-5" role="tabpanel" aria-labelledby="<?=$key_w?>-type-5">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/5-panoramnyy-balkonnyy-blok-s-odnostvorchatoy-dveryu.1113694d.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->balkonnye_bloki_3->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-6">
            <h2 class="title-block-type-windows">Балконный блок с штульповой дверью и глухим окном</h2>
            <span class="small-title">Размер 1200 х 2100 мм, окно 750 х 1350 мм, Цена от <span class="min-price"><?=$price_obj->balkonnye_bloki_6->min?></span> грн до <span class="max-price"><?=$price_obj->balkonnye_bloki_6->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-6">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->balkonnye_bloki_6 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-6" role="tabpanel" aria-labelledby="<?=$key_w?>-type-6">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/6-balkonnyy-blok-so-shtulpovoy-dveryu-i-glukhim-oknom.57147bca.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->balkonnye_bloki_6->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-7">
            <h2 class="title-block-type-windows">Балконный блок с открывающимся окном и двойной фрамугой</h2>
            <span class="small-title">Размер двери 800 х 2100, окно 1100 х 1350, фрамуга 1900 х 500 мм, Цена от <span class="min-price"><?=$price_obj->balkonnye_bloki_7->min?></span> грн до <span class="max-price"><?=$price_obj->balkonnye_bloki_7->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-7">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->balkonnye_bloki_7 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-7" role="tabpanel" aria-labelledby="<?=$key_w?>-type-7">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/7-balkonnyy-blok-s-otkryvayushchimsya-oknom-i-dvoynoy-framugoy.8c2420c1.png" class="vertical-doors-3 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->balkonnye_bloki_7->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-8">
            <h2 class="title-block-type-windows">Балконный блок со стеклянной дверью открывающимся окном и фрамугой</h2>
            <span class="small-title">Размер двери 800 х 2100, окна 750 х 1350, фрамуги 1550 х 500 мм, Цена от <span class="min-price"><?=$price_obj->balkonnye_bloki_8->min?></span> грн до <span class="max-price"><?=$price_obj->balkonnye_bloki_8->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-8">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->balkonnye_bloki_8 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-8" role="tabpanel" aria-labelledby="<?=$key_w?>-type-8">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/8-balkonnyy-blok-so-steklyannoy-dveryu-otkryvayushchimsya-oknom-i-framugoy.3ed015f7.png" class="vertical-doors-3 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->balkonnye_bloki_8->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-9">
            <h2 class="title-block-type-windows">Балконный блок со стеклянной дверью с фрамугой и двумя глухими окнами</h2>
            <span class="small-title">Размер двери 800 х 2600, окна 1500 х 1850 мм, Цена от <span class="min-price"><?=$price_obj->balkonnye_bloki_9->min?></span> грн до <span class="max-price"><?=$price_obj->balkonnye_bloki_9->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-9">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->balkonnye_bloki_9 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-9" role="tabpanel" aria-labelledby="<?=$key_w?>-type-9">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/9-balkonnyy-blok-so-steklyannoy-dveryu-s-framugoy-i-dvumya-glukhimi-oknami.1b3f85a2.png" class="vertical-doors-3 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->balkonnye_bloki_9->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Варианты балконных блоков</h2>
         <p>Балконный блок представляет собой конструкцию в комбинации из двери и окна. Комплект бывает цельным или раздельным. Дверные створки могут заполняться стеклопакетами или внизу находится сэндвич-панель, вверху – стеклопакет. Такое наполнение уменьшает вес блока, делает его светонепроницаемым.</p>
         <p>Существует несколько вариантов блока для балкона:</p>
         <ul>
            <li>· стандарт – дверь в комплекте с окном;</li>
            <li>· распахивающаяся дверь с несколькими оконными блоками (тип “чебурашка”);</li>
            <li>· портально-раздвижная система (французское остекление);</li>
            <li>· дверной комплект с несколькими створками и вертикальным импостом – тип «бабочка».</li>
         </ul>
         <p>Для неостекленных лоджий рекомендуется установка классического комплекта: двери с окном. В небольшой проем предпочтительнее выбирать комбинированный тип с механизмом “гармошка”.</p>
         <h2 class="title-post">Особенности выбора</h2>
         <p>При наличии глухого окна блок оснащается створкой с поворотным откидным механизмом открывания. Такой вариант оптимальный для естественной вентиляции помещения. Установка распашной конструкции ограничивает проветривание лоджии.</p>
         <p>Вариант «чебурашка» подходит для длинных лоджий. Комбинация имеет разновидности: дверь в соединении с одной активной и глухой фрамугой, парой глухих окон или двумя открывающимися фрамугами. В проем для конструкции монтируется поворотно-откидная фурнитура.</p>
         <p>Французское остекление – широкоформатная разновидность оформления балкона. При установке портальной раздвижной системы необходим демонтаж части стены, перенос батареи. Порталы обеспечивают панорамный вид из окна, максимальное проникновение солнечного света в комнату.</p>
         <p>Для балкона в квартире с хрущевской планировкой подбирается балконный блок «бабочка». Комплект состоит из центральной двери и боковых окон. Такой вариант расширяет площадь лоджии.</p>
         <p>Дополнительно с балконным блоком снаружи устанавливаются металлические отливы, защищающие помещение от атмосферных осадков.</p>
         <p>В наших каталогах представлены металлопластиковые балконные рамы по выгодной цене.</p>
         <h2 class="title-post">Как правильно замерить</h2>
         <p>Для заказа необходимо знать параметры будущей конструкции:</p>
         <ul>
            <li>· ширину, высоту двери;</li>
            <li>· ширину проема окна без учета балконной двери;</li>
            <li>· общую ширину балконного блока.</li>
         </ul>
         <p>Измерения балкона производятся с наружной стороны. При замерах с внутренней стороны не исключаются погрешности в размере.</p>
         <p>К полученным параметрам прибавляются 3 см для припуска на монтажные швы. Если планируется установка аксессуаров, тогда оставляется дополнительное место.</p>
         <p>Самостоятельный замер не гарантирует получения точных размеров конструкции. Поэтому наши специалисты готовы выехать на объект, составить эскиз конструкции и обговорить предварительную стоимость заказа.</p>
         <h2 class="title-post">Как выбрать и какой купить</h2>
         <p>К конструкции предъявляются высокие требования, если отсутствует остекление или имеется холодное остекление. В сравнении со стандартными оконными конструкциями балконные блоки отличаются большими размерами. Это указывает на необходимость повышения их энергоэффективности:</p>
         <ul>
            <li>Установить в блок двухкамерные стеклопакеты, при больших створках – однокамерные стеклопакеты с энергосберегающими стеклами.</li>
            <li>Использовать металлопластиковые пятикамерные профильные системы.</li>
            <li>Заказать профессиональный монтаж. Герметичная установка является гарантией надежности и долговечности конструкции.</li>
         </ul>
         <p>При заказе стандартного балконного блока окно бывает глухим. В зависимости от размера проема, условий эксплуатации конструкция оснащается форточкой, фрамугой, створкой.</p>
         <p>Полотно двери заполняется стеклопакетами. Такое заполнение двери подразумевает использование ударопрочного стекла. В целях равномерной нагрузки и жесткости применяются горизонтальные импосты, проемы делятся на две части.</p>
         <p>Конструкции оснащаются разными механизмами открывания. Установка противовзломной фурнитуры предотвратит посторонний доступ в квартиру или дом.</p>
         <p>Мы предлагаем заказать у нас окна и двери на балкон по доступным ценам в комплекте с оригинальной фурнитурой. Узнать цены можно на сайте в прайсе или позвонив по указанным телефонам.</p>
      </div>
   </section>
      ...
      <div class="container">
         ...
         <ul class="list-other-type-windows">
            <li class="item-other-type-windows">
               <div class="block-img-other doors"><img src="<?php bloginfo('template_url') ?>/images/shtulpovye-metalloplastikovye-dveri.bf60a320.jpg" class="not-all-img img-fluid" alt="photo"></div>
               <a href="<?=get_bloginfo('home')?>/plastikovye-dveri/shtulpovye/" class="title-footer">Штульповые</a>
            </li>
            <li class="item-other-type-windows">
               <div class="block-img-other doors"><img src="<?php bloginfo('template_url') ?>/images/metalloplastikovye-dveri-v-ofis.1e08d111.jpg" class="all-img img-fluid" alt="photo"></div>
               <a href="<?=get_bloginfo('home')?>/plastikovye-dveri/v-ofis/" class="title-footer">В Офис</a>
            </li>
            <li class="item-other-type-windows">
               <div class="block-img-other doors"><img src="<?php bloginfo('template_url') ?>/images/metalloplastikovye-dveri-na-terrasu.2408b5a3.jpg" class="all-img img-fluid" alt="photo"></div>
               <a href="<?=get_bloginfo('home')?>/plastikovye-dveri/na-terrasu/" class="title-footer">На Терассу</a>
            </li>
         </ul>
      </div>
   </section>
