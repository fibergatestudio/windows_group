...
<div class="main page-calculator">
   <section class="section-calculator">
      <div class="container">
         <?php if ( function_exists( 'dimox_breadcrumbs' ) ) dimox_breadcrumbs(); ?>
         <h1 class="title-section">Калькулятор Стоимости Окон</h1>
         <p class="text-custom-page">Калькулятор окон позволяет легко и быстро рассчитать стоимость будущей конструкции. Это поможет разобраться в ценах на металлопластиковые изделия, сравнить несколько вариантов и выбрать подходящий. Мы предлагаем широкий выбор окон от ведущих производителей с доставкой по выгодным ценам в Киеве и области. Гарантируем лучшее качество по европейским стандартам.</p>
   ...
   <section class="section-post section-post-windows page-calculator post-border-none">
      <div class="container">
         <h2 class="title-section">Расчет Стоимости Металлопластиковых Окон Онлайн</h2>
         <p>Калькулятор стоимости металлопластиковых окон в Киеве позволяет произвести расчет изделия, учитывая размеры, комплектацию и энергоэффективные опции.</p>
         <p>Также калькулятор поможет рассчитать цены на остекление балкона, заказ на офисные, балконные двери с фрамугой или без, раздвижные конструкции.</p>
         <p>На стоимость металлопластикового изделия влияют:</p>
         <ul>
            <li>- вид, размер, цвет;</li>
            <li>- выбор комплектующих (фурнитуры, декоративных вставок, ламинирования);</li>
            <li>- замер;</li>
            <li>- доставка;</li>
            <li>- монтаж.</li>
         </ul>
         <p>При покупке важно выбрать тип установки: обычный или евромонтаж. Второй вариант является профессиональным. Качественная установка обеспечивает герметичность, усиленную тепловую и звуковую изоляцию конструкции. Наши специалисты осуществляют евромонтаж любого изделия даже нестандартной конфигурации.</p>
         <h2 class="title-post">Как рассчитать стоимость пластиковых окон</h2>
         <p>Для того чтобы рассчитать цену пластикового окна онлайн в Украине, необходимо произвести ряд действий:</p>
         <ol>
            <li>Определиться с типом окна (одностворчатое, двухстворчатое, наличие фрамуги, одно- два открывания или глухое).</li>
            <li>Выбрать параметры и комплектующие конструкции (указать размер окна, тип открывания; вид профиля, фурнитуры, камерность стеклопакета). Для определения замеров будущей оконной модели необходимо изнутри по видимой части измерить ширину и высоту. Дополнительно рекомендуется прибавить по высоте и ширине по 50 мм. Это будет примерный замер будущей конструкции.</li>
            <li>Подобрать другие параметры: аксессуары (отливы, подоконники), вид отделки откосов.</li>
         </ol>
         <p>После того, как подходящие пункты были отмечены, нужно кликнуть на команду "Заказать". Подробный расчет металлопластикового окна отобразится на экране или будет отправлен на указанный электронный почтовый адрес. При подсчете можно сравнивать расценки на изделие с подбором разных видов профиля, фурнитуры, комплектующих.</p>
         <p>При подсчете стоимости конструкций ПВХ нестандартных форм (треугольных, арочных, круглых) без профессиональной консультации трудно обойтись. Позвоните по телефону, наш менеджер проконсультирует вас в выборе и просчитает ориентировочную стоимость заказа.</p>
         <h2 class="title-post">Преимущества использования калькулятора окон</h2>
         <p>При помощи оконного калькулятора вы сможете не только рассчитать стоимость, но и заказать товар онлайн от следующих производителей:</p>
         <ul>
            <li>- Rehau;</li>
            <li>- KBE;</li>
            <li>- WDS;</li>
         ...
         <p>В калькуляторе отображаются все контакты поставщиков для уточнения условий оплаты, доставки, установки, наличия документов.</p>
         <p>При вводе исходных данных клиент может ознакомиться с описанием каждой позиции калькулятора. Дополнительно для выбранной конструкции приводятся значения звуковой и тепловой изоляции в процентном соотношении. Этот момент важно учесть, если необходимо заказать окно с повышенной теплопроводностью и звукоизоляцией.</p>
         <p>Следует обратить внимание, что цена на металлопластиковую конструкцию из ПВХ-профиля является предварительной. Точная стоимость будет известна непосредственно после проведения замера на объекте. Узнать цены на окна по индивидуальным параметрам можно у нас на сайте или по телефону.</p>
      </div>
   </section>
   <a id="button"></a>
</div>
