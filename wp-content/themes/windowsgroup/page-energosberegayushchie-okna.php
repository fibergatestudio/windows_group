<?php
/* Template Name: PageEnergosberegayushchieOkna */
get_header();
?>
...
<div class="main page-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
             <h1 class="title-post">Купить энергосберегающие пластиковые окна в Киеве</h1>
             <p class="text-custom-page">Энергоэффективные пластиковые окна обеспечат комфорт и уют, предотвращая потерю тепла.
                 Использование данного вида конструкций помогает сэкономить на отоплении и кондиционировании.
                 Наша компания “Windows Group” предлагает купить энергосберегающие окна по выгодным ценам в Киеве и области.
                 Мы гарантируем широкий выбор товара и лучшее обслуживание клиентов.</p>
         </div>
         
         <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_energosberegayushiye' ");
   ...
   <section class="section-post section-post-windows">
      <div class="container">
          <h2 class="title-section">Особенности конструкции энергосберегающих пластиковых окон</h2>
         <p>Энергосберегающие окна – пластиковая конструкция, препятствующая теплообмену между помещением и улицей. Окно сохраняет температуру внутри комнаты зимой, и снижает нагрев помещения летом.</p>
         <p>Энергоэффективные оконные конструкции состоят из:</p>
         <ul>
            <li>· стеклопакета;</li>
            <li>· заполнения камеры газом (криптона, ксенона или аргона);</li>
            <li>· теплоотражающего слоя стекла.</li>
         </ul>
         <p>Главное различие обычных окон от энергосберегающих моделей – наличие энергоэффективного слоя, содержащего ионы серебра. Стекло с серебряным напылением не дает проникать в помещение прямым солнечным лучам и нагреваться.</p>
         <p></p>
         <h2 class="title-post">Виды</h2>
         <p>Энергосберегающие стеклопакеты бывают:</p>
         <ol>
            <li>К-стекло – жесткое покрытие, изготавливаемое посредством нанесения на горячее стекло оксидов. Остывая, расплавленное стекло скрепляется с металлической пленкой. В нем, как в зеркале, можно увидеть отражение. Поверхность отличается устойчивостью к механическим повреждениям. Возможна тонировка в разные цвета. Стеклопакеты данного типа уменьшают потери тепла в зимний период на 30%.</li>
            <li>И-стекло – покрытие мягкого типа, получаемое посредством вакуумного напыления с двух- и трехслойным серебром с титаном. Данный вид стекла характеризуются сохранением до 90% тепла, минимальной стойкостью к абразивному воздействию.</li>
         </ol>
         <p>На низкоэмиссионном стеклопакете практически не образуется конденсат, потому что температура внутренней стеклянной поверхности равняется комнатным показателям.</p>
         <h2 class="title-post">Как правильно выбрать</h2>
         <p>При выборе энергосберегающего пластикового окна следует учесть следующие нюансы:</p>
         <ol>
            <li>Отдавать предпочтение окнам с максимальным коэффициентом теплопередачи. Такие модели лучше сохраняют тепло, не требуя дополнительного обогрева помещения.</li>
            <li>Важно обращать внимание, из какого материала изготовлены окна. Алюминиевые конструкции применяются для холодного остекления, пластиковые – используются для теплых оконных блоков.</li>
            <li>Профиль должен быть однородным, без потертостей и зернистости. При выборе профильной ширины необходимо учитывать регион, где будут устанавливаться изделия. Профиль обязательно должен быть армированным с металлической вставкой. Армирование предотвращает деформацию и перекос оконной конструкции.</li>
            <li>Чем толще наружная стенка профиля, тем больше возможностей для изготовления больших окон стандартной и нестандартной формы.</li>
            <li>Выбирать профильную систему с контурами уплотнения. Чем больше контуров, тем герметичнее будет окно.</li>
            <li>Не нужно экономить на фурнитуре. От качества фурнитуры зависит функциональность, противовзломность и детская защита конструкции.</li>
            <li>Для усиленной теплоизоляции дистанционная рамка стеклопакета должна быть стальной или пластиковой.</li>
         </ol>
         <p>Отличить простое стекло от энергосберегающего стекла невооруженным взглядом проблематично. Чтобы убедиться в том, что стеклопакет энергоэффективен, необходимо зажечь спичку и поднести к стеклу. Если в отражении отобразится красный цвет пламени, значит, стеклопакет энергосберегающий.</p>
         <p>Также проверить стеклопакет можно по методу блика. Для этого необходимо смотреть на стеклянную поверхность под углом. Перед вами должен быть виден голубовато-фиолетовый отлив, как на лобовом стекле автомобиля.</p>
         <h2 class="title-post">Преимущества</h2>
         <p>Окна энергосберегающие характеризуются следующими преимуществами:</p>
         <ul>
            <li>· обеспечением оптимального микроклимата;</li>
            <li>· меньшим весом конструкции;</li>
            <li>· защитой текстиля и мебели от выцветания;</li>
            <li>· высоким уровнем пропуска света;</li>
            <li>· простым монтажом и эксплуатацией;</li>
         ...
         <ol>
            <li>Чистить раму мягкой салфеткой с мыльным раствором. Не использовать абразивные моющие средства и жесткие губки из-за риска повреждений и царапин поверхности.</li>
            <li>Мыть стеклопакеты следует специальным резиновым валиком, смоченным в средство для чистки стекол.</li>
            <li>Два раза в год необходимо чистить от пыли резиновые уплотнители. Обязательно их смазывать средствами с содержанием силиконового масла.</li>
            <li>Срок службы фурнитуры увеличится, если смазывать 1-2 раза в год специальными маслами.</li>
         </ol>
         <h2 class="title-post">Стоимость</h2>
         <p>Цена энергосберегающей оконной конструкции зависит от ряда факторов</p>
         <ul>
            <li>· вида, формы и размера окна;</li>
            <li>· типа профиля;</li>
            <li>· фурнитуры;</li>
            <li>· уплотнителя;</li>
            <li>· используемого стекла;</li>
            <li>· механизма открывания;</li>
            <li>· декора.</li>
         </ul>
         <p>Компания “Виндовс Груп” предлагает купить энергосберегающие окна со стеклопакетами по цене от производителя. Узнать ориентировочную стоимость пластиковых евроокон можно на сайте или, позвонив по телефону.</p>
      </div>
   </section>
      ...
      <div class="container">
         ...
         <ul class="list-other-type-windows">
            <li class="item-other-type-windows">
               <div class="img-box-shadow"><img src="<?php bloginfo('template_url') ?>/images/laminirovannye-metalloplastikovye-okna.4aec47ae.jpg" class="p-3 img-fluid" alt="photo"></div>
               <a href="<?=get_bloginfo('home')?>/plastikovye-okna/laminirovannye/" class="title-footer">Ламинированные</a>
            </li>
