<?php
/* Template Name: PageRazdvizhnyeOkna */
get_header();
?>
...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
            <h1 class="title-post">Раздвижные ПВХ (пластиковые) окна в Киеве – цены</h1>
            <p class="text-custom-page">Мы предлагаем купить раздвижные пластиковые окна от известных производителей по доступной цене. В каталогах на сайте представлены современные раздвижные модели любого цвета, размера и конфигурации.</p>
         </div>

         <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_razdvizniye' ");
            $price_obj = json_decode($result_params[0]->data);
         
         ?>
         
         <div class="block-windows-type-1">
            <h2 class="title-block-type-windows">Раздвижные на Одно Окно</h2>
            <span class="small-title">Размер 1500 х 1500 мм, Цена от <span class="min-price"><?=$price_obj->razdvizniye_1->min?></span> грн до <span class="max-price"><?=$price_obj->razdvizniye_1->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>" role="tabpanel" aria-labelledby="<?=$key_w?>">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/sliding-windows-1.3eda116a.png" class="mt-lg-4 img-type-windows img-fluid" alt="photo"></div>
         ...
         <div class="block-windows-type-2">
            <h2 class="title-block-type-windows">Раздвижные на Два Окна по Бокам</h2>
            <span class="small-title">Размер 3600 х 1600 мм, Цена от <span class="min-price"><?=$price_obj->razdvizniye_2->min?></span> грн до <span class="max-price"><?=$price_obj->razdvizniye_2->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-open">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-open" role="tabpanel" aria-labelledby="<?=$key_w?>-open">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/sliding-windows-2.83eb7a4a.png" class="mt-lg-4 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-windows-type-3">
            <h2 class="title-block-type-windows">Раздвижные ан Четыре Окна - Два Открытия Посередине</h2>
            <span class="small-title">Размер 3600 х 1600 мм, Цена от <span class="min-price"><?=$price_obj->razdvizniye_4->min?></span> грн до <span class="max-price"><?=$price_obj->razdvizniye_4->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-3">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->razdvizniye_4 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-3" role="tabpanel" aria-labelledby="<?=$key_w?>-type-3">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/sliding-windows-3.d1f0158f.png" class="mt-lg-4 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->razdvizniye_4->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Виды раздвижных окон</h2>
         <p>Раздвижные окна – подходящий вариант для небольшого помещения. Принцип функционирования конструкции основывается на горизонтальном скольжении створок вправо-влево. Небольшое поднятие окон над направляющим механизмом обеспечивает их плавное перемещение.</p>
         <p>Раздвижная система состоит из нескольких элементов:</p>
         <ol>
            <li>Рамы.</li>
            <li>Ролика.</li>
            <li>Щеточного и резинового уплотнителя.</li>
            <li>Отлива.</li>
            <li>Стеклопакета.</li>
            <li>Створки.</li>
         </ol>
         <p>По типу материала сдвижные оконные блоки бывают:</p>
         <ul>
            <li>· стеклокомпозитные – устойчивые к выцветанию, коррозии и деформации, имеет низкую теплопроводность;</li>
            <li>· алюминиевые – недорогие, состоят из легкого профиля, створки прилегают не герметично, пропускают холод;</li>
            <li>· металлопластиковые – отличаются плотной структурой, герметичные, защищены от попадания влаги.</li>
         </ul>
         <p>Популярностью пользуются раздвижные металлопластиковые окна. Их конструкция подбирается с учетом типа раздвигания створок. Сдвижные виды по механизму передвижения бывают:</p>
         <ul>
            <li>· с параллельными сдвигаемыми створками;</li>
            <li>· с вертикальными раздвигаемыми створками;</li>
            <li>· с поворотными сдвижными фрамугами;</li>
            <li>· порталы или панорамные окна.</li>
         </ul>
         <p>Модели с параллельными створками являются распространенным типом. Чаще устанавливаются в частных домах. Принцип работы базируется наподобие открывания двери-купе. Оконные створки передвигаются роликами на рельсах. Наличие глухой створки препятствует движению рабочей фрамуги за пределы оконного блока. Такой тип окна отличается простотой, надежностью, повышенной теплоизоляцией.</p>
         <p>В вертикальных раздвижных конструкциях рабочая фрамуга открывается, приподнимаясь вверх по отвесу. В конструкции нет петель, многие модели изготавливаются без ручек. Для вертикальных моделей требуется фурнитура для фиксирования оконного блока в нужном направлении.</p>
         <p>Изделия с поворотно-сдвижными створками представляют собой сложный механизм. Створка перемещается посредством сдвигания на себя. Имеется вертикальное открывание для проветривания.</p>
         <p>Окна-порталы представляют собой широкоформатную систему, изготовленную из прочного ламинированного стекла. Такая конструкция визуально увеличивает пространство, наполняет дом большим количеством солнечного света. По способу открывания аналогичны поворотно-раздвижным моделям.</p>
         <h2 class="title-post">Особенности раздвижных окон</h2>
         <p>Раздвижные пластиковые оконные блоки обладают аналогичными характеристиками, как и традиционные изделия из пластика. Универсальные сдвижные системы устанавливаются для П- и Г- образных лоджий и балконов.</p>
         <p>Размер конструкции без импостов варьируется в пределах 1,5 метра в ширину и 2,5 метров в высоту. Количество створок может быть разным. Элементы рамы занимают небольшую часть оконной площади, что экономит пространство.</p>
         <p>Зачастую в качестве остекления используются панорамные окна. Установка массивных светопрозрачных конструкций – отличный вариант сделать маленькое помещение уютным и комфортным, создать зону отдыха в квартире.</p>
         <h2 class="title-post">Преимущества раздвижных окон</h2>
         <p>Конструкции из металлопластика имеют некоторые преимущества:</p>
         <ol>
            <li>Подходят для остекления маленького балкона.</li>
            <li>Используются в качестве подоконника.</li>
            <li>Москитная сетка отодвигается легко, по принципу створки.</li>
            <li>Изготавливаются для оконной коробки любого размера и формы.</li>
            <li>Легко моются и эксплуатируются.</li>
            <li>Надежные и долговечные.</li>
            <li>Защищают дом от посторонних звуков и шумов, погодных условий, пыли и грязи.</li>
            <li>Сохраняют тепло.</li>
            <li>Передвигаются за счет легкой фиксации створок.</li>
         </ol>
         <p>Благодаря использованию оригинальной фурнитуры срок эксплуатации конструкций из ПВХ продлевается.</p>
         <h2 class="title-post">Цены на раздвижные окна</h2>
         <p>Цены на раздвижные окна в Киеве отличаются доступностью и зависят от:</p>
         <ul>
            <li>· механизма;</li>
            <li>· размеров оконной конструкции;</li>
            <li>· материала;</li>
            <li>· профильной системы;</li>
            <li>· фурнитуры;</li>
            <li>· вида стеклопакета;</li>
            <li>· услуг монтажа.</li>
         </ul>
         <p>Стоимость может увеличиваться за счет нестандартной формы и больших размеров оконной конструкции.</p>
         <h2 class="title-post">Раздвижные окна на балкон</h2>
         <p>Чтобы правильно подобрать раздвижные окна на балкон, следует придерживаться ряда рекомендаций:</p>
         <ol>
            <li>Выбирайте проверенного производителя с сертификатом качества.</li>
            <li>Не экономьте на фурнитуре, стеклопакетах, профиле.</li>
            <li>Доверьте установку специалистам. Профессиональный монтаж гарантирует долговечность конструкции.</li>
            <li>При покупке не забудьте узнать правила ухода за изделием. Правильный уход продлит срок службы оконной конструкции.</li>
         </ol>
         <p>Наша компания «Windows Group» предлагает купить пластиковые раздвижные конструкции в Украине по выгодным ценам. Узнать стоимость можно на сайте или по телефону. У нас вы сможете заказать окна с гарантией и доставкой по Киеву и области.</p>
      </div>
   </section>
