...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
            <h1 class="title-post">Слуховые ПВХ (пластиковые) окна в Киеве – цены</h1>
            <p class="text-custom-page">
             Слуховое окно – это конструкция, установленная на чердаке или мансардном этаже.
                Является одним из неотъемлемых элементов кровли, придавая необычный и роскошный облик зданию.</p>
             <p class="text-custom-page">Компания «Windows Group» предлагает купить слуховые окна в Киеве и области по лучшим ценам.
                 На сайте в каталоге представлены на заказ модели с любым цветом и дизайном от популярных производителей.
            </p>
         </div>
         ...
         <?php 
            ...
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_sluhovye' ");
            $price_obj = json_decode($result_params[0]->data);
         
         ?>
         
         <div class="block-windows-type-1">
            <h2 class="title-block-type-windows">Треугольник Глухое без Перемычки</h2>
            <span class="small-title">Размер 1000 х 700 мм, Цена от <span class="min-price"><?=$price_obj->treugolnik_bez_peremichky->min?></span> грн до <span class="max-price"><?=$price_obj->treugolnik_bez_peremichky->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-open">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->treugolnik_bez_peremichky as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-open" role="tabpanel" aria-labelledby="<?=$key_w?>-open">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/dormer-type-1.8ca6ee60.png" class="mt-lg-5 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->treugolnik_bez_peremichky->$key_w;
                              $j = 0;
         ...
         <div class="block-windows-type-2">
            <h2 class="title-block-type-windows">Треугольник Глухое с Перемычкой</h2>
            <span class="small-title">Размер 1000 х 700 мм, Цена от <span class="min-price"><?=$price_obj->treugolnik_s_peremichkoy->min?></span> грн до <span class="max-price"><?=$price_obj->treugolnik_s_peremichkoy->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->treugolnik_s_peremichkoy as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>" role="tabpanel" aria-labelledby="<?=$key_w?>">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/dormer-type-2.b8b1decc.png" class="mt-lg-5 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->treugolnik_s_peremichkoy->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-3">
            <h2 class="title-block-type-windows">Треугольник без Перемычки которое Открывается Вверх</h2>
            <span class="small-title">Размер 1000 х 700 мм, Цена от <span class="min-price"><?=$price_obj->treugolnik_bez_peremichky_vverh->min?></span> грн до <span class="max-price"><?=$price_obj->treugolnik_bez_peremichky_vverh->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-3">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->treugolnik_bez_peremichky_vverh as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-3" role="tabpanel" aria-labelledby="<?=$key_w?>-type-3">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/dormer-type-3.4e194d71.png" class="mt-lg-5 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->treugolnik_bez_peremichky_vverh->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-4">
            <h2 class="title-block-type-windows">Треугольник с Перемычкой, которое Открывается Напополам</h2>
            <span class="small-title">Размер 1500 х 800 мм, Цена от <span class="min-price"><?=$price_obj->treugolnik_s_peremichkoy_napopolam->min?></span> грн до <span class="max-price"><?=$price_obj->treugolnik_s_peremichkoy_napopolam->max?></span> грн</span>
            <ul class="nav nav-tabs" id="myTab-type-4" role="tablist">
            ...
            <div class="tab-content" id="myTabContent-type-4">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->treugolnik_s_peremichkoy_napopolam as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-4" role="tabpanel" aria-labelledby="<?=$key_w?>-type-4">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/dormer-type-4.f1e1839c.png" class="mt-lg-5 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->treugolnik_s_peremichkoy_napopolam->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-5">
            <h2 class="title-block-type-windows">Открывается Посредине</h2>
            <span class="small-title">Размер 1500 х 800 мм, Цена от <span class="min-price"><?=$price_obj->otkrivaetsa_poseredine->min?></span> грн до <span class="max-price"><?=$price_obj->otkrivaetsa_poseredine->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-5">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->otkrivaetsa_poseredine as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-5" role="tabpanel" aria-labelledby="<?=$key_w?>-type-5">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/dormer-type-5.916565da.png" class="mt-lg-5 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->otkrivaetsa_poseredine->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-6">
            <h2 class="title-block-type-windows">Открывается Посредине</h2>
            <span class="small-title">Размер 1500 х 800 мм, Цена от <span class="min-price"><?=$price_obj->otkrivaetsa_poseredine_2->min?></span> грн до <span class="max-price"><?=$price_obj->otkrivaetsa_poseredine_2->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-6">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->otkrivaetsa_poseredine_2 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-6" role="tabpanel" aria-labelledby="<?=$key_w?>-type-6">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/dormer-type-6.0b8f8e5f.png" class="mt-lg-5 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->otkrivaetsa_poseredine_2->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-7">
            <h2 class="title-block-type-windows">Полукруглое Глухое</h2>
            <span class="small-title">Размер 1000 х 500 мм, Цена от <span class="min-price"><?=$price_obj->polukrugloe_gluhoe->min?></span> грн до <span class="max-price"><?=$price_obj->polukrugloe_gluhoe->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-7">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->polukrugloe_gluhoe as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-7" role="tabpanel" aria-labelledby="<?=$key_w?>-type-7">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/dormer-type-7.3259b3a5.png" class="mt-lg-5 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->polukrugloe_gluhoe->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-8">
            <h2 class="title-block-type-windows">Полукруглое Глухое с Открыванием</h2>
            <span class="small-title">Размер 1720 х 1350 мм, Цена от <span class="min-price"><?=$price_obj->polukrugloe_gluhoe_s_otkrivaniem->min?></span> грн до <span class="max-price"><?=$price_obj->polukrugloe_gluhoe_s_otkrivaniem->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-8">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->polukrugloe_gluhoe_s_otkrivaniem as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-8" role="tabpanel" aria-labelledby="<?=$key_w?>-type-8">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/dormer-type-8.124962f0.png" class="mt-lg-5 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->polukrugloe_gluhoe_s_otkrivaniem->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Преимущества и недостатки слуховых окон</h2>
         <p>Основная функция слухового окна – обеспечивать поступление солнечного света на крышу. Благодаря естественному источнику освещения в помещении отсутствует необходимость использования светильников. Второй значимой функцией является проветривание комнаты. Это важно для предотвращения плесени и затхлости.</p>
         <p>При правильном размещении слухового окна на крыше упрощается очистка кровли от мусора, опавших листьев и снега. Через чердачное евроокно можно эвакуироваться из дома при пожаре или наводнении. Также мансардная оконная конструкция позволяет проникать на крышу для осуществления ремонтных работ.</p>
         <p>Слуховые оконные конструкции имеют некоторые недостатки:</p>
         <ul>
         ...
         <p>Виды слуховых окон различаются по дизайну:</p>
         <ul>
         ...
         <p>Трапециевидное слуховое окно на фронтоне применяется в качестве архитектурного элемента в нетиповом строительстве. Несложная конструкция отлично вписывается под любой тип крыши. При остеклении частных домов со скатными крышами, трапециевидная модель заполняет сложные части фасада, а также увеличивает площадь внутреннего освещения и остекления.</p>
         <p>Треугольное слуховое окно с жалюзийной решеткой является частью жилого подкровельного помещения. Для открывания треугольной модели используется поворотно-откидной механизм. Регулируемая жалюзийная решетка обеспечивает вентиляцию чердака. При определенном повороте лопастей контролируется скорость втягивания и вытягивания воздуха.</p>
         <p>Треугольная форма позволяет создавать большие оконные конструкции. Остекление треугольными конструкциями также применяется на объектах со сложной крышей.</p>
         <p>Полукруглые чердачные окна смотрятся оригинально в полукруглой кровле. Модели получили второе название “летучая мышь”, на что указывает форма евроокна.</p>
         <p>Круглые слуховые окна на чердаке чаще всего бывают с одной или двумя распашными створками. Могут быть глухими, без возможности прямого проветривания. Данный тип используется нечасто из-за сложности осуществления монтажа.</p>
         <p>Отдельной разновидностью являются панорамные евроокна и стеклянные “фонари”. Изделия устанавливаются в большие оконные проемы. Установка панорамных конструкций значительно увеличивает пространство мансарды. Расширение площади позволяет создать отдельную комнату на верхнем этаже. Панорамные модели ставятся под крышей в оранжереях, зимних садах, бассейнах, бильярдных залах. Дополнительно для безопасности модели обрамляются решеткой.</p>
         <p>Евроокна фонарного типа могут выступать над плоскостью или быть выпуклыми в виде пирамиды, полусферы или купола. Для их изготовления используется прочный материал и противоударное стекло. Применяются оконные фонари на складах, в частном домостроении, торговых и развлекательных центрах, офисных помещениях, бассейнах.</p>
         <h2 class="title-post">Как выбрать</h2>
         <p>Чтобы подобрать слуховые окна на кровле, необходимо учитывать следующие нюансы:</p>
         <ol>
            <li>Модель изделия зависит от вида кровли.</li>
            <li>При выборе расположения учитывается то, что монтаж не производится близко к краям крыши.</li>
            <li>Не рекомендуется устанавливать в северной части дома.</li>
            <li>Расположение на торцевой стороне крыши обеспечивает минимальное освещение подкровельного помещения.</li>
            <li>От прочности установленного стеклопакета зависит тепло-, звуко- и гидроизоляция мансарды.</li>
            <li>Качество фурнитуры влияет на надежность и долговечность евроокна.</li>
            <li>Наличие уплотнительного резинового контура обеспечивает герметичность конструкции.</li>
            <li>Дополнительные опции в виде рольставней, жалюзи защитят дом от взлома, осадков и солнечных лучей.</li>
         </ol>
         <p>При выборе изделия следует учитывать параметры оконного проема и функциональные характеристики слуховой конструкции.</p>
         <h2 class="title-post">Цены на слуховые окна</h2>
         <p>Цена слухового окна зависит от ряда факторов:</p>
         <ul>
            <li>· вида конструкции;</li>
            <li>· типа используемого профиля и стеклопакета;</li>
            <li>· механизма открывания;</li>
            <li>· наличия резинового уплотнителя;</li>
            <li>· ламинации.</li>
         </ul>
         <p>Наши специалисты готовы осуществить замеры и проконсультировать по функциональным характеристикам евроокна. Узнать цены можно на нашем сайте в прайсе или позвонив по телефону.</p>
      </div>
   </section>
      ...
      <div class="container">
         ...
         <ul class="list-other-type-windows">
            <li class="item-other-type-windows">
               <div class="block-img-other all-img"><img src="<?php bloginfo('template_url') ?>/images/ecern-windows.d7b8ef07.png" class="img-fluid" alt="photo"></div>
               <a href="<?=get_bloginfo('home')?>/plastikovye-okna/erkernye/" class="title-footer">Эркерные</a>
            </li>
            <li class="item-other-type-windows"><img src="<?php bloginfo('template_url') ?>/images/uglovye-metalloplastikovye-okna.ddbef6a3.jpg" class="img-fluid" alt="photo"> <a href="<?=get_bloginfo('home')?>/plastikovye-okna/uglovye/" class="title-footer">Угловые</a></li>
            <li class="item-other-type-windows">
               <div class="block-img-other p-0"><img src="<?php bloginfo('template_url') ?>/images/cycle.a7c36460.webp" class="p-2 img-fluid" alt="photo"></div>
               <a href="<?=get_bloginfo('home')?>/plastikovye-okna/kruglye/" class="title-footer">Круглые</a>
            </li>
         </ul>
      </div>
   </section>
