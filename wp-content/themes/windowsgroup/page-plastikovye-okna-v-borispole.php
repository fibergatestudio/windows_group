...
<div class="main page-windows">
    ...
    <section class="section-calculator">
        <div class="container">
            <div class="top-post-page">
                <h1 class="title-post  mb-lg-3">Пластиковые окна в Борисполе: цена с установкой</h1>
                <p class="text-custom-page">
                    Компания «Windows Group» предлагает надежные <span class="strong-text">пластиковые окна в Борисполе</span>. Мы гарантируем качество продукции и всех своих услуг. Цена на металлопластиковые окна и двери —  наиболее доступная в Украине.
                </p>
                <p class="text-custom-page">
                    Каждый квадратный метр ПВХ-окон — гарантия сохранения тепла. «Windows Group»  — не только продажа, но и обновление стеклопакетов под ключ. Каждый клиент всегда найдет качественные окна дешевле благодаря регулярным скидкам.
                </p>
            </div>
            <h2 class="title-section">Калькулятор Окон в Борисполе</h2>
    ...
    <section class="section-slider-type-profil">
        ...
        <?php 
            ...
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_v_borispole' ");
    ...
    <section class="section-post section-post-windows  post-page-agency">
        <div class="container">
            <h2 class="title-section">Почему стоит заменить металлопластиковые окна с «Windows Group»?</h2>
            <p class="mb-2">Когда наступает время поменять окна, нужно искать компанию, которая бы могла предложить продукцию надежных производителей и недорого. В нашей компании, клиенты получают полный спектр услуг по замене окон в Борисполе, включая работу замерщика, установку, даже создание стеклопакета под заказ.</p>
            <p class="mb-2">Мы предлагаем своим клиентам:</p>
            <ul class="list-style-disc">
                <li>Качественную, быструю, профессиональную установку окон ПВХ. Наша репутация и выполнение всех обязательств имеют огромное значение. Поэтому все работы проводятся точно в срок.</li>
                <li>Большой выбор продукции. Клиенту легко заказать стеклопакеты для офисов, коммерческих помещений, квартир, т.д. В зависимости от пожеланий заказчика осуществляется подбор идеального варианта. Компания производит стеклопакеты, отвечающие всем требованиям качества и долговечности.</li>
                <li>Соблюдение всех стандартов качества. «Windows Group» гарантирует, что вся продукция, в том числе стеклопакеты, создается с соблюдением всех требований ДСТУ, европейских и международных стандартов. </li>
            </ul>
            <p class="mb-2">Заказчику гарантируется демократичная стоимость любых конструкций. «Windows Group» позволяет легко <a href="https://windowsgroup.com.ua/">установить пластиковые окна недорого</a> просто потому, что мы сами занимаемся производством ПВХ-изделий. Специалисты помогут заменить оконные системы без потери лишних денег.</p>
            <h2 class="title-post">Как рассчитать стоимость пластиковых окон?</h2>
            <p class="mb-2">Стоимость металлопластиковых окон зависит сразу от многих параметров. Ее можно просчитать, учитывая параметры:</p>
            <ul class="list-style-disc">
                <li>точных замеров;</li>
                <li>выбора базовой комплектации, дополнительных деталей;</li>
                <li>особенностей модели: количества камер (двухкамерные, трехкамерные, т.д.), фурнитур, страны производства (Германия, Украина, т.д.).</li>
            </ul>
            <p class="mb-2">Обычно цены на пластиковые окна с завода могут зависеть от сложности их монтажа. </p>
            <h3 class="title-post">Как рассчитать стоимость окна на заказ?</h3>
            <p class="mb-2">Для того, чтобы провести примерный расчет стоимости пластикового окна, можно воспользоваться удобным калькулятором прямо на сайте. В нем вам достаточно указать:</p>
            <ul class="list-style-disc">
                <li>тип конструкции ( балкон, лоджия, окно, проч.);</li>
                <li>тип оконной конструкции;</li>
                <li>характеристики фурнитуры;</li>
                <li>профильную систему (профиль Rehau или другой);</li>
                <li>тип стеклопакетов.</li>
            </ul>
            <p class="mb-2">Чтобы понять, какова в итоге будет цена на пластиковые окна, необходимо указать точные размеры. Калькулятор позволяет рассчитать стоимость дополнительных механизмов, позволяющих комплектовать кастомные заказы. Точную цифру, сколько стоит установка пластиковых окон в Борисполе, можно узнать только после детальной консультации. Калькулятор необходим для подсчета примерной суммы. Так проще создать бюджет.</p>
            <h2 class="title-post">Как выбрать продукцию чтобы заменить металлопластиковые окна?</h2>
            <p class="mb-2">На сайте можно купить пластиковые окна на балкон, для панорамного остекления или стандартных оконных конструкций. При выборе подобной продукции специалисты рекомендуют обратить внимание на такие общие нюансы:</p>
            <ol>
                <li>Форма окон (квадратное окно, круглое, т.д.) Каждое строение имеет свои архитектурные особенности, поэтому форма пластиковых окон важна.</li>
                <li>Качество профиля. В каталоге есть профиль Rehau или изделия других надежных компаний.</li>
                <li>Способ монтажа, материал герметизации.</li>
                <li>Сложность фурнитуры.</li>
                <li>Особенности конфигурации, подгон по размеру.</li>
                <li>Страна, завод производства (немецкие, украинские, проч.)</li>
            </ol>
            <p class="mb-2">Естественно, установить окна в комнату и на балкон — это два разных процесса. Поэтому выбирать продукцию следует разную.</p>

            <h3 class="title-post">Продукция для помещений</h3>
            <p class="mb-2">У нас можно <a href="https://windowsgroup.com.ua/plastikovye-okna/kruglye/">заказать круглые металлопластиковые окна</a>, прочные изделия нестандартных форм и конфигураций. При подборе продукции особое внимание стоит уделить количеству камер. В помещении оконные конструкции должны быть особенно теплые. Балкон создает дополнительную защиту от холода. Но в комнатах такого барьера нет. Параметр энергосбережения напрямую зависит от качества оконных рам, особенностей монтажа, фурнитуры.</p>
            <p class="mb-2">«Windows Group» предлагает заказать металлопластиковые окна индивидуального отлива. Наш специалист сделает точные замеры, чтобы создать идеальную конструкцию. К ним подбирается правильный подоконник.</p>
            <p class="mb-2">Не менее важный момент — цвет ПВХ. Часто в помещении лучше выглядят коричневые модели. После подбора всех этих параметров можно рассчитать стоимость конструкции, дополнительных услуг.</p>

            <h3 class="title-post">Остекление балконов</h3>
            <p class="mb-2">Большой или маленький балкон под ключ — самое простое решение. Специалисты помогут подобрать не только сам стеклопакет, но также:</p>
            <ul class="list-style-disc">
                <li>фурнитуру (петли, оконные ручки, москитные сетки, т.д.);</li>
                <li>способ монтажа (монтажная пена, нестандартные материалы);</li>
                <li>тип дверей, глухое остекление.</li>
            </ul>
            <p class="mb-2">Мы поможем подобрать доступные варианты высокого качества. Прочность, надежность, долговечность продукции проверяется еще при производстве. Клиентам не придется долго искать подходящий вариант.</p>

            <h2 class="title-post">Как можно оплатить и заказать остекление в Борисполе?</h2>
            <p class="mb-2">Финансовые трудности в процессе ремонта — распространенная проблема. Демонтаж старых конструкций, доставка нужных материалов, непредвиденные строительные работы — все это требует денег. Поэтому мы предлагаем купить металлопластиковые окна в рассрочку. Так вы сможете осуществить покупку лучшего товара, оплачивая его постепенно.</p>
            <p class="mb-2">Как сделать заказ? Достаточно воспользоваться калькулятором на сайте и оставить свои контактные данные. Менеджер продаж свяжется с вами в самые короткие сроки. Специалист уточнит наличие товара на складе, термины изготовления окон, список необходимых работ. Период изготовления в стандартных ситуациях составляет 2-3 дня.</p>
            <p class="mb-2">«Windows Group» предоставляет все гарантии качества. После составления договора, создаются все условия для плодотворного сотрудничества. Просто свяжитесь с нами любым удобным способом. Специалисты предложат оптимальные варианты недорого.</p>
