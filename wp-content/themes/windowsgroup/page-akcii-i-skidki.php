...
<div class="main page-sales">
   <section class="section-welcome-page bg-welcome-page-sales">
      <div class="container">
         <div class="text-welcome">
            <h1>Акции и Скидки от компании Windows Group 2021!</h1>
            <!--<span class="text-custom-page">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua</span>-->
         </div>
      </div>
   </section>
   <section class="section-sales">
      <div class="container">
         ...
         <div class="block-section-sales">
            <div class="block-img-sales"></div>
            <div class="info-sales">
               <h2 class="title-block">На данный момент акции и скидки отсутствуют</h2>
               <p>Мы постоянно пытаемся радовать наших клиентов и по этому следите за нашим сайтом, чтобы не упустить свой шанс получить приятный бонус</p>
            </div>
         </div>
      </div>
   </section>
   ...
   <section class="section-post">
      <div class="container">
         <h2 class="title-section">Акции и скидки на пластиковые ПВХ окна</h2>
