...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
             <h1 class="title-post">Панорамные ПВХ (пластиковые) окна в Киеве – цены</h1>
             <p class="text-custom-page">Панорамные окна – тип остекления, который занимает стену или ее часть от потолка до пола. Современные технологии позволяют применять такое остекление в разных зданиях. Массивные светопрозрачные оконные конструкции востребованы как в квартире, так и в частном доме.</p>
             <p class="text-custom-page">Применяются в интерьерах разных стилей – от классического до ультрасовременного.
                 Конструкции помогают подчеркнуть динамичность пространства, создать неповторимую атмосферу.</p>
         </div>

         <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_panoramniye' ");
            $price_obj = json_decode($result_params[0]->data);
         
         ?>
         
         <div class="block-deadlight">
            <h2 class="title-block-type-windows">Панорамные Окна</h2>
            <span class="small-title">Размер 3000 х 2600 мм, Цена от <span class="min-price"><?=$price_obj->panoramniye->min?></span> грн до <span class="max-price"><?=$price_obj->panoramniye->max?></span> грн</span>
            <ul class="nav nav-tabs" id="myTab" role="tablist">
               <li class="nav-item"><a class="nav-link active" id="wdc-tab" data-toggle="tab" href="#wds" role="tab" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/WDS-logo-1.5f37c8d5.svg" class="WDS-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="windoffs-tab" data-toggle="tab" href="#windoffs" role="tab" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/logo-new-windoffs-1.590253c8.svg" class="windoffs-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="viknaland-tab" data-toggle="tab" href="#viknaland" role="tab" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/viknaland-logo-1.a67c333c.svg" class="viknaland-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="rehau-tab" data-toggle="tab" href="#rehau" role="tab" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/rehau-logo-1.5dbf9707.svg" class="rehau-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="salamander-tab" data-toggle="tab" href="#salamander" role="tab" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/salamander-logo-1.4fa97951.svg" class="salamander-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="kbe-tab" data-toggle="tab" href="#kbe" role="tab" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/kbe-logo-1.0d5c807a.svg" class="kbe-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="opentek-tab" data-toggle="tab" href="#opentek" role="tab" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="veka-tab" data-toggle="tab" href="#veka" role="tab" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/veka-logo-1.5a1822d9.svg" class="veka-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="aluplast-tab" data-toggle="tab" href="#aluplast" role="tab" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/aluplast-logo-1.19c32497.svg" class="aluplast-logo img-fluid" alt="photo"></a></li>
            </ul>
            <div class="tab-content" id="myTabContent">

               <?php 
               $k = 0;
               foreach ($price_obj->panoramniye as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>" role="tabpanel">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/panoramic-1.f7a9a035.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->panoramniye->$key_w;
                              $j = 0;
         ...
         <div class="block-open">
            <h2 class="title-block-type-windows">Панорамные Окна</h2>
            <span class="small-title">Размер 3000 х 2600 мм, Цена от <span class="min-price"><?=$price_obj->panoramniye_2->min?></span> грн до <span class="max-price"><?=$price_obj->panoramniye_2->max?></span> грн</span>
            <ul class="nav nav-tabs" id="myTab-open" role="tablist">
               <li class="nav-item"><a class="nav-link active" id="wdc-open-tab" data-toggle="tab" href="#wds-open" role="tab" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/WDS-logo-1.5f37c8d5.svg" class="img-fluid WDS-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="windoffs-open-tab" data-toggle="tab" href="#windoffs-open" role="tab"  aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/logo-new-windoffs-1.590253c8.svg" class="img-fluid windoffs-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="viknaland-open-tab" data-toggle="tab" href="#viknaland-open" role="tab" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/viknaland-logo-1.a67c333c.svg" class="viknaland-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="rehau-open-tab" data-toggle="tab" href="#rehau-open" role="tab" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/rehau-logo-1.5dbf9707.svg" class="rehau-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="salamander-open-tab" data-toggle="tab" href="#salamander-open" role="tab" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/salamander-logo-1.4fa97951.svg" class="salamander-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="kbe-open-tab" data-toggle="tab" href="#kbe-open" role="tab" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/kbe-logo-1.0d5c807a.svg" class="img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="opentek-open-tab" data-toggle="tab" href="#opentek-open" role="tab"  aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="veka-open-tab" data-toggle="tab" href="#veka-open" role="tab" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/veka-logo-1.5a1822d9.svg" class="veka-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="aluplast-open-tab" data-toggle="tab" href="#aluplast-open" role="tab" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/aluplast-logo-1.19c32497.svg" class="aluplast-logo img-fluid" alt="photo"></a></li>
            </ul>
            <div class="tab-content" id="myTabContent-open">

               <?php 
               $k = 0;
               foreach ($price_obj->panoramniye_2 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-open" role="tabpanel" >
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/panoramic-2.46df3085.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->panoramniye_2->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
      ...
      <div class="container">
         ...
         <ul class="list-top-product">
            ...
            <li class="block-item-product">
               ...
               <p>Позаботьтесь о безопасности ваших детей</p>
            </li>
         </ul>
      </div>
   </section>
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Где устанавливаются панорамные окна</h2>
         <p>Окна панорама используются для следующих типов объектов:</p>
         <ul>
            <li>· балконов;</li>
            <li>· веранд;</li>
            <li>· теплиц;</li>
            ...
            <li>· террас;</li>
            <li>· бассейнов;</li>
            <li>· крытых беседок;</li>
            <li>· внутренних помещений.</li>
         </ul>
         <p>Кроме того применяются в качестве дополнения эркеров – оригинальных архитектурных элементов.</p>
         <h2 class="title-post">Плюсы и минусы</h2>
         <p>Основными преимуществами панорамных конструкций являются:</p>
         <ol>
            <li>Респектабельный внешний вид.</li>
            <li>Обзор пейзажей в любое время суток.</li>
            <li>Увеличение пространства.</li>
            <li>Отличная освещенность помещений.</li>
            <li>Сохранение тепла в комнате.</li>
            <li>Защита от шума.</li>
         </ol>
         <p>Кроме плюсов выделяют также и минусы использования такого остекления:</p>
         <ol>
            <li>Отсутствие уединенности.</li>
            <li>Необходимость применения безопасного стекла и противовзломной фурнитуры.</li>
            <li>При остеклении на террасе необходим фундамент, выдерживающий тяжелую оконную конструкцию.</li>
            <li>Неудобство в расстановке мебели.</li>
            <li>Сложность чистки наружной оконной стороны.</li>
         </ol>
         <p>Не следует ставить мебель вплотную к панорамным конструкциям. Идеальный вариант – расположить рядом кресла, обеденный гарнитур, рабочий стол или кофейный столик.</p>
         <h2 class="title-post">Особенности</h2>
         <p>Массивные конструкции состоят из элементов:</p>
         <ul>
            <li>· профильной системы;</li>
            <li>· стеклопакетов;</li>
            <li>· фурнитуры;</li>
            <li>· декоративных опций (ламинации, тонировки, витража).</li>
         </ul>
         <p>В зависимости от оконной фурнитуры различаются по механизму: поворотно-откидные, раздвижные, гармошка, подъемно-сдвижные.</p>
         <h2 class="title-post">Разновидности панорамных окон</h2>
         <p>Существуют разновидности панорамного окна:</p>
         <ul>
            <li>· классические – распространенный тип, подходит для любых зданий;</li>
            <li>· угловые – расширяют угол обзора;</li>
            <li>· эркерные – предназначаются для оформления выступов на домах.</li>
         </ul>
         <p>Окна в пол могут укомплектовываться рамой или быть без нее. Рамный вариант предпочтительный за счет надежности и долговечности. Рекомендуется, чтобы рама была из армированного металла. Это высокопрочный материал, не подвергающийся горению, выцветанию, коррозии и деформации.</p>
         <h2 class="title-post">Как выбрать панорамные окна в Киеве</h2>
         <p>При выборе широкоформатной оконной модели, необходимо учитывать характеристики:</p>
         <ol>
            <li>Теплосбережение.</li>
            <li>Шумоизоляцию.</li>
            <li>Вентиляцию.</li>
            <li>Безопасность.</li>
            <li>Декорирование.</li>
         </ol>
         <p>В наших красочных каталогах представлены популярные панорамные окна по лучшим ценам в Киеве. Мы предлагаем купить актуальные модели по выгодной стоимости напрямую от производителя.</p>
         <h2 class="title-post">Стеклопакеты для панорамных окон</h2>
         <p>Стеклопакеты подбираются в зависимости от эксплуатации конструкции. Различают следующие виды стеклопакетов для панорамных окон:</p>
         <ul>
            <li>· бронированные (устойчивы к ударам и нагрузкам);</li>
            <li>· шумозащитные (поглощают посторонние звуки);</li>
            <li>· солнцезащитные (не пропускают инфракрасные лучи);</li>
            <li>· энергосберегающие (экономят до 50% тепла);</li>
            <li>· закаленные (универсальный за счет повышенной сопротивляемости к большим температурным перепадам).</li>
         </ul>
         <p>Бронированное стекло устанавливается на верандах, но не применяется в жарких помещениях. Солнцезащитное стекло монтируется с южной стороны фасада. Такой тип стеклопакета нормализует микроклимат, а также защищает комнату от осмотра посторонними. Энергосберегающее стекло рекомендуется для установки в северных регионах.</p>
         <h2 class="title-post">Требования к панорамным окнам</h2>
         <p>Панорамное остекление должно соответствовать нормативным требованиям по ДСТУ:</p>
         <ol>
            <li>При монтаже учитывается, что площадь одной глухой створки не может быть больше 6 кв.м, а открывающейся створки – не более 2,5 кв.м.</li>
            <li>Высота и ширина стекла допускаются в соотношении 1:5.</li>
            <li>Для мансард разрешается чтобы площадь окна и пола была в соотношении 1:10.</li>
            <li>Для тепловой и звуковой изоляции в раму вставляется специальное стекло толщиной не менее 6 мм.</li>
         </ol>
         <p>При выборе стеклопакета важно помнить, что чем больше камер устанавливается в раму, тем теплее будет окно.</p>
         <h2 class="title-post">Запотевание панорамных окон</h2>
         <p>Зачастую в квартире панорамные окна запотевают. Это связано с образованием конденсата. Существуют различные способы борьбы с каплями на стеклах:</p>
         <ul>
            <li>· поддерживать оптимальную температуру;</li>
            <li>· снижать уровень влажности;</li>
            <li>· использовать электрический обогрев стеклопакета;</li>
            <li>· монтировать вентилятор вдоль окна.</li>
         </ul>
         <p>Позвоните нам и мы изготовим конструкции различной конфигурации по индивидуальным размерам.</p>
      </div>
   </section>
