...
<div class="main page-brand-windows">
   <section class="section-welcome-page bg-servises-glass bg-one-glass">
      <div class="container">
         <div class="text-welcome">
            <img src="<?php bloginfo('template_url') ?>/images/type-windows-brand-vindoffs.590253c8.svg" class="img-brand img-fluid" alt="brand">
            <h1>окна Windoff`s</h1>
         </div>
      </div>
   </section>
   <section class="section-top">
      <div class="container">
         ...
         <h2 class="title-post title-post-top text-center">Оконный профиль Windoff`s в Киеве</h2>
         <p class="text-custom-page">
             Оконный профиль Windoffs применяется в изготовлении пластиковых окон для любого типа помещений.
             Профильная система специально адаптирована под климатические условия в Украине.
             Наша компания «Виндовс Груп» предлагает купить профильную оконную систему, соответствующую европейским технологическим стандартам.</p>
      </div>
   </section>
   ...
   <section class="section-bank brand-windows">
      <div class="container">
         <h2 class="title-section">Выберите подходящее Вам окно ПВХ Windoff`s</h2>
         <ul class="nav nav-pills nav-justified" id="pills-other-glass" role="tablist">
            <li class="nav-item active" role="presentation"><a class="nav-link active" id="pills-type-1-tab" data-toggle="pill" href="#pills-type-1" role="tab" aria-controls="pills-type-1" aria-selected="true" data-parent="#pills-other-glass"><span class="title-tab">Windoff`s 3 камерный</span> <i class="fa fa-chevron-down"></i></a></li>
            <li class="nav-item" role="presentation"><a class="nav-link" id="pills-type-2-tab" data-toggle="pill" href="#pills-type-2" role="tab" aria-controls="pills-type-2" aria-selected="false" data-parent="#pills-other-glass"><span class="title-tab">Windoff`s 5 камерный</span> <i class="fa fa-chevron-down"></i></a></li>
         </ul>
         <div class="tab-content" id="pills-other-glassContent">
            <div class="tab-pane fade show active" id="pills-type-1" role="tabpanel" aria-labelledby="pills-type-1">
               <div class="block">
                  <h2 class="title-block-bank d-none d-lg-block">Windoff`s 3 камерный</h2>
                  <div class="d-lg-flex">
                     <div class="block-left">
                        <a href="#" class="block-img"><i class="icon-flag-ukraine"></i><img src="<?php bloginfo('template_url') ?>/images/windoffs-type-1.d53d1b5c.png" class="img-fluid" alt="photo-product1"></a>
                        <div class="block-text-info">
                           <div class="list-specific">
                            ...
                            <p class="text-custom-page">Трехкамерная профильная система Windoff`s 3 с монтажной глубиной 58 мм пользуется популярностью в Украине. Широкий спрос на профиль обуславливается оптимальным соотношением цены и качества. Коэффициент сопротивления теплопередачи составляет 0,62 м²•°С/Вт.
                                Windoff`s 3 является бюджетной профильной системой, которая характеризуется повышенным уровнем энергосбережения и шумоизоляции. Простая и практичная эксплуатация конструкций из профиля шириной 58 мм позволяет надолго сохранить эстетичный вид окон.
                                Качество выпускаемых профилей Windoff`s 3 обеспечивается оригинальной рецептурной смесью, а также беспрецедентными мерами по обеспечению технологии производства оконных конструкций.
                            </p>
                        </div>
                     </div>
                  </div>
            ...
            <div class="tab-pane fade" id="pills-type-2" role="tabpanel" aria-labelledby="pills-type-2-tab">
               <div class="block">
                  <h2 class="title-block-bank d-none d-lg-block">Windoff`s 5 камерный</h2>
                  <div class="d-lg-flex">
                     <div class="block-left">
                        <a href="#" class="block-img"><i class="icon-flag-ukraine"></i><img src="<?php bloginfo('template_url') ?>/images/windoffs-type-2.7c384d49.png" class="img-fluid" alt="photo-product1"></a>
                        <div class="block-text-info">
                           <div class="list-specific">
                              <dl class="info-bank brand">
                                 <dt>Количество камер профиля:</dt>
                            ...
                            <p class="text-custom-page">Пятикамерная профильная система Windoff`s 5 с глубиной монтажа 70 мм характеризуется высоким уровнем звуко- и теплоизоляции. Предельная толщина стеклопакета составляет 4 см. Коэффициент сопротивления теплопередаче профиля 0,83 м²•°С/Вт.
                                Благодаря увеличенной ширине фальца доступна установка стеклопакета с двумя камерами толщиной 4 см. Герметичные стыки обеспечивают надежную защиту оконной конструкции от пыли, влаги и сквозняков. Комфортное использование профильной системы Windoff`s 5 достигается за счет соединения качества и практичности конструкции, а также безопасности используемых материалов.
                                Окна из пятикамерного профиля Windoff`s 5 рекомендуются для установки в регионах с суровыми климатическими условиями.
                            </p>
                        </div>
                     </div>
                  </div>
   ...
   <section class="section-table-price-brand">
      <div class="container">
         <h2 class="title-block-type-windows">Цены на окна Windoff`s</h2>
         <span class="small-title">Размер 750 х 1350 мм, 1100 х 1350 мм, 1150 х 1750 мм, 1720 х 1350 мм, Цена от <span class="min-price"><?=$price_obj->windoffs->min?></span> грн до <span class="max-price"><?=$price_obj->windoffs->max?></span> грн</span>
         <div class="tabs-table-price-brand-glass">
            ...
            <div class="tab-content" id="myTabContent">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->windoffs as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>" role="tabpanel" aria-labelledby="<?=$key_w?>-tab">
                  <div class="block-content">
                     <div class="table-tab">
                        <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/<?=$price_obj->windoffs->img[$k]?>" class="img-fluid" alt="product"></div>
                        <table class="table-windows">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 <?php
                                 $this_obj = $price_obj->windoffs->$key_w;
                                 $j = 0;
   ...
   <section class="section-like-type">
      <div class="container">
         <h2 class="title-section">Преимущества Окон Windoff`s</h2>
      ...
      <div class="container">
         <div class="block-buy-our-company">
            <div class="info-buy-our-company">
               <h2 class="title-section">Почему стоит заказать окна Windoff`s у WindowsGroup</h2>
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <div class="text-custom-page">
            <h2 class="title-section">Почему популярны oконный профиль Windoff`s</h2>
            ...
            <p>Профиль Windoffs имеет спрос у покупателей за счет отличных функциональных характеристик. Основным достоинством профильной системы является совместимость евроокон с украинским климатом.</p>
            <p>В производстве используется ПВХ материал, устойчивый к низким температурам. В изготовлении применяется трехконтурная система контурного уплотнения. Благодаря такой технологии обеспечивается защита помещения от холода, внешних шумов и загрязнений.</p>
            <h2 class="title-post">Виды и серии профилей</h2>
            <p>Windoffs производит следующие серии оконного профиля:</p>
            <ul>
               <li>· Windoff's 58 mm;</li>
               <li>· SCHON 70 mm.</li>
            </ul>
            ...
            <p>Windoff's 58 mm – профильная система, состоящая из трех воздушных камер. Оконные системы с профильной шириной 58 мм пользуются популярностью в Украине. Спрос на продукцию обуславливается соотношением цены, качества и практичности. Windoff's 58 mm обеспечивает повышенную шумо- и теплоизоляцию помещения.</p>
            <p>Шестикамерная профильная система SCHON 70 mm характеризуется высоким уровнем тепловой и звуковой защиты. Максимальная толщина установки стеклопакета составляет 40 мм. Система повышенного комфорта отличается герметичностью и надежностью оконной конструкции.</p>
            <h2 class="title-post">Преимущества</h2>
            <p>Окна из Windoffs профиля обладают несколькими преимуществами:</p>
            <ol>
               <li>Устойчивостью конструкции за счет армирования металла.</li>
               <li>Надежностью и практичностью.</li>
               <li>Повышенным энергосбережением, тепло- и шумоизоляцией.</li>
               <li>Возможностью доукомплектования фурнитурой и деталями других оконных производителей.</li>
               <li>Эстетичностью.</li>
            </ol>
            <p>В ассортименте Windoffs представлен широкий выбор оконных конструкций с декоративным оформлением и стилевыми направлениями.</p>
            ...
            <p>Классическая профильная ширина в 58 мм применяется в жилых помещениях. Система с шириной 70 мм используется при производстве окон для сурового климата.</p>
            <p>Для установки окон в офисных помещениях или квартирах следует отдать предпочтение двухкамерным стеклопакетам. Однокамерные стеклопакеты используются при обустройстве балконов, лоджий, террас или веранд.</p>
            <p>Положительные отзывы о профиле Windoffs подтверждают отличные функциональные и эксплуатационные характеристики пластиковых евроокон.</p>
            ...
            <p>При выборе профиля существует ряд нюансов:</p>
            <ol>
               <li>Поверхность профиля должна быть однородной, без разводов, царапин и повреждений.</li>
               <li>Толщина профильной системы должна быть одинаковой по всему периметру от 2,5 до 3 мм. Тонкие профили не рекомендуется использовать в тяжелых оконных конструкциях по причине слабости сварочных швов.</li>
               <li>Количество воздушных камер зависит от ширины окна. Чем больше камер, тем теплее евроокно ПВХ.</li>
               <li>Двойной стеклопакет обеспечивает улучшенное энергосбережение и звукоизоляцию.</li>
            </ol>
            <p>Важно учитывать количество резинового контурного уплотнителя. Их должно быть два, в противном случае под рамой будет собираться конденсат. Появление конденсата приводит к образованию грибка, плесени, износу оконной конструкции.</p>
            <h2 class="title-post">Как проверить оригинальность</h2>
            <p>Проверить подлинность оконного профиля можно следующим образом:</p>
            <ol>
               <li>Найти лазерную маркировку на торце створки. Надпись повторяется через каждые 25 см.</li>
               <li>Проверить сертификат соответствия. На оригинале присутствует фирменный знак с голограммой.</li>
               <li>Найти маркировку на импостах и раме. На маркировке указываются ГОСТ, серия профиля с номером партии.</li>
            </ol>
            <p>Кроме того у оригинального товара незаметно спрятан уплотнитель. Контурная резиновая лента располагается по периметру оконной конструкции.</p>
            <p>Наша компания предлагает купить металлопластиковые окна из профиля Windoffs по лучшей цене в Киеве и области. Мы гарантируем качество оконных изделий и лучшее обслуживание клиентов. Узнать цены можно на сайте или позвонить по телефону.</p>
         </div>
      </div>
   </section>
