...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
            <h1 class="title-post">Пластиковые двери ПВХ в Киеве – Цены</h1>
            <p class="text-custom-page">Современные металлопластиковые конструкции являются важной составляющей стильного интерьера.
                Компания Windows Group предлагает для вас выгодное предложение – купить пластиковые двери напрямую
                от производителя по лучшим ценам в Киеве и области.
            </p>
             <p class="text-custom-page">В наших каталогах представлен широкий выбор различных моделей металлопластиковых дверей на заказ,
                 изготовленных по новым европейским технологиям.</p>
         </div>

        <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'dvery_metaloplastikovie' ");
            $price_obj = json_decode($result_params[0]->data);
         
        ?>
         
         <div class="block-windows-type-1">
            <h2 class="title-block-type-windows">Одностворчатая металлопластиковая панорамная дверь</h2>
            <span class="small-title">Размер 800 х 2000 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_1->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_1->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-open">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_1 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-open" role="tabpanel" aria-labelledby="<?=$key_w?>-open">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/1-odnostvorchataya-metalloplastikovaya-panoramnaya-dver.b3ba2de2.png" class="vertical-doors img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_1->$key_w;
                              $j = 0;
         ...
         <div class="block-windows-type-2">
            <h2 class="title-block-type-windows">Одностворчатая металлопластиковая панорамная дверь с перемычкой</h2>
            <span class="small-title">Размер 800 х 2000 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_2->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_2->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_2 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>" role="tabpanel" aria-labelledby="<?=$key_w?>">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/2-odnostvorchataya-metalloplastikovaya-dver-s-peremychkoy.a7399f2e.png" class="vertical-doors img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_2->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-3">
            <h2 class="title-block-type-windows">Одностворчатая металлопластиковая дверь с сэндвич панелью</h2>
            <span class="small-title">Размер 800 х 2000 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_3->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_3->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-3">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_3 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-3" role="tabpanel" aria-labelledby="<?=$key_w?>-type-3">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/3-odnostvorchataya-metalloplastikovaya-dver-s-sendvich-panelyu.29198d45.png" class="vertical-doors img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_3->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-4">
            <h2 class="title-block-type-windows">Одностворчатая металлопластиковая дверь с фрамугой и перемычкой</h2>
            <span class="small-title">Размер 800 х 2700 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_4->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_4->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-4">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_4 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-4" role="tabpanel" aria-labelledby="<?=$key_w?>-type-4">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/4-odnostvorchataya-metalloplastikovaya-dver-s-framugoy-i-peremychkoy.110a17fe.png" class="vertical-doors img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_4->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-5">
            <h2 class="title-block-type-windows">Одностворчатая металлопластиковая дверь с фрамугой и сэндвич панелью</h2>
            <span class="small-title">Размер 800 х 2700 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_5->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_5->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-5">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_5 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-5" role="tabpanel" aria-labelledby="<?=$key_w?>-type-5">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/5-odnostvorchataya-metalloplastikovaya-dver-s-framugoy-i-sendvich-panelyu.d25aa543.png" class="vertical-doors img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_5->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-6">
            <h2 class="title-block-type-windows">Одностворчатая металлопластиковая дверь без стекла</h2>
            <span class="small-title">Размер 800 х 2000 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_6->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_6->max?></span> грн</span>
            <ul class="nav nav-tabs" id="myTab-type-6" role="tablist">
               <li class="nav-item"><a class="nav-link active" id="wdc-type-6-tab" data-toggle="tab" href="#wds-type-5" role="tab" aria-controls="wds-type-6" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/WDS-logo-1.5f37c8d5.svg" class="img-fluid WDS-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="windoffs-type-6-tab" data-toggle="tab" href="#windoffs-type-6" role="tab" aria-controls="windoffs-type-6" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/logo-new-windoffs-1.590253c8.svg" class="img-fluid windoffs-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="viknaland-type-6-tab" data-toggle="tab" href="#viknaland-type-6" role="tab" aria-controls="viknaland-type-6" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/viknaland-logo-1.a67c333c.svg" class="viknaland-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="rehau-type-6-tab" data-toggle="tab" href="#rehau-type-6" role="tab" aria-controls="rehau-type-6" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/rehau-logo-1.5dbf9707.svg" class="rehau-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="salamander-type-6-tab" data-toggle="tab" href="#salamander-type-6" role="tab" aria-controls="salamander-type-6" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/salamander-logo-1.4fa97951.svg" class="salamander-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="kbe-open-type-6-tab" data-toggle="tab" href="#kbe-type-6" role="tab" aria-controls="kbe-type-6" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/kbe-logo-1.0d5c807a.svg" class="img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="opentek-type-6-tab" data-toggle="tab" href="#opentek-type-6" role="tab" aria-controls="opentek-type-6" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="veka-type-6-tab" data-toggle="tab" href="#veka-type-6" role="tab" aria-controls="veka-type-6" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/veka-logo-1.5a1822d9.svg" class="veka-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="aluplast-type-6-tab" data-toggle="tab" href="#aluplast-type-6" role="tab" aria-controls="aluplast-type-6" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/aluplast-logo-1.19c32497.svg" class="aluplast-logo img-fluid" alt="photo"></a></li>
            </ul>
            <div class="tab-content" id="myTabContent-type-6">

               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_6 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-6" role="tabpanel" aria-labelledby="<?=$key_w?>-type-6">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/6-odnostvorchataya-metalloplastikovaya-dver-bez-stekla.d3c3c0f0.png" class="vertical-doors img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_6->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-7">
            <h2 class="title-block-type-windows">Двухстворчатая металлопластиковая дверь с перемычкой</h2>
            <span class="small-title">Размер 1400 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_7->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_7->max?></span> грн</span>
            <ul class="nav nav-tabs" id="myTab-type-7" role="tablist">
               <li class="nav-item"><a class="nav-link active" id="wdc-type-7-tab" data-toggle="tab" href="#wds-type-7" role="tab" aria-controls="wds-type-7" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/WDS-logo-1.5f37c8d5.svg" class="img-fluid WDS-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="windoffs-type-7-tab" data-toggle="tab" href="#windoffs-type-7" role="tab" aria-controls="windoffs-type-7" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/logo-new-windoffs-1.590253c8.svg" class="img-fluid windoffs-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="viknaland-type-7-tab" data-toggle="tab" href="#viknaland-type-7" role="tab" aria-controls="viknaland-type-7" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/viknaland-logo-1.a67c333c.svg" class="viknaland-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="rehau-type-7-tab" data-toggle="tab" href="#rehau-type-7" role="tab" aria-controls="rehau-type-7" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/rehau-logo-1.5dbf9707.svg" class="rehau-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="salamander-type-7-tab" data-toggle="tab" href="#salamander-type-7" role="tab" aria-controls="salamander-type-7" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/salamander-logo-1.4fa97951.svg" class="salamander-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="kbe-open-type-7-tab" data-toggle="tab" href="#kbe-type-7" role="tab" aria-controls="kbe-type-7" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/kbe-logo-1.0d5c807a.svg" class="img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="opentek-type-7-tab" data-toggle="tab" href="#opentek-type-7" role="tab" aria-controls="opentek-type-7" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="veka-type-7-tab" data-toggle="tab" href="#veka-type-7" role="tab" aria-controls="veka-type-7" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/veka-logo-1.5a1822d9.svg" class="veka-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="aluplast-type-7-tab" data-toggle="tab" href="#aluplast-type-7" role="tab" aria-controls="aluplast-type-7" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/aluplast-logo-1.19c32497.svg" class="aluplast-logo img-fluid" alt="photo"></a></li>
            </ul>
            <div class="tab-content" id="myTabContent-type-7">

               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_7 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-7" role="tabpanel" aria-labelledby="<?=$key_w?>-type-7">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/7-dvustvorchataya-metalloplastikovaya-dver-s-peremychkoy.cc63397b.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_7->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-8">
            <h2 class="title-block-type-windows">Двухстворчатая металлопластиковая дверь с сэндвич панелью</h2>
            <span class="small-title">Размер 1400 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_8->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_8->max?></span> грн</span>
            <ul class="nav nav-tabs" id="myTab-type-8" role="tablist">
               <li class="nav-item"><a class="nav-link active" id="wdc-type-8-tab" data-toggle="tab" href="#wds-type-8" role="tab" aria-controls="wds-type-8" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/WDS-logo-1.5f37c8d5.svg" class="img-fluid WDS-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="windoffs-type-8-tab" data-toggle="tab" href="#windoffs-type-8" role="tab" aria-controls="windoffs-type-8" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/logo-new-windoffs-1.590253c8.svg" class="img-fluid windoffs-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="viknaland-type-8-tab" data-toggle="tab" href="#viknaland-type-8" role="tab" aria-controls="viknaland-type-8" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/viknaland-logo-1.a67c333c.svg" class="viknaland-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="rehau-type-8-tab" data-toggle="tab" href="#rehau-type-8" role="tab" aria-controls="rehau-type-8" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/rehau-logo-1.5dbf9707.svg" class="rehau-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="salamander-type-8-tab" data-toggle="tab" href="#salamander-type-8" role="tab" aria-controls="salamander-type-8" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/salamander-logo-1.4fa97951.svg" class="salamander-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="kbe-open-type-8-tab" data-toggle="tab" href="#kbe-type-8" role="tab" aria-controls="kbe-type-8" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/kbe-logo-1.0d5c807a.svg" class="img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="opentek-type-8-tab" data-toggle="tab" href="#opentek-type-8" role="tab" aria-controls="opentek-type-8" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="veka-type-8-tab" data-toggle="tab" href="#veka-type-8" role="tab" aria-controls="veka-type-8" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/veka-logo-1.5a1822d9.svg" class="veka-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="aluplast-type-8-tab" data-toggle="tab" href="#aluplast-type-8" role="tab" aria-controls="aluplast-type-8" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/aluplast-logo-1.19c32497.svg" class="aluplast-logo img-fluid" alt="photo"></a></li>
            </ul>
            <div class="tab-content" id="myTabContent-type-8">

               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_8 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-8" role="tabpanel" aria-labelledby="<?=$key_w?>-type-8">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/8-dvustvorchataya-metalloplastikovaya-dver-s-sendvich-panelyu.09837bf0.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_8->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-9">
            <h2 class="title-block-type-windows">Двухстворчатая металлопластиковая дверь с фрамугой и перемычкой</h2>
            <span class="small-title">Размер 1400 х 2700 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_9->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_9->max?></span> грн</span>
            <ul class="nav nav-tabs" id="myTab-type-9" role="tablist">
               <li class="nav-item"><a class="nav-link active" id="wdc-type-9-tab" data-toggle="tab" href="#wds-type-9" role="tab" aria-controls="wds-type-9" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/WDS-logo-1.5f37c8d5.svg" class="img-fluid WDS-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="windoffs-type-9-tab" data-toggle="tab" href="#windoffs-type-9" role="tab" aria-controls="windoffs-type-9" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/logo-new-windoffs-1.590253c8.svg" class="img-fluid windoffs-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="viknaland-type-9-tab" data-toggle="tab" href="#viknaland-type-9" role="tab" aria-controls="viknaland-type-9" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/viknaland-logo-1.a67c333c.svg" class="viknaland-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="rehau-type-9-tab" data-toggle="tab" href="#rehau-type-9" role="tab" aria-controls="rehau-type-9" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/rehau-logo-1.5dbf9707.svg" class="rehau-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="salamander-type-9-tab" data-toggle="tab" href="#salamander-type-9" role="tab" aria-controls="salamander-type-9" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/salamander-logo-1.4fa97951.svg" class="salamander-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="kbe-open-type-9-tab" data-toggle="tab" href="#kbe-type-9" role="tab" aria-controls="kbe-type-9" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/kbe-logo-1.0d5c807a.svg" class="img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="opentek-type-9-tab" data-toggle="tab" href="#opentek-type-9" role="tab" aria-controls="opentek-type-9" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="veka-type-9-tab" data-toggle="tab" href="#veka-type-9" role="tab" aria-controls="veka-type-9" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/veka-logo-1.5a1822d9.svg" class="veka-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="aluplast-type-9-tab" data-toggle="tab" href="#aluplast-type-9" role="tab" aria-controls="aluplast-type-9" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/aluplast-logo-1.19c32497.svg" class="aluplast-logo img-fluid" alt="photo"></a></li>
            </ul>
            <div class="tab-content" id="myTabContent-type-9">

               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_9 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-9" role="tabpanel" aria-labelledby="<?=$key_w?>-type-9">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/9-dvustvorchataya-metalloplastikovaya-dver-s-framugoy-i-peremychkoy.800a2043.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_9->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-10">
            <h2 class="title-block-type-windows">Двухстворчатая металлопластиковая дверь с фрамугой и сэндвич панелью</h2>
            <span class="small-title">Размер 1400 х 2700 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_10->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_10->max?></span> грн</span>
            <ul class="nav nav-tabs" id="myTab-type-10" role="tablist">
               <li class="nav-item"><a class="nav-link active" id="wdc-type-10-tab" data-toggle="tab" href="#wds-type-10" role="tab" aria-controls="wds-type-10" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/WDS-logo-1.5f37c8d5.svg" class="img-fluid WDS-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="windoffs-type-10-tab" data-toggle="tab" href="#windoffs-type-10" role="tab" aria-controls="windoffs-type-10" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/logo-new-windoffs-1.590253c8.svg" class="img-fluid windoffs-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="viknaland-type-10-tab" data-toggle="tab" href="#viknaland-type-10" role="tab" aria-controls="viknaland-type-10" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/viknaland-logo-1.a67c333c.svg" class="viknaland-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="rehau-type-10-tab" data-toggle="tab" href="#rehau-type-10" role="tab" aria-controls="rehau-type-10" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/rehau-logo-1.5dbf9707.svg" class="rehau-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="salamander-type-10-tab" data-toggle="tab" href="#salamander-type-10" role="tab" aria-controls="salamander-type-10" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/salamander-logo-1.4fa97951.svg" class="salamander-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="kbe-open-type-10-tab" data-toggle="tab" href="#kbe-type-10" role="tab" aria-controls="kbe-type-10" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/kbe-logo-1.0d5c807a.svg" class="img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="opentek-type-10-tab" data-toggle="tab" href="#opentek-type-10" role="tab" aria-controls="opentek-type-10" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="veka-type-10-tab" data-toggle="tab" href="#veka-type-10" role="tab" aria-controls="veka-type-10" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/veka-logo-1.5a1822d9.svg" class="veka-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="aluplast-type-10-tab" data-toggle="tab" href="#aluplast-type-10" role="tab" aria-controls="aluplast-type-10" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/aluplast-logo-1.19c32497.svg" class="aluplast-logo img-fluid" alt="photo"></a></li>
            </ul>
            <div class="tab-content" id="myTabContent-type-10">

               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_10 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-10" role="tabpanel" aria-labelledby="<?=$key_w?>-type-10">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/10-dvustvorchataya-metalloplastikovaya-dver-s-framugoy-i-sendvich-panelyu.637e78ba.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_10->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-11">
            <h2 class="title-block-type-windows">Металлопластиковые стеклянные двери на балкон с открывающимся окном</h2>
            <span class="small-title">Размер 600 х 2000 мм + 1100 х 1350 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_11->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_11->max?></span> грн</span>
            <ul class="nav nav-tabs" id="myTab-type-11" role="tablist">
               <li class="nav-item"><a class="nav-link active" id="wdc-type-11-tab" data-toggle="tab" href="#wds-type-11" role="tab" aria-controls="wds-type-11" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/WDS-logo-1.5f37c8d5.svg" class="img-fluid WDS-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="windoffs-type-11-tab" data-toggle="tab" href="#windoffs-type-11" role="tab" aria-controls="windoffs-type-11" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/logo-new-windoffs-1.590253c8.svg" class="img-fluid windoffs-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="viknaland-type-11-tab" data-toggle="tab" href="#viknaland-type-11" role="tab" aria-controls="viknaland-type-11" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/viknaland-logo-1.a67c333c.svg" class="viknaland-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="rehau-type-11-tab" data-toggle="tab" href="#rehau-type-11" role="tab" aria-controls="rehau-type-11" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/rehau-logo-1.5dbf9707.svg" class="rehau-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="salamander-type-11-tab" data-toggle="tab" href="#salamander-type-11" role="tab" aria-controls="salamander-type-11" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/salamander-logo-1.4fa97951.svg" class="salamander-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="kbe-open-type-11-tab" data-toggle="tab" href="#kbe-type-11" role="tab" aria-controls="kbe-type-11" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/kbe-logo-1.0d5c807a.svg" class="img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="opentek-type-11-tab" data-toggle="tab" href="#opentek-type-11" role="tab" aria-controls="opentek-type-11" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="veka-type-11-tab" data-toggle="tab" href="#veka-type-11" role="tab" aria-controls="veka-type-11" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/veka-logo-1.5a1822d9.svg" class="veka-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="aluplast-type-11-tab" data-toggle="tab" href="#aluplast-type-11" role="tab" aria-controls="aluplast-type-11" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/aluplast-logo-1.19c32497.svg" class="aluplast-logo img-fluid" alt="photo"></a></li>
            </ul>
            <div class="tab-content" id="myTabContent-type-11">

               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_11 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-11" role="tabpanel" aria-labelledby="<?=$key_w?>-type-11">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/11-metalloplastikovyye-steklyannyye-dveri-na-balkon-s-otkryvayushchimsya-oknom.2b37d538.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_11->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-12">
            <h2 class="title-block-type-windows">Металлопластиковые стеклянные двери на балкон с глухим окном</h2>
            <span class="small-title">Размер 600 х 2000 мм + 1100 х 1350 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_12->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_12->max?></span> грн</span>
            <ul class="nav nav-tabs" id="myTab-type-12" role="tablist">
               <li class="nav-item"><a class="nav-link active" id="wdc-type-12-tab" data-toggle="tab" href="#wds-type-12" role="tab" aria-controls="wds-type-12" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/WDS-logo-1.5f37c8d5.svg" class="img-fluid WDS-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="windoffs-type-12-tab" data-toggle="tab" href="#windoffs-type-12" role="tab" aria-controls="windoffs-type-12" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/logo-new-windoffs-1.590253c8.svg" class="img-fluid windoffs-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="viknaland-type-12-tab" data-toggle="tab" href="#viknaland-type-12" role="tab" aria-controls="viknaland-type-12" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/viknaland-logo-1.a67c333c.svg" class="viknaland-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="rehau-type-12-tab" data-toggle="tab" href="#rehau-type-12" role="tab" aria-controls="rehau-type-12" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/rehau-logo-1.5dbf9707.svg" class="rehau-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="salamander-type-12-tab" data-toggle="tab" href="#salamander-type-12" role="tab" aria-controls="salamander-type-12" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/salamander-logo-1.4fa97951.svg" class="salamander-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="kbe-open-type-12-tab" data-toggle="tab" href="#kbe-type-12" role="tab" aria-controls="kbe-type-12" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/kbe-logo-1.0d5c807a.svg" class="img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="opentek-type-12-tab" data-toggle="tab" href="#opentek-type-12" role="tab" aria-controls="opentek-type-12" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="veka-type-12-tab" data-toggle="tab" href="#veka-type-12" role="tab" aria-controls="veka-type-12" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/veka-logo-1.5a1822d9.svg" class="veka-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="aluplast-type-12-tab" data-toggle="tab" href="#aluplast-type-12" role="tab" aria-controls="aluplast-type-12" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/aluplast-logo-1.19c32497.svg" class="aluplast-logo img-fluid" alt="photo"></a></li>
            </ul>
            <div class="tab-content" id="myTabContent-type-12">

               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_12 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-12" role="tabpanel" aria-labelledby="<?=$key_w?>-type-12">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/12-metalloplastikovyye-steklyannyye-dveri-na-balkon-s-glukhim-oknom.063d4237.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_12->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-13">
            <h2 class="title-block-type-windows">Штульповые металлопластиковые стеклянные двери на балкон с глухим окном</h2>
            <span class="small-title">Размер 1200 х 2100 мм, окно 750 х 1350 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_13->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_13->max?></span> грн</span>
            <ul class="nav nav-tabs" id="myTab-type-13" role="tablist">
               <li class="nav-item"><a class="nav-link active" id="wdc-type-13-tab" data-toggle="tab" href="#wds-type-13" role="tab" aria-controls="wds-type-13" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/WDS-logo-1.5f37c8d5.svg" class="img-fluid WDS-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="windoffs-type-13-tab" data-toggle="tab" href="#windoffs-type-13" role="tab" aria-controls="windoffs-type-13" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/logo-new-windoffs-1.590253c8.svg" class="img-fluid windoffs-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="viknaland-type-13-tab" data-toggle="tab" href="#viknaland-type-13" role="tab" aria-controls="viknaland-type-13" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/viknaland-logo-1.a67c333c.svg" class="viknaland-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="rehau-type-13-tab" data-toggle="tab" href="#rehau-type-13" role="tab" aria-controls="rehau-type-13" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/rehau-logo-1.5dbf9707.svg" class="rehau-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="salamander-type-13-tab" data-toggle="tab" href="#salamander-type-13" role="tab" aria-controls="salamander-type-13" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/salamander-logo-1.4fa97951.svg" class="salamander-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="kbe-open-type-13-tab" data-toggle="tab" href="#kbe-type-13" role="tab" aria-controls="kbe-type-13" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/kbe-logo-1.0d5c807a.svg" class="img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="opentek-type-13-tab" data-toggle="tab" href="#opentek-type-13" role="tab" aria-controls="opentek-type-13" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="veka-type-13-tab" data-toggle="tab" href="#veka-type-13" role="tab" aria-controls="veka-type-13" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/veka-logo-1.5a1822d9.svg" class="veka-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="aluplast-type-13-tab" data-toggle="tab" href="#aluplast-type-13" role="tab" aria-controls="aluplast-type-13" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/aluplast-logo-1.19c32497.svg" class="aluplast-logo img-fluid" alt="photo"></a></li>
            </ul>
            <div class="tab-content" id="myTabContent-type-13">

               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_13 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-13" role="tabpanel" aria-labelledby="<?=$key_w?>-type-13">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/13-shtulpovyye-metalloplastikovyye-dveri-na-balkon-s-glukhim-oknom.57147bca.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_13->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-14">
            <h2 class="title-block-type-windows">Панорамные металлопластиковые стеклянные двери на балкон с панорамным окном</h2>
            <span class="small-title">Размер 600 х 2000 мм + 1100 х 2000 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_14->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_14->max?></span> грн</span>
            <ul class="nav nav-tabs" id="myTab-type-14" role="tablist">
               <li class="nav-item"><a class="nav-link active" id="wdc-type-14-tab" data-toggle="tab" href="#wds-type-14" role="tab" aria-controls="wds-type-14" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/WDS-logo-1.5f37c8d5.svg" class="img-fluid WDS-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="windoffs-type-14-tab" data-toggle="tab" href="#windoffs-type-14" role="tab" aria-controls="windoffs-type-14" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/logo-new-windoffs-1.590253c8.svg" class="img-fluid windoffs-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="viknaland-type-14-tab" data-toggle="tab" href="#viknaland-type-14" role="tab" aria-controls="viknaland-type-14" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/viknaland-logo-1.a67c333c.svg" class="viknaland-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="rehau-type-14-tab" data-toggle="tab" href="#rehau-type-14" role="tab" aria-controls="rehau-type-14" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/rehau-logo-1.5dbf9707.svg" class="rehau-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="salamander-type-14-tab" data-toggle="tab" href="#salamander-type-14" role="tab" aria-controls="salamander-type-14" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/salamander-logo-1.4fa97951.svg" class="salamander-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="kbe-open-type-14-tab" data-toggle="tab" href="#kbe-type-14" role="tab" aria-controls="kbe-type-14" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/kbe-logo-1.0d5c807a.svg" class="img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="opentek-type-14-tab" data-toggle="tab" href="#opentek-type-14" role="tab" aria-controls="opentek-type-14" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="veka-type-14-tab" data-toggle="tab" href="#veka-type-14" role="tab" aria-controls="veka-type-14" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/veka-logo-1.5a1822d9.svg" class="veka-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="aluplast-type-14-tab" data-toggle="tab" href="#aluplast-type-14" role="tab" aria-controls="aluplast-type-14" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/aluplast-logo-1.19c32497.svg" class="aluplast-logo img-fluid" alt="photo"></a></li>
            </ul>
            <div class="tab-content" id="myTabContent-type-14">

               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_14 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-14" role="tabpanel" aria-labelledby="<?=$key_w?>-type-14">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/14-panoramnyye-metalloplastikovyye-steklyannyye-dveri-na-balkon-s-panoramnym-oknom.1113694d.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_14->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-15">
            <h2 class="title-block-type-windows">Раздвижная металлопластиковая дверь</h2>
            <span class="small-title">Размер 1000 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_15->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_15->max?></span> грн</span>
            <ul class="nav nav-tabs" id="myTab-type-15" role="tablist">
               <li class="nav-item"><a class="nav-link active" id="wdc-type-15-tab" data-toggle="tab" href="#wds-type-15" role="tab" aria-controls="wds-type-15" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/WDS-logo-1.5f37c8d5.svg" class="img-fluid WDS-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="windoffs-type-15-tab" data-toggle="tab" href="#windoffs-type-15" role="tab" aria-controls="windoffs-type-15" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/logo-new-windoffs-1.590253c8.svg" class="img-fluid windoffs-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="viknaland-type-15-tab" data-toggle="tab" href="#viknaland-type-15" role="tab" aria-controls="viknaland-type-15" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/viknaland-logo-1.a67c333c.svg" class="viknaland-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="rehau-type-15-tab" data-toggle="tab" href="#rehau-type-15" role="tab" aria-controls="rehau-type-15" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/rehau-logo-1.5dbf9707.svg" class="rehau-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="salamander-type-15-tab" data-toggle="tab" href="#salamander-type-15" role="tab" aria-controls="salamander-type-15" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/salamander-logo-1.4fa97951.svg" class="salamander-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="kbe-open-type-15-tab" data-toggle="tab" href="#kbe-type-15" role="tab" aria-controls="kbe-type-15" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/kbe-logo-1.0d5c807a.svg" class="img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="opentek-type-15-tab" data-toggle="tab" href="#opentek-type-15" role="tab" aria-controls="opentek-type-15" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="veka-type-15-tab" data-toggle="tab" href="#veka-type-15" role="tab" aria-controls="veka-type-15" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/veka-logo-1.5a1822d9.svg" class="veka-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="aluplast-type-15-tab" data-toggle="tab" href="#aluplast-type-15" role="tab" aria-controls="aluplast-type-15" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/aluplast-logo-1.19c32497.svg" class="aluplast-logo img-fluid" alt="photo"></a></li>
            </ul>
            <div class="tab-content" id="myTabContent-type-15">

               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_15 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-15" role="tabpanel" aria-labelledby="<?=$key_w?>-type-15">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/15-razdvizhnaya-metalloplastikovaya-dver.8d0830da.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_15->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-16">
            <h2 class="title-block-type-windows">Двухстворчатые панорамные металлопластиковые двери с двумя стеклянными окнами по бокам</h2>
            <span class="small-title">Размер 2700 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_16->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_16->max?></span> грн</span>
            <ul class="nav nav-tabs" id="myTab-type-16" role="tablist">
               <li class="nav-item"><a class="nav-link active" id="wdc-type-16-tab" data-toggle="tab" href="#wds-type-16" role="tab" aria-controls="wds-type-16" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/WDS-logo-1.5f37c8d5.svg" class="img-fluid WDS-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="windoffs-type-16-tab" data-toggle="tab" href="#windoffs-type-16" role="tab" aria-controls="windoffs-type-16" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/logo-new-windoffs-1.590253c8.svg" class="img-fluid windoffs-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="viknaland-type-16-tab" data-toggle="tab" href="#viknaland-type-16" role="tab" aria-controls="viknaland-type-16" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/viknaland-logo-1.a67c333c.svg" class="viknaland-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="rehau-type-16-tab" data-toggle="tab" href="#rehau-type-16" role="tab" aria-controls="rehau-type-16" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/rehau-logo-1.5dbf9707.svg" class="rehau-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="salamander-type-16-tab" data-toggle="tab" href="#salamander-type-16" role="tab" aria-controls="salamander-type-16" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/salamander-logo-1.4fa97951.svg" class="salamander-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="kbe-open-type-16-tab" data-toggle="tab" href="#kbe-type-16" role="tab" aria-controls="kbe-type-16" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/kbe-logo-1.0d5c807a.svg" class="img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="opentek-type-16-tab" data-toggle="tab" href="#opentek-type-16" role="tab" aria-controls="opentek-type-16" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="veka-type-16-tab" data-toggle="tab" href="#veka-type-16" role="tab" aria-controls="veka-type-16" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/veka-logo-1.5a1822d9.svg" class="veka-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="aluplast-type-16-tab" data-toggle="tab" href="#aluplast-type-16" role="tab" aria-controls="aluplast-type-16" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/aluplast-logo-1.19c32497.svg" class="aluplast-logo img-fluid" alt="photo"></a></li>
            </ul>
            <div class="tab-content" id="myTabContent-type-16">

               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_16 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-16" role="tabpanel" aria-labelledby="<?=$key_w?>-type-16">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/16-dvustvorchatyye-panoramnyye-metalloplastikovyye-dveri-s-dvumya-steklyannymi-oknami-po-bokam.9460dbba.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_16->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-19">
            <h2 class="title-block-type-windows">Раздвижная металлопластиковая дверь с панорамными окнами по бокам</h2>
            <span class="small-title">Размер 3000 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_17->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_17->max?></span> грн</span>
            <ul class="nav nav-tabs" id="myTab-type-19" role="tablist">
               <li class="nav-item"><a class="nav-link active" id="wdc-type-19-tab" data-toggle="tab" href="#wds-type-19" role="tab" aria-controls="wds-type-19" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/WDS-logo-1.5f37c8d5.svg" class="img-fluid WDS-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="windoffs-type-19-tab" data-toggle="tab" href="#windoffs-type-19" role="tab" aria-controls="windoffs-type-19" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/logo-new-windoffs-1.590253c8.svg" class="img-fluid windoffs-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="viknaland-type-19-tab" data-toggle="tab" href="#viknaland-type-19" role="tab" aria-controls="viknaland-type-19" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/viknaland-logo-1.a67c333c.svg" class="viknaland-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="rehau-type-19-tab" data-toggle="tab" href="#rehau-type-19" role="tab" aria-controls="rehau-type-19" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/rehau-logo-1.5dbf9707.svg" class="rehau-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="salamander-type-19-tab" data-toggle="tab" href="#salamander-type-19" role="tab" aria-controls="salamander-type-19" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/salamander-logo-1.4fa97951.svg" class="salamander-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="kbe-open-type-19-tab" data-toggle="tab" href="#kbe-type-19" role="tab" aria-controls="kbe-type-19" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/kbe-logo-1.0d5c807a.svg" class="img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="opentek-type-19-tab" data-toggle="tab" href="#opentek-type-19" role="tab" aria-controls="opentek-type-19" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="veka-type-19-tab" data-toggle="tab" href="#veka-type-19" role="tab" aria-controls="veka-type-19" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/veka-logo-1.5a1822d9.svg" class="veka-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="aluplast-type-19-tab" data-toggle="tab" href="#aluplast-type-19" role="tab" aria-controls="aluplast-type-19" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/aluplast-logo-1.19c32497.svg" class="aluplast-logo img-fluid" alt="photo"></a></li>
            </ul>
            <div class="tab-content" id="myTabContent-type-19">
               
               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_17 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-19" role="tabpanel" aria-labelledby="<?=$key_w?>-type-19">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/17-razdvizhnyye-metalloplastikovyye-dveri-s-panoramnymi-oknami-po-bokam.92c2eed7.png" class="mt-lg-4 img-type-windows-3 img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_17->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-17">
            <h2 class="title-block-type-windows">Металлопластиковые двери гармошка</h2>
            <span class="small-title">Размер 2700 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->dvery_metaloplastikovie_18->min?></span> грн до <span class="max-price"><?=$price_obj->dvery_metaloplastikovie_18->max?></span> грн</span>
            <ul class="nav nav-tabs" id="myTab-type-17" role="tablist">
               <li class="nav-item"><a class="nav-link active" id="wdc-type-17-tab" data-toggle="tab" href="#wds-type-17" role="tab" aria-controls="wds-type-17" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/WDS-logo-1.5f37c8d5.svg" class="img-fluid WDS-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="windoffs-type-17-tab" data-toggle="tab" href="#windoffs-type-17" role="tab" aria-controls="windoffs-type-17" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/logo-new-windoffs-1.590253c8.svg" class="img-fluid windoffs-logo" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="viknaland-type-17-tab" data-toggle="tab" href="#viknaland-type-17" role="tab" aria-controls="viknaland-type-17" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/viknaland-logo-1.a67c333c.svg" class="viknaland-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="rehau-type-17-tab" data-toggle="tab" href="#rehau-type-17" role="tab" aria-controls="rehau-type-17" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/rehau-logo-1.5dbf9707.svg" class="rehau-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="salamander-type-17-tab" data-toggle="tab" href="#salamander-type-17" role="tab" aria-controls="salamander-type-17" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/salamander-logo-1.4fa97951.svg" class="salamander-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="kbe-open-type-17-tab" data-toggle="tab" href="#kbe-type-17" role="tab" aria-controls="kbe-type-17" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/kbe-logo-1.0d5c807a.svg" class="img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="opentek-type-17-tab" data-toggle="tab" href="#opentek-type-17" role="tab" aria-controls="opentek-type-17" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="veka-type-17-tab" data-toggle="tab" href="#veka-type-17" role="tab" aria-controls="veka-type-17" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/veka-logo-1.5a1822d9.svg" class="veka-logo img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="aluplast-type-17-tab" data-toggle="tab" href="#aluplast-type-17" role="tab" aria-controls="aluplast-type-17" aria-selected="true"><img src="<?php bloginfo('template_url') ?>/images/aluplast-logo-1.19c32497.svg" class="aluplast-logo img-fluid" alt="photo"></a></li>
            </ul>
            <div class="tab-content" id="myTabContent-type-17">
               
               <?php 
               $k = 0;
               foreach ($price_obj->dvery_metaloplastikovie_18 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-17" role="tabpanel" aria-labelledby="<?=$key_w?>-type-17">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/18-metalloplastikovyye-dveri-garmoshka.326f93d6.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->dvery_metaloplastikovie_18->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
   ...
   <section class="section-buy-this-product doors">
      <div class="container">
         <h2 class="title-section">Вместе с Дверями Покупают</h2>
         <ul class="list-top-product">
            <li class="block-item-product">
               <h6 class="title-header">Защитные ролеты</h6>
               <a href="<?=get_bloginfo('home')?>/komplektuyushchie/zashchitnye-rolety/"><img src="<?php bloginfo('template_url') ?>/images/additional-item-2.17400e5f.png" class="img-fluid" alt="photo"></a>
               <p>Роллетные конструкции являются разновидностью жалюзи, обеспечивающие не только защиту от солнца, но и от взлома.</p>
            </li>
            <li class="block-item-product">
               <h6 class="title-header">Москитные сетки на двери</h6>
               <a href="<?=get_bloginfo('home')?>/komplektuyushchie/moskitnye-setki/na-dveri/"><img src="<?php bloginfo('template_url') ?>/images/ustanovka-raspashnoj-moskitnoj-setki-na-dveri.9c292477.webp" class="img-fluid" alt="photo"></a>
               <p>Москитная сетка на двери отлично справляется не только с защитой от насекомых, но и от пыли.</p>
            </li>
         </ul>
      </div>
   </section>
...
<!--         </form>-->
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Особенности пластиковых дверей</h2>
         <p>Изделия соответствуют всем важным параметрам по энергоэффективности, безопасности и эстетике. В сравнении с деревянным дверным полотном металлопластик обладает высоким уровнем звуковой и тепловой изоляции.</p>
         <p>В основе конструкции используется ПВХ. В процессе изготовления полотно дополнительно армируются. Это придает материалу плотность и устойчивость.</p>
         <p>Универсальные изделия идеально подходят для установки в административном здании, офисном помещении, магазине, частном доме и квартире.</p>
         <h2 class="title-post">Преимущества пластиковых дверей</h2>
         <p>Пластиковые двери обладают следующими преимуществами:</p>
         <ol>
            <li>Высокими теплоизоляционными свойствами.</li>
            <li>Повышенной защитой от посторонних шумов.</li>
            <li>Отсутствием воздействия влаги и резких температурных перепадов.</li>
            <li>Простотой ухода за дверным полотном.</li>
            <li>Изделие не нуждается в дальнейшей покраске и лакировке.</li>
         </ol>
         <p>Дверные полотна из пластика отличаются гибкостью и пластичностью, что позволяет создавать изделия разной формы и размера. Используя ламинацию и окрашивание профиля, наша компания изготовит модель любого цвета и текстуры.</p>
         <h2 class="title-post">Виды пластиковых дверей</h2>
         <p>Мы предлагаем различные виды металлопластиковых дверных изделий:</p>
         <ul>
            <li>· входные;</li>
            <li>· межкомнатные;</li>
            <li>· балконные.</li>
         </ul>
         <p>Современные входные металлопластиковые двери отличаются надежной конструкцией с удобной фурнитурой. Дополнительно оснащаются доводчиками, подпороговым утеплителем и многозапорным замком.</p>
         <p>Межкомнатные модели – неотъемлемый атрибут любого дома, который украшает и дополняет его стиль. Внешний вид дверной конструкции отличается надежностью и привлекательностью.</p>
         <p>Балконные виды представляют собой стандартный корпус в комплекте с различной фурнитурой. Универсальные крепежные элементы позволяют превращать балконные дверные модели в уличные типы. Полотна оснащаются одноточечным замком и нажимным гарнитуром.</p>
         <p>Покупка дверей от производителя в Киеве сделает ваш ремонт стильным и практичным. Возможна установка одно-, двухстворчатых дверных конструкций.</p>
         <h2 class="title-post">Как выбрать пластиковые двери</h2>
         <p>Независимо от планировки и жилой площади модели выбираются с учетом рекомендаций:</p>
         <ol>
            <li>Для каждого типа помещения подбирается определенный вид дверного механизма по принципу открывания/закрывания (распашные, раздвижные, раскладные).</li>
            <li>Изделия должны быть изготовлены из экологического и пожароустойчивого материала.</li>
            <li>Для дополнительной безопасности во входную дверь вставляется противоударное стекло (триплекс) и противовзломная фурнитура.</li>
         </ol>
         <p>Определенная конфигурация зависит от назначения, функциональных особенностей конструкции и типа помещения. Наши специалисты готовы осуществить монтаж любого изделия в нужном дизайне и цвете.</p>
         <h2 class="title-post">Преимущества нашей компании</h2>
         <p>Перед тем, как приобрести металлопластиковые дверные конструкции, необходимо произвести правильный замер проема. С этим заданием легко справится наша команда. Мы поможем подобрать изделие нужной формы и размера даже для нестандартных дверных проемов.</p>
         <p>Дополнительно мы предлагаем своим клиентам преимущества:</p>
         <ul>
            <li>· производство из безопасного высококачественного материала по стандартам ГОСТ;</li>
            <li>· использование надежной оригинальной фурнитуры;</li>
            <li>· доставку и установку металлопластиковых конструкций;</li>
            <li>· оплату любым удобным способом;</li>
            <li>· приложение к заказу всех необходимых документов.</li>
         </ul>
         <p>Наша компания гарантирует качество, надежность и продолжительный срок использования дверной конструкции.</p>
         <h2 class="title-post">Стоимость пластиковых дверей</h2>
         <p>На стоимость пластиковых дверей влияют:</p>
         <ul>
            <li>· материал;</li>
            <li>· разновидность, функциональность конструкции;</li>
            <li>· выбор фурнитуры;</li>
            <li>· применение цветного ламинирования.</li>
         </ul>
         <p>Мы предлагаем купить металлопластиковые двери в Киеве по выгодной стоимости. Заказать можно не только на сайте, руководствуясь подробными описаниями и наглядными фотографиями, но и по номеру телефона. Выбирайте понравившийся цвет и дизайн будущего изделия, и мы подберем конструкции для вашего интерьера.</p>
      </div>
   </section>
   <section class="section-other-type-windows">
      <div class="container">
         <h2 class="title-section">Ищите Другие Двери?</h2>
         <ul class="list-other-type-windows">
            <li class="item-other-type-windows">
               <div class="block-img-other doors"><img src="<?php bloginfo('template_url') ?>/images/metalloplastikovye-dveri-2.ccb91392.png" class="not-all-img img-fluid" alt="photo"></div>
               <a href="<?=get_bloginfo('home')?>/plastikovye-dveri/vhodnye/" class="title-footer">Входные</a>
            </li>
            <li class="item-other-type-windows">
               <div class="block-img-other doors"><img src="<?php bloginfo('template_url') ?>/images/img-unlinking-doors-3.bda9bafb.jpg" class="all-img img-fluid" alt="photo"></div>
               <a href="<?=get_bloginfo('home')?>/plastikovye-dveri/na-balkon/" class="title-footer">На балкон</a>
            </li>
            <li class="item-other-type-windows">
               <div class="block-img-other doors"><img src="<?php bloginfo('template_url') ?>/images/mezhkomnatnye-metalloplastikovye-dveri.6b3dff80.jpg" class="all-img img-fluid" alt="photo"></div>
               <a href="<?=get_bloginfo('home')?>/plastikovye-dveri/mezhkomnatnye/" class="title-footer">Межкомнатные</a>
            </li>
            <li class="item-other-type-windows">
               <div class="block-img-other doors"><img src="<?php bloginfo('template_url') ?>/images/razdvizhnye-metalloplastikovye-dveri.767b67ad.jpg" class="all-img img-fluid" alt="photo"></div>
               <a href="<?=get_bloginfo('home')?>/plastikovye-dveri/razdvizhnye/" class="title-footer">Раздвижные</a>
            </li>
            <li class="item-other-type-windows">
               <div class="block-img-other doors"><img src="<?php bloginfo('template_url') ?>/images/metalloplastikovye-dveri.79c6c78c.webp" class="not-all-img img-fluid" alt="photo"></div>
               <a href="<?=get_bloginfo('home')?>/plastikovye-dveri/balkonnye-bloki/" class="title-footer">Блоки</a>
            </li>
            <li class="item-other-type-windows"><a href="<?=get_bloginfo('home')?>/plastikovye-dveri/vse-dveri/" class="icon-button"></a> <a href="<?=get_bloginfo('home')?>/plastikovye-dveri/vse-dveri/" class="title-button">Показать всё</a></li>
         </ul>
      </div>
   </section>
   <a id="button"></a>
