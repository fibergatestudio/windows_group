...
<div class="main page-windows">
    ...
    <section class="section-calculator">
        <div class="container">
            <div class="top-post-page">
                <h1 class="title-post mb-lg-3">Пластиковые окна в Василькове: цена с установкой</h1>
                <p class="text-custom-page">Компания «Windows Group» занимается сборкой и монтажом <span class="strong-text">пластиковых окон в Василькове</span>, Киеве и других городах региона под ключ. Капитальный ремонт частного дома, квартиры или офиса подразумевает замену ПВХ изделий. Качественные пластиковые конструкции сделают интерьер уютным, а пребывание в помещении будет более комфортным. Чтобы заменить металлопластиковые окна, достаточно сделать один звонок или оформить заявку на сайте.</p>
                <p class="text-custom-page">Наша компания является крупнейшим в Украине изготовителем ПВХ-конструкций. Также мы сотрудничаем с ведущими производителями из Германии, Швейцарии и других стран Европы, выпускающими надежные, прочные и недорогие изделия. Мы предлагаем лояльные <a href="https://windowsgroup.com.ua/plastikovye-okna/">цены на металлопластиковые окна</a>, с которыми подробно можно ознакомиться в этом разделе.</p>
            </div>
            <h2 class="title-section">Калькулятор Окон в Василькове</h2>
    ...
    <section class="section-slider-type-profil">
        ...
        <?php 
            ...
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_v_vasilkove' ");
    ...
    <section class="section-post section-post-windows post-page-agency">
        <div class="container">
            <h2 class="title-section">Цены на пластиковые окна</h2>
            <p class="mb-1">Стоимость металлопластиковых окон формируется из расчета цены за квадратный метр, которая зависит от следующих критериев:</p>
            <ul class="list-style-disc">
                <li>тип конструкции и форма (стандартные прямоугольные, квадратные окна, арочные и другие исполнения);</li>
                <li>размеры, конфигурация и тип профильной системы (откидная, распашная, глухая);</li>
                <li>производитель и качество сборки – более бюджетные отечественные оконные рамы обойдутся дешевле, чем зарубежные (немецкие, швейцарские);</li>
                <li>комплектация, дополнительные функции и возможности;</li>
                <li>сложность проекта в целом, включая необходимость демонтажа старых оконных рам и дверей, особенности установки, тип здания (кирпичное, панельное), наличие лифта в доме, расходы монтажной пены.</li>
            </ul>
            <p class="mb-2">Параметры, влияющие на формирование цены на металлопластиковые окна и двери:</p>
            <ol>
                <li>Выбор профиля и характеристики пластикового изделия. Чем толще конструкция, функциональнее стеклопакет и больше количество камер, тем сложнее применяются технологии при производстве. Это необходимо учитывать при расчете стоимости. Свяжитесь с нашим менеджером, и он уточнит наличие доступных профилей Rehau или изделий от других производителей на складе.</li>
                <li>Число створок. Чем больше глухих створок в конструкции, тем ниже цена на пластиковые окна. Наиболее приемлемый вариант – поворотно-откидной механизм открытия. Такие оконные системы удобны в эксплуатации, при этом их стоимость не намного выше.</li>
                <li>Форма и цвет. Помимо классических прямоугольных пластиковых рам, мы предлагаем овальные, шестиугольные, треугольные, круглые металлопластиковые окна на заказ. Изделие можно недорого заламинировать в коричневый, бежевый, серый или любой другой цвет.</li>
                <li>Тип и особенности стеклопакета. Чем толще он и функциональнее, тем дороже обойдется заказчику замена окон в Васильковке. Двухкамерные стеклопакеты – наиболее распространенный и востребованный вариант, но в продаже также представлены конструкции на 1 и 3 камеры. Если вы проживаете на первых этажах, рекомендуем заказать металлопластиковые окна с тонировкой. Также мы можем комплектовать оконные конструкции противоударными, энергосберегающими и мультифункциональными стеклопакетами.</li>
                <li>Фурнитура. В зависимости от производителя, базовая комплектация может различаться, этот момент необходимо уточнить у менеджера компании. При интенсивной эксплуатации оконные ручки и петли изнашиваются достаточно быстро, поэтому они должны быть прочными. На фурнитуре лучше не экономить. </li>
            </ol>
            <p class="mb-2">В перечень дополнительных услуг входит монтаж подоконников, отливов, установка откосов. Также у нас можно недорого заказать москитные сетки.  Чтобы рассчитать стоимость окна на заказ, воспользуйтесь онлайн-калькулятором на нашем сайте. Укажите размеры конструкций и дополнительные функции. Также рассчитать, сколько стоит установка окон ПВХ, поможет наш специалист. Для всех жителей Украины консультация бесплатна.</p>

            <h2 class="title-post">Как заменить металлопластиковые окна: алгоритм действий</h2>
            <p class="mb-2">Если вы решили купить пластиковые окна на балкон или в комнату, мы будет сотрудничать по такой схеме:</p>
            <ol>
                <li>Оформление заказа. Оставьте заявку на сайте или свяжитесь с нашим специалистом. </li>
                <li>Снятие замеров. Наш замерщик выезжает на объект, чтобы составить проект и предварительно просчитать стоимость установки пластиковых окон в Василькове.</li>
                <li>Составление договора. Стоимость услуги под ключ рассчитывается индивидуально. После предоплаты мы отправляем запрос на завод, где начинается производство ПВХ-конструкций. Как правило, на реализацию одного проекта уходит 2-3 дня.</li>
                <li>Доставка оконных блоков на объект клиента, установка.</li>
                <li>Гарантия. На все металлопластиковые конструкции – 10 лет, на работы – 5 лет. Что касается фактического ресурса эксплуатации, то при правильном обслуживании установленные в Василькове пластиковые окна прослужат не менее 20 лет. Своевременно смазывайте петли и не забывайте о регулировке механизмов. У нас также можно заказать обслуживание ПВХ-конструкций.</li>
            </ol>
            <p class="mb-2">Чтобы купить металлопластиковые окна, оставьте заявку или позвоните нашему оператору по указанному номеру.</p>
            <h2 class="title-post">Виды профилей на балкон и в комнату</h2>
            <p class="mb-2">«Windows Group» предлагает монтаж следующих типов ПВХ-конструкций на балкон:</p>
            <ul class="list-style-disc">
                <li>классические – стандартные окна для лоджий;</li>
                <li>Г-образные – конструкции с одной боковой створкой;</li>
                <li>П-образные – системы с двумя боковыми частями;</li>
                <li>французские балконы (панорамное остекление);</li>
                <li>полукруглые.</li>
            </ul>
            <p class="mb-2">Если нужно поменять окна в комнате, кроме формы, необходимо определиться с типом открывания (Т-образные, трех- и двухстворчатые, фрамужные и т. д.). При покупке следует выбрать подходящий уровень шумоизоляции и тип стеклопакета (теплый, бронированный, с аргоновым или криптоновым наполнением).</p>

            <h2 class="title-post">Причины заказать остекление в Василькове у нас</h2>
            <p class="mb-2">Пять главных преимуществ:</p>
            <ol>
                <li>Профессионализм и огромный опыт. За 20 лет работы нашими специалистами было установлено более 100 тысяч пластиковых окон в Василькове, Киеве и других городах Украины.</li>
                <li>Широкий спектр услуг. Установка алюминиевых окон и дверных блоков, монтаж раздвижных конструкций, ламинирование, безрамное остекление, защита от детей – это и многое другое можно заказать в «Windows Group».</li>
                <li>Лояльные цены на пластиковые окна с завода. Мы занимаемся не только продажей и установкой. «Windows Group» - это собственное производство на высокоточном многопрофильном оборудовании. Сотрудничая с нами, вы не переплачиваете посредникам, поэтому наши цены более чем доступные.</li>
                <li>Большой ассортимент. Мы предлагаем качественные профили Rehau, WDS, Salamander, Viknaland, KBE и т. д.</li>
                <li>Выгодные условия сотрудничества. Бесплатный подбор и расчет, скидки для постоянных клиентов. Ремонт – это всегда непредвиденные затраты, поэтому если у вас не хватает денег, чтобы установить окна – не проблема. Мы предлагаем рассрочку под 0%.</li>
            </ol>
            <p class="mb-2">Благодаря выгодным и гибким условиям сотрудничества мы поможем быстро, качественно и недорого заменить окна во всей квартире. </p>
        </div>
