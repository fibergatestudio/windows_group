...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
            <h1 class="title-post">Французские ПВХ (пластиковые) окна в Киеве – цены</h1>
            <p class="text-custom-page">Французские окна придают стильность и эксклюзивность помещению.
                Главной отличительной особенностью данных конструкций является остекление от потолка до пола.
                Компания “Виндовс Груп” предлагает заказать популярные французские оконные конструкции в
                Киеве и области по лучшим ценам напрямую от производителя.</p>
         </div>

         <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_francuzskiye' ");
            $price_obj = json_decode($result_params[0]->data);
         
         ?>
         
         <div class="block-windows-type-1">
            <h2 class="title-block-type-windows">Французское Окно</h2>
            <span class="small-title">Размер 3000 х 2600 мм, Цена от <span class="min-price"><?=$price_obj->francuzskoye_okno->min?></span> грн до <span class="max-price"><?=$price_obj->francuzskoye_okno->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-open">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->francuzskoye_okno as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-open" role="tabpanel" aria-labelledby="<?=$key_w?>-open">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/french-type-1.0467f465.png" class="px-lg-4 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->francuzskoye_okno->$key_w;
                              $j = 0;
         ...
         <div class="block-windows-type-2">
            <h2 class="title-block-type-windows">Французское Окно Г-образный</h2>
            <span class="small-title">Размер 3000 х 2600 мм + 800 х 2600 мм, Цена от <span class="min-price"><?=$price_obj->francuzskoye_g_obraznoye->min?></span> грн до <span class="max-price"><?=$price_obj->francuzskoye_g_obraznoye->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->francuzskoye_g_obraznoye as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>" role="tabpanel" aria-labelledby="<?=$key_w?>">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/french-type-2.72a12270.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->francuzskoye_g_obraznoye->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-3">
            <h2 class="title-block-type-windows">Французское Окно П-образный</h2>
            <span class="small-title">Размер 3000 х 2600 мм + 800 х 2600 мм + 800 х 2600 мм, Цена от <span class="min-price"><?=$price_obj->francuzskoye_p_obraznoye->min?></span> грн до <span class="max-price"><?=$price_obj->francuzskoye_p_obraznoye->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-3">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->francuzskoye_p_obraznoye as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-3" role="tabpanel" aria-labelledby="<?=$key_w?>-type-3">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/french-type-3.5313a40c.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->francuzskoye_p_obraznoye->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-4">
            <h2 class="title-block-type-windows">Французское Окно Прямой</h2>
            <span class="small-title">Размер 4600 х 2600 мм, Цена от <span class="min-price"><?=$price_obj->francuzskoye_pryamoye->min?></span> грн до <span class="max-price"><?=$price_obj->francuzskoye_pryamoye->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-4">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->francuzskoye_pryamoye as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
               
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-4" role="tabpanel" aria-labelledby="<?=$key_w?>-type-4">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/french-type-4.e9112fd4.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->francuzskoye_pryamoye->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
      ...
      <div class="container">
         ...
         <ul class="list-top-product">
            ...
            <li class="block-item-product">
               ...
               <p>Сделайте пространство для жизни ваших детей безопасным</p>
            </li>
         </ul>
      </div>
   </section>
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Типы французских окон</h2>
         <p>Французские окна в интерьере классифицируются по форме конструкции и по особенностям оконной рамы.</p>
         <p>По форме конструкции оконные блоки бывают цельными и секционными. Цельный тип представляет собой конструкцию, не имеющую перегородок в раме. Оптимальным типом открывания является раздвижной. В секционном виде панорамные оконные блоки делятся на части перегородками. Максимальное количество створок не превышает семи.</p>
         <p>По конструкции оконной рамы французские окна в частном доме оснащаются штульпом или импостом. Штульповые створки не имеют перемычек, что обеспечивает панорамный вид из окна. Присутствие импоста делает изделие прочным. Перемычка позволяет открывать одну или несколько створок, а также ставить их на проветривание.</p>
         <p>При изготовлении модели могут оснащаться декоративными раскладками (шпросами). Вставленная в оконный блок решетка зрительно разделяет стекло на несколько частей. Шпросы используются для укрепления и украшения высокой или широкой конструкции.</p>
         <h2 class="title-post">Функционал</h2>
         <p>По функциональным особенностям панорамные конструкции бывают:</p>
         <ul>
            <li>· раздвижными;</li>
            <li>· распашными;</li>
            <li>· складными по принципу “книжки”.</li>
         </ul>
         <p>В раздвижных моделях рабочие створки открываются и удерживаются задвижками и шпингалетами. Французское раздвижное окно является удобной и надежной системой. Распашные оконные блоки подходят для узкого проема, где нельзя монтировать раздвижные конструкции. Открываются распашные модели внутрь или наружу при помощи ручки.</p>
         <p>Французские окна в пол с механизмом книжка раскрываются максимально широко. Оконные створки собираются в одном месте, экономя пространство комнаты.</p>
         <h2 class="title-post">Вид стекол</h2>
         <p>В панорамных конструкциях применяются следующие виды стекла:</p>
         <ul>
            <li>· каленое;</li>
            <li>· флоат-стекло (термополированное);</li>
            <li>· смарт-стекло;</li>
            <li>· триплекс.</li>
         </ul>
         <p>Каленое стекло является прочным к механическим повреждениям. Термополированное стекло имеет не только отличную пропускную способность светового потока, но и устойчивость к деформации. Смарт-стекло не пропускает ультрафиолетовые лучи, затеняет оконный блок наподобие жалюзи, обладает повышенной звукоизоляцией. При необходимости умное стекло становится матовым. Многослойное стекло триплекс характеризуется высокой прочностью, стойкостью и шумоизоляцией.</p>
         <h2 class="title-post">Места монтажа французских окон - куда установить</h2>
         <p>Панорамные оконные блоки устанавливаются в разных местах:</p>
         <ul>
            <li>· в квартирах;</li>
            <li>· в частных домах;</li>
            <li>· в хрущевках;</li>
            <li>· в торговых центрах;</li>
            <li>· в офисных помещениях.</li>
         </ul>
         <p>В домах или квартирах, где лоджии отсутствуют, может монтироваться вместо балконного блока французское окно. Интересным вариантом станет обустройство конструкции решеткой-ограждением и противовзломной фурнитурой.</p>
         <p>Французские окна на лоджии в хрущевке требуют ответственного монтажа. При проектировании следует учитывать, что холодные конструкции намного легче теплых оконных моделей. При монтаже панорамного оконного типа важно правильно рассчитать несущую способность железобетонной конструкции, а также учесть все необходимые элементы.</p>
         <p>Наши специалисты готовы выехать на объект и произвести профессиональный замер по предварительной заявке.</p>
         <h2 class="title-post">Преимущества и недостатки</h2>
         <p>Французские окна в квартире характеризуются несколькими преимуществами:</p>
         <ol>
            <li>Необычностью и оригинальностью.</li>
            <li>Высокой тепло- и звукоизоляцией.</li>
            <li>Улучшенной вентиляцией.</li>
            <li>Естественной освещенностью.</li>
            <li>Зрительным увеличением пространства.</li>
            <li>Широким обзором пейзажей.</li>
         </ol>
         <p>Панорамное остекление позволяет создавать отдельное помещение в качестве продолжения балкона или лоджии.</p>
         <p>Кроме преимуществ выделяют также недостатки панорамных оконных моделей:</p>
         <ol>
            <li>Сложность мытья стекла.</li>
            <li>Сильный нагрев комнаты в летний зной. Решить проблему можно, повесив шторы или жалюзи.</li>
            <li>Возможность появления конденсата на стекле. Предотвратить запотевание изделия поможет регулярное проветривание помещения.</li>
            <li>Сложность установки в многоэтажке из-за потребности в перепланировке.</li>
         </ol>
         <h2 class="title-post">Цена на французские окна</h2>
         <p>Цена французского окна значительно выше обычного оконного блока. Стоимость панорамного остекления зависит от размера, функционала, типа используемого профиля, стеклопакета, фурнитуры и вспомогательных элементов. Узнать ориентировочные цены можно на нашем сайте или позвонив по телефону.</p>
      </div>
   </section>
   <section class="section-other-type-windows">
      <div class="container">
         ...
         <ul class="list-other-type-windows">
            ...
            <li class="item-other-type-windows"><img src="<?php bloginfo('template_url') ?>/images/sluhovoe_okno.6f334b6a.png" class="img-fluid" alt="photo"> <a href="<?=get_bloginfo('home')?>/plastikovye-okna/sluhovye/" class="title-footer">Слуховые</a></li>
         </ul>
      </div>
   </section>
   <a id="button"></a>
