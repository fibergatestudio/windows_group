...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
            <h1 class="title-post">ПВХ (пластиковые) окна в ванную в Киеве – цены</h1>
            <p class="text-custom-page">Окна в ванной комнате наполнят комнату для водных процедур солнечным теплом и светом.
                Бодрящий душ или вечерняя релаксация, после тяжелого рабочего дня, станут от этого комфортнее.
                Компания “Виндовс Груп” предлагает купить интересные оконные модели разного дизайна и цвета по лучшим ценам с гарантией от производителя.</p>
         </div>

         <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_v_vannuyu' ");
         ...
         <div class="block-windows-type-1">
            ...
            <span class="small-title">Размер 500 х 500 мм, Цена от <span class="min-price"><?=$price_obj->okno_otkrivayusheesya->min?></span> грн до <span class="max-price"><?=$price_obj->okno_otkrivayusheesya->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-open">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-open" role="tabpanel" aria-labelledby="<?=$key_w?>-open">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/windows-open-bathroom.11b3446d.png" class="img-type-windows img-fluid" alt="photo"></div>
         ...
         <div class="block-windows-type-2">
            ...
            <span class="small-title">Размер 500 х 500 мм, Цена от <span class="min-price"><?=$price_obj->okno_gluhoe->min?></span> грн до <span class="max-price"><?=$price_obj->okno_gluhoe->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>" role="tabpanel" aria-labelledby="<?=$key_w?>">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/windows-close-bathroom.a3521563.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-windows-type-3">
            ...
            <div class="tab-content" id="myTabContent-type-3">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-3" role="tabpanel" aria-labelledby="<?=$key_w?>-type-3">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/tilt-window.67c6141d.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-windows-type-4">
            <h2 class="title-block-type-windows">Двустворчатое с 1 открыванием</h2>
            <span class="small-title">Размер 1500 х 500 мм, Цена от <span class="min-price"><?=$price_obj->okno_2_1->min?></span> грн до <span class="max-price"><?=$price_obj->okno_2_1->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-4">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-4" role="tabpanel" aria-labelledby="<?=$key_w?>-type-4">
                  <div class="table-tab">
                     <div class="block-img mt-lg-5"><img src="<?php bloginfo('template_url') ?>/images/tilt-windows-type-2.0f6ce90f.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-windows-type-5">
            <h2 class="title-block-type-windows">Двустворчатое с 1 открыванием</h2>
            <span class="small-title">Размер 750 х 1500 мм, Цена от <span class="min-price"><?=$price_obj->okno_2_t_1->min?></span> грн до <span class="max-price"><?=$price_obj->okno_2_t_1->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-5">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-5" role="tabpanel" aria-labelledby="<?=$key_w?>-type-5">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/windows-bathroom-type-1.fff503d1.png" class="vertical img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-windows-type-6">
            <h2 class="title-block-type-windows">Двустворчатое с 1 открыванием</h2>
            <span class="small-title">Размер 750 х 1500 мм, Цена от <span class="min-price"><?=$price_obj->okno_2_t_2->min?></span> грн до <span class="max-price"><?=$price_obj->okno_2_t_2->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-6">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-6" role="tabpanel" aria-labelledby="<?=$key_w?>-type-6">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/windows-bathroom-type-2.09ffbadd.png" class="vertical img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Преимущества окна в ванную</h2>
         <p>Окно в ванной служит декоративным элементом, дополняющим интерьер помещения для купания. Оконная конструкция имеет следующие преимущества:</p>
         <ol>
            <li>Является источником освещения.</li>
            <li>Обеспечивает поступление большого потока свежего воздуха, что снижает влажность.</li>
            <li>Значительно увеличивает пространство помещения.</li>
            <li>Открывает возможность наслаждаться шикарными пейзажами из окна.</li>
            <li>Подоконник служит дополнительным местом для хранения предметов личной гигиены.</li>
         </ol>
         <p>Улучшения вентиляции благоприятно воздействует на микроклимат и сохранность отделки.</p>
         <h2 class="title-post">Виды конструкции окон в ванную</h2>
         <p>Основной распространенный тип для ванного помещения – стандартный прямоугольный. Данный вариант пользуется популярностью в следующем виде и расположении:</p>
         <ul>
            <li>· по всему периметру стены;</li>
            <li>· иллюминатора на мансардном этаже;</li>
            <li>· вытянутого окна вдоль линии потолка.</li>
         </ul>
         <p>Панорамная конструкция, установленная во всю стену, обеспечивает максимальную освещенность помещения. Установка раздвижной конструкции на первом этаже частного дома позволит после купания отдохнуть в саду или на террасе. Дополнительным элементом стиля станут шторы или жалюзи.</p>
         <p>Зачастую ванное помещение располагается на мансарде. В данном случае окно в ванной комнате в частном доме предпочтительнее выбрать круглое или имитацию иллюминатора. Мансардная оконная конструкция обеспечивает высокий уровень освещения в комнате.</p>
         <p>При расположении ванной на мансарде не следует устанавливать матовые или тонированные стекла, вешать жалюзи.</p>
         <p>Вытянутая конструкция вдоль линии потолка – это упрощенный вид панорамного типа. Такой вариант размещается высоко, что обеспечивает уединенность. Иногда конструкция располагается под углом к стене. При таком размещении увидеть купающегося просто невозможно. Отличительной особенностью вытянутого мансардного оконного типа является сложность мытья стекла, при которой потребуется стремянка.</p>
         <p>При выборе цветовой гаммы в оформлении санузла необходимо учитывать размер помещения. Для небольшой комнаты предпочтительнее использовать светлые цвета, которые визуально расширят маленькое пространство. Темные расцветки рекомендуются применять в большой ванной комнате.</p>
         <p>В качестве стекла могут использоваться оригинальные варианты: матовые, тонированные, витражи. Матовые стекла не только пропускают лучи света, но и скрывают купающегося от посторонних. Тонированный стеклопакет следует устанавливать в санитарных узлах, расположенных на южной стороне. Витражи являются оригинальным решением для уменьшения светового потока.</p>
         <h2 class="title-post">Планировка ванной с окном</h2>
         <p>Установка конструкции в ванной комнате подразумевает различные дизайнерские варианты оформления помещения. Современные оконные рамы изготавливаются из прочного и износоустойчивого пластика. Контрастные рамы подчеркнут рельефные линии окна.</p>
         <p>Для максимального расширения помещения умывальник с зеркалом располагается на стене, перпендикулярной проему для окна. Такое размещение препятствует рассеиванию естественного света в зеркале.</p>
         <p>При планировке с оконным проемом, размещенным параллельно двери, сантехника и мебель расставляются по обе стороны проема. В вытянутой комнате предметы размещаются вдоль стены.</p>
         <p>Размер окна в ванной в частном доме или квартире зависит от планировки санитарного узла. Наши специалисты готовы выехать на объект и произвести замеры оконного проема для последующего изготовления изделия.</p>
         <h2 class="title-post">Цены окон в ванную</h2>
         <p>Стоимость пластикового окна в ванную является основополагающим фактором в пользу определенного производителя. На цену будущего изделия влияют несколько характеристик:</p>
         <ul>
            <li>· вид, форма и размер;</li>
            <li>· профиль;</li>
            <li>· тип стеклопакета;</li>
            <li>· механизм открывания;</li>
            <li>· фурнитура;</li>
            <li>· наличие отлива и подоконника.</li>
         </ul>
         <p>Наша компания предлагает заказать пластиковое окно в ванную по ценам напрямую от производителя Алюпласт в Киеве и области. Узнать стоимость оконных конструкций можно на сайте или позвонив по телефону.</p>
      </div>
   </section>
