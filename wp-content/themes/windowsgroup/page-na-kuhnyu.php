   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
            <h1 class="title-post">Пластиковые окна на кухню</h1>
            <p class="text-custom-page"><strong>Пластиковые окна на кухню в Киеве</strong> – простое и надежное решение для комфортного пребывания и создания оптимального микроклимата в кухонном помещении. В компании «Windows Group» можно заказать пластиковое окно на кухню по цене, доступной для каждого. Мы предлагаем лучшие модели евроокон с гарантией от производителя.
            </p>
         </div>         
         ...
         <?php 
            ...
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_na_kuhnyu' ");
         ...
         <div class="block-open">
            ...
            <span class="small-title">Размер 750 х 1350 мм, Цена от <span class="min-price"><?=$price_obj->okno_1->min?></span> грн до <span class="max-price"><?=$price_obj->okno_1->max?></span> грн</span>
         ...
         <div class="block-DoubleDoubleOpening">
            ...
            <span class="small-title">Размер 1100 х 1350 мм, Цена от <span class="min-price"><?=$price_obj->okno_3->min?></span> грн до <span class="max-price"><?=$price_obj->okno_3->max?></span> грн</span>
         ...
         <div class="block-ThreeDoubleOpening">
            ...
            <span class="small-title">Размер 1720 х 1350 мм, Цена от <span class="min-price"><?=$price_obj->okno_5->min?></span> грн до <span class="max-price"><?=$price_obj->okno_5->max?></span> грн</span>
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <div class="text-custom-page">
            <h2 class="title-post">Виды кухонных окон</h2>
            <span>В зависимости от материала изготовления окна на кухню бывают следующих видов:</span>
            <ul class="ml-3">
               <li>● деревянные – материал отлично справляется с влажной средой в помещении, при условии правильной эксплуатации минимально подвергается деформации, но не защищен от появления грибка и плесени;</li>
               <li>● алюминиевые – изделия отличаются современностью и минималистичностью, устойчивостью к агрессивным температурам; алюминиевый профиль позволяет осуществлять <a href="<?=get_bloginfo('home')?>/uslugi/bezramnoe-osteklenie/">безрамное остекление балконов и лоджий</a>, конструируя проекты с огромными открывающимися створками;</li>
               <li>● ПВХ – изготавливаются из универсального материала, который характеризуется повышенной защитой от холода, простым уходом, надежной и долговечной эксплуатацией.</li>
            </ul>
            <p>Наличие армированного вкладыша в пластиковом окне усиливает уровень шумоизоляции, теплоизоляции, предотвращает образование конденсата на стеклах. Пластиковые изделия отличаются долговечностью, при условии аккуратной эксплуатации срок службы конструкций составляет 40-45 лет.</p>

            <h2 class="title-post">Какое окно лучше установить на кухню?</h2>
            <span>Перед тем, как выбрать пластиковое окно для кухни, следует учитывать несколько рекомендаций:</span>
            <ol>
               <li>
                  Профиль подбирается с учетом типа дома и климатических условий. Изделия из дешевого пластика производятся из вторичного некачественного сырья, быстро желтеют и служат недолго. Главное отличие качественных окон от недорогих изделий – наличие замкнутого армирования по всему периметру профиля. Именно такими являются металлопластиковые окна.
               </li>
               <li>
                  От количества камер в пластиковой профильной системе зависит уровень звуко- и теплоизоляции оконной конструкции. Профиль с одной или двумя воздушными камерами сохраняет тепло хуже, чем трех-, четырех, пятикамерные системы ПВХ. Оптимальный вариант – купить оконную конструкцию из трех- или пятикамерного профиля с установленным одно- или двухкамерным стеклопакетом.
               </li>
               <li>
                  Стеклопакет на кухню влияет на звукоизоляцию и теплопроводность окна. Количество стекол влияет на толщину профильной системы: чем больше стекол, тем больше должен быть ПВХ-профиль. На кухню не следует устанавливать стеклопакеты из самого теплого профиля с толстым стеклом.
               </li>
               <li>
                  <strong>Поставить</strong> окна рекомендуется до проведения внутренних отделочных работ, чтобы не повредить стены. Обязательно оснастить окна противомоскитной сеткой, чтобы предотвратить проникновение насекомых в кухню.
               </li>
               <li>
                  Важно правильно выбрать фурнитуру, от ее качества зависит удобное открывание и закрывание оконной конструкции. Для кухни небольших размеров идеально установить окно с поворотно-откидными створками.
               </li>
            </ol>
            <p>Кроме того, установка пластикового окна должна осуществляться специалистами, с учетом особенностей кухонного помещения.</p>

            <h2 class="title-post">Дополнительные аксессуары для кухонного окна</h2>
            <p>Завершающим процессом установки окон из пластикового профиля является отделка и декор.</p>
            <span>Для выбора аксессуаров существуют определенные критерии:</span>
            <ul class="ml-3">
               <li>● особое внимание следует уделить откосам, откосы из сэндвич-панелей просты в уходе, защищены от выцветания, желтизны и растрескивания;</li>
               <li>● для тех, кто любит спрятаться от посторонних глаз, рекомендуется установить тонированные стекла, тогда нет необходимости в покупке тюля, штор или жалюзи;</li>
               <li>● большой подоконник станет идеальным дополнением кухонного окна, на нем хорошо разместить вазоны и мелкую бытовую технику;</li>
               <li>● для расширения и визуального увеличения пространства кухни следует выбрать воздушные короткие шторы;</li>
               <li>● для кухни, совмещенной со столовой, идеально подойдут длинные портьеры.</li>
            </ul>

            <h2 class="title-post">Какие стеклопакеты на кухню лучше?</h2>
            <p>Среди покупателей распространено мнение, что на кухне почти всегда высокая температура, поэтому нет необходимости в монтаже энергоэффективного стеклопакета. Это мнение является ошибочным.</p>
            <p>При повышенной влажности на стеклах образуется конденсат, постоянное наличие которого провоцирует грибок и плесень. Покупка стеклопакета с высоким уровнем теплоизоляции помогает частично решить проблему, потому как внутреннее стекло не будет оставаться зимой холодным и запотевать. Дополнительной мерой борьбы с конденсатом является эффективная вентиляция оконной конструкции.</p>
            <span>Для клиента предлагается несколько способов комплектации пластиковых окон:</span>
            <ul class="ml-3">
               <li>● подъемная или откидная фрамуга;</li>
               <li>● традиционная форточка;</li>
               <li>● наличие поворотно-откидной створки во всю высоту окна.</li>
            </ul>
            <p>Для обеспечения притока свежего воздуха, рекомендуется оснастить оконную конструкцию специальным вентиляционным клапаном. Система микропроветривания кухни особенно полезна зимой, так как створка находится в приоткрытом положении, что предотвращает запотевание окон.</p>

            <h2 class="title-post">Как заказать кухонные окна ПВХ?</h2>
            <span> Несколько вариантов, как сделать заказ, чтобы <strong>поменять окна на кухне</strong>:</span>
            <ol>
               <li>
                  Оставить заявку на сайте с указанием адреса и телефона, или адреса электронной почты.
               </li>
               <li>
                  Самостоятельно позвонить по указанному телефону. Наши специалисты не только рассчитают предварительную стоимость окна, но и помогут определиться с правильным выбором.
               </li>
            </ol>
            <p>После приема заявки на указанный адрес выезжает наш мастер, который произведет соответствующие замеры и предварительно подсчитает стоимость изделия. По окончанию изготовления монтажная бригада произведет грамотную установку оконной конструкции, с соблюдением всех необходимых требований.</p>
            <p>Также <a href="<?=get_bloginfo('home')?>/okna/wds/">купить окна WDS в Киеве</a> можно в наших магазинах, расположенных в городах Борисполь, Белая Церковь, Бровары, Васильков, Ирпень.</p>

            <h2 class="title-post">Преимущества заказа в нашей компании</h2>
            <p>В приоритете компании «Виндовс Групп» находится уважение и выполнение предпочтений своих клиентов. Заменить старое окно просто, достаточно довериться нашему бесценному опыту. Мы осуществляем установку евроокон в любом типе построек: от хрущевок до квартир и домов премиум-класса.</p>
            <span>Наши преимущества:</span>
            <ol>
               <li>Бесплатный выезд мастера для осуществления замеров и составления предварительной сметы.</li>
               <li>При необходимости проводится демонтаж и вывоз старых оконных конструкций.</li>
               <li>Предоставление гарантии на изготовленные оконные конструкции и осуществленный монтаж.</li>
               <li>Оптимальная стоимость изготовления вместе с доставкой и установкой.</li>
               <li>Большой ассортимент стройматериалов, фурнитуры, дверных и оконных профилей, соответствующим европейским стандартам качества.</li>
            </ol>
            <p>В результате вы получите качественное окно, которые будет гармонично сочетаться с гарнитуром, подчеркивать общий стиль и освещать пространство кухни.</p>

            <h2 class="title-post">Как рассчитать стоимость металлопластиковых окон на кухню?</h2>
            <p>Чтобы рассчитать предварительные <a href="<?=get_bloginfo('home')?>/plastikovye-okna/">цены металлопластиковых окон</a> на кухню, можно воспользоваться встроенным онлайн-калькулятором на нашем сайте.</p>
            <span>Для этого потребуется внести в оконный калькулятор следующие данные:</span>
            <ul class="ml-3">
               <li>● тип окна (одностворчатое, двухстворчатое, трехстворчатое);</li>
               <li>● тип открытия (глухое или окно с открыванием);</li>
               <li>● ширина и высота изделия в единице измерения (миллиметрах);</li>
               <li>● профиль (тип, стеклопакет (однокамерный, двухкамерный, трехкамерный, энергосберегающий), фурнитура).</li>
            </ul>
            <p>После внесения вышеперечисленных данных на экране необходимо нажать на команду «Рассчитать стоимость». В результате автоматизации программа выдаст на дисплей ориентировочные расчеты по изготовлению оконной конструкции, также смета будет отправлена на адрес вашей электронной почты.</p>

            <h2 class="title-post">Где купить евроокна для кухни в Украине?</h2>
            <span>Компания «Виндовс Груп» предлагает к покупке качественные модели евроокон для кухни от известных производителей, таких как:</span>
            <ul class="ml-3">
               <li>● Aluplast;</li>
               <li>● Salamander;</li>
               <li>● Rehau;</li>
            ...
            <p>Также в наших каталогах представлены <a href="<?=get_bloginfo('home')?>/plastikovye-dveri/na-balkon/">пластиковые окна с дверью на балкон</a> для увеличения пространства и функциональности кухонного помещения. Узнать <a href="<?=get_bloginfo('home')?>/uslugi/osteklenie-balkonov-i-lodzhij/">цены на остекление лоджии</a> можно на сайте у менеджера-консультанта или по телефону.</p>
            <p>С окнами от «Windows Group» ваша кухня преобразится и станет комфортной. Смелее оставляйте заявку на замеры и заказывайте понравившуюся модель евроокна!</p>
   ...
   <section class="section-other-type-windows">
      <div class="container">
         ...
         <ul class="list-other-type-windows">
            <li class="item-other-type-windows"><img src="<?php bloginfo('template_url') ?>/images/metalloplastikovye-okna-na-dachu.ef19de49.png" class="img-box-shadow p-3 img-fluid" alt="photo"> <a href="<?=get_bloginfo('home')?>/plastikovye-okna/na-dachu" class="title-footer">На Дачу</a></li>
