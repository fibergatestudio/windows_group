...
<div class="main page-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
            <h1 class="title-post">ПВХ (пластиковые) окна в дом – цены</h1>
            <p class="text-custom-page">Создать комфорт и уют в собственном доме помогут качественные оконные конструкции.
                Наша компания "Виндовс Груп” предлагает купить окна в дом от производителя по доступным ценам в Киеве и области.
                В каталогах представлены лучшие модели окон ПВХ стандартной и нестандартной формы.</p>
         </div>
         
         <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_v_dom' ");
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Виды окон для дома частного дома</h2>
         <p>Красивые окна в частном доме создадут легкую и комфортную обстановку. Существует несколько разновидностей оконных конструкций в зависимости от способа открывания:</p>
         <ul>
            <li>· глухие;</li>
            <li>· поворотные;</li>
            <li>· откидные;</li>
         ...
         <p>Глухие окна в каркасном доме отличаются надежностью и простотой изготовления. Оконная система не имеет механизмов, поэтому изделия защищены от поломки. Глухие блоки устанавливаются на первых этажах для предотвращения несанкционированного доступа в помещение. Дополнительно для безопасности используются противовзломная фурнитура, ставни, жалюзи, роллеты.</p>
         <p>Поворотные конструкции являются распространенным типом. В случае установки поворотного механизма на все створки, окна становятся доступными для мытья. Конструкции с открывающимися створками монтируются в комнатах, где необходима вентиляция.</p>
         <p>Откидные окна для частного дома оснащаются механизмом откидывания в горизонтальной или вертикальной плоскости. Оконные створки могут откидываться вниз или открываться вверх.</p>
         <p>Поворотно-откидные модели открываются посредством поворота ручки.Они имеют дополнительную функцию микропроветривания. Данный тип является оптимальным вариантом для строений с регулярной потребностью в проветривании.</p>
         <p>Еще одним популярным видом являются панорамные конструкции, используемые при остеклении балконов, террас, веранд, лоджий. Панорамный балкон в панельном доме позволяет любоваться природой из окна. Лоджия с панорамным остеклением визуально расширяет пространство, делая помещение светлым. При панорамном остеклении применяются многослойные безопасные стекла (триплекс). Кроме повышенной удароустойчивости они отличаются теплосбережением и звукоизоляцией.</p>
         <p>Типы окон по форме бывают разные: круглые, трапециевидные, прямоугольные, арочные. Для нестандартных проемов изготавливаются конструкции по индивидуальным параметрам, с учетом особенностей помещения.</p>
         <h2 class="title-post">Преимущества пластиковых окон для загородного дома</h2>
         <p>Звукопоглощающие и термоизоляционные характеристики оконных конструкций из ПВХ профиля превосходят изделия из других материалов. Пластиковые окна в частный дом обладают следующими преимуществами:</p>
         <ul>
            <li>· высокой технологичностью изготовления;</li>
            <li>· герметичностью (сохранение теплого воздуха в помещении зимой и прохладу летом);</li>
            <li>· устойчивостью к любому атмосферному воздействию;</li>
            <li>· защитой от деформации, желтизны и выцветания;</li>
            <li>· простотой ухода;</li>
            <li>· пожаробезопасностью.</li>
         </ul>
         <p>При правильной эксплуатации оконные блоки из пластика не нуждаются в обслуживании и ремонте.</p>
         <h2 class="title-post">Как подобрать нужный профиль</h2>
         <p>Толщина профиля окна в загородный дом подбирается с учетом климатических условий и наличия шумов в местности.</p>
         <p>При выборе профиля следует знать некоторые нюансы:</p>
         <ol>
            <li>Монтажная глубина и количество воздушных камер влияют на теплосберегающие свойства изделия. Чем выше параметры, тем жестче и теплее конструкция.</li>
            <li>Толщина внешней и наружной стенки отвечает за уровень сопротивления нагрузкам, долговечность и прочность конструкции. От толщины зависит уровень энергоэффективности и шумопоглощения.</li>
            <li>Присутствие металлических вкладышей в пластиковом профиле защищает оконные блоки от деформации. Оптимальная толщина армирующего металла составляет 1,5 мм.</li>
            <li>От количества уплотнительных контуров зависит герметичность конструкции.При условиях эксплуатации при сильных ветрах и низких температурах рекомендуется выбирать модели с тремя контурами уплотнения.</li>
            <li>Глубина фальца профильной системы влияет на вероятность появления конденсата на стеклопакетах. Оптимальная глубина фальца составляет 20-21 мм.</li>
         </ol>
         <p>В загородных домах с холодным климатом или расположением вблизи шумной улицы используются оконные конструкции из 4-5 профильной системы. Для коттеджей, расположенных в южной стороне, применяются изделия из трехкамерного профиля.</p>
         <p>Дополнительно при выборе профиля стоит учитывать фурнитуру и разновидность стеклопакета.</p>
         <h2 class="title-post">Преимущества нашей компании</h2>
         <p>Компания “Windows Group” при заказе учитывает следующие факторы:</p>
         <ol>
            <li>Местоположение объекта.</li>
            <li>Планировку дома, материал стен.</li>
            <li>Качество и технические особенности профиля.</li>
            <li>Разновидность стеклопакета, тип стекла.</li>
            <li>Цвет и ламинацию профиля.</li>
            <li>Фурнитуру.</li>
            <li>Дополнительные элементы (вентиляционный клапан, откосы, отливы, ручки, москитную сетку).</li>
         </ol>
         <p>Все нюансы заказа оговариваются непосредственно после осуществления замера на объекте.</p>
         <h2 class="title-post">Цены на пластиковые окна для частного дома</h2>
         <p>Итоговая цена пластикового окна в частный дом складывается из типа и размера конструкции, материала изготовления, условий доставки и монтажных услуг. Узнать стоимость пластиковых оконных блоков в Украине можно на сайте или позвонить по телефону. Мы гарантируем качество и лучшее обслуживание!</p>
      </div>
   </section>
