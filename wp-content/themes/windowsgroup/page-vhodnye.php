...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
             <h1 class="title-post">Пластиковые входные двери</h1>
             <p class="text-custom-page">Металлопластиковые входные двери предназначаются не только для производственных помещений, но и для частных домов.
                 Мы предлагаем вам купить пластиковые двери из ПВХ в Киеве по цене производителя.
                 В наших красочных каталогах представлены популярные модели входных дверей из металлопластика.
                 У нас можно приобрести качественные изделия любого размера и конфигурации.</p>
         </div>

         <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'dvery_vhodniye' ");
            $price_obj = json_decode($result_params[0]->data);
         
         ?>
         
         <div class="block-windows-type-1">
            <h2 class="title-block-type-windows">Входные металлопластиковые двери</h2>
            <span class="small-title">Размер 1400 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->vhodnaya->min?></span> грн до <span class="max-price"><?=$price_obj->vhodnaya->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-open">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->vhodnaya as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-open" role="tabpanel" aria-labelledby="<?=$key_w?>-open">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/1-vkhodnyye-metalloplastikovyye-dveri.cc63397b.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->vhodnaya->$key_w;
                              $j = 0;
         ...
         <div class="block-windows-type-2">
            <h2 class="title-block-type-windows">Входные металлопластиковые двери с сэндвич панелью</h2>
            <span class="small-title">Размер 1800 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->vhodnaya_s_sendvich->min?></span> грн до <span class="max-price"><?=$price_obj->vhodnaya_s_sendvich->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->vhodnaya_s_sendvich as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>" role="tabpanel" aria-labelledby="<?=$key_w?>">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/2-vkhodnyye-metalloplastikovyye-dveri-s-sendvich-panelyu.d86befc9.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->vhodnaya_s_sendvich->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <!-- <div class="block-windows-type-3">
            <h2 class="title-block-type-windows">Входные металлопластиковые двери с штульпом</h2>
            <span class="small-title">Размер 750 х 1350 мм, Цена от <span class="min-price">1965</span> грн до <span class="max-price">5027</span> грн</span>
            <ul class="nav nav-tabs" id="myTab-DoubleOneOpening" role="tablist">
               ...
               <li class="nav-item"><a class="nav-link" id="opentek-type-3-tab" data-toggle="tab" href="#opentek-type-3" role="tab" aria-controls="type-3-teck" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
            ...
            <div class="tab-content" id="myTabContent-type-3">
               <div class="tab-pane fade show active" id="wds-type-3" role="tabpanel" aria-labelledby="wds-type-3">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/3-vkhodnyye-metalloplastikovyye-dveri-so-shtulpom.0ebfeeba.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <td class="name">Energetto 4000</td>
                              <td>86 мм</td>
                              <td>3551 грн</td>
                              <td>3551 грн</td>
                              <td>3551 грн</td>
                           ...
                           <tr>
                              <td class="name">Energetto 8000</td>
                              <td>80 мм</td>
                              <td>5201 грн</td>
                              <td>5201 грн</td>
                              <td>5201 грн</td>
               ...
               <div class="tab-pane fade" id="windoffs-type-3" role="tabpanel" aria-labelledby="windoffs-type-3-tab"></div>
               <div class="tab-pane fade" id="viknaland-type-3" role="tabpanel" aria-labelledby="viknaland-type-3-tab"></div>
               <div class="tab-pane fade" id="rehau-type-3" role="tabpanel" aria-labelledby="rehau-type-3-tab"></div>
               <div class="tab-pane fade" id="salamander-type-3" role="tabpanel" aria-labelledby="salamander-type-3-tab"></div>
               <div class="tab-pane fade" id="kbe-type-3" role="tabpanel" aria-labelledby="kbe-type-3-tab"></div>
               <div class="tab-pane fade" id="opentek-type-3" role="tabpanel" aria-labelledby="opentek-type-3-tab"></div>
               <div class="tab-pane fade" id="veka-type-3" role="tabpanel" aria-labelledby="veka-type-3-tab"></div>
               <div class="tab-pane fade" id="aluplast-type-3" role="tabpanel" aria-labelledby="aluplast-type-3-tab"></div>
            </div>
         </div> -->
         <div class="block-windows-type-4">
            <h2 class="title-block-type-windows">Входные металлопластиковые двери с фрамугой</h2>
            <span class="small-title">Размер 1400 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->vhodnaya_s_framogoy->min?></span> грн до <span class="max-price"><?=$price_obj->vhodnaya_s_framogoy->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-4">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->vhodnaya_s_framogoy as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-4" role="tabpanel" aria-labelledby="<?=$key_w?>-type-4">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/4-vkhodnyye-metalloplastikovyye-dveri-s-framugoy.800a2043.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->vhodnaya_s_framogoy->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-5">
            <h2 class="title-block-type-windows">Входные металлопластиковые двери с фрамугой и сэндвич панелью</h2>
            <span class="small-title">Размер 1400 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->vhodnaya_s_framogoy_sendvich->min?></span> грн до <span class="max-price"><?=$price_obj->vhodnaya_s_framogoy_sendvich->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-5">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->vhodnaya_s_framogoy_sendvich as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-5" role="tabpanel" aria-labelledby="<?=$key_w?>-type-5">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/5-vkhodnyye-metalloplastikovyye-dveri-s-framugoy-i-sendvich-panelyu.637e78ba.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->vhodnaya_s_framogoy_sendvich->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-6">
            <h2 class="title-block-type-windows">Входные металлопластиковые двери с окнами по бокам</h2>
            <span class="small-title">Размер 1800 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->vhodnaya_s_oknamy->min?></span> грн до <span class="max-price"><?=$price_obj->vhodnaya_s_oknamy->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-6">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->vhodnaya_s_oknamy as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-6" role="tabpanel" aria-labelledby="<?=$key_w?>-type-6">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/6-vkhodnyye-metalloplastikovyye-dveri-s-oknami-po-bokam.4dd292e8.png" class="vertical-doors-3 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->vhodnaya_s_oknamy->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-7">
            <h2 class="title-block-type-windows">Входная одностворчатая металлопластиковая дверь с перемычкой</h2>
            <span class="small-title">Размер 900 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->odnastvorchataya->min?></span> грн до <span class="max-price"><?=$price_obj->odnastvorchataya->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-7">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-7" role="tabpanel" aria-labelledby="<?=$key_w?>-type-7">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/7-vkhodnaya-odnostvorchataya-metalloplastikovaya-vder-s-peremychkoy.a7399f2e.png" class="vertical-doors img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-windows-type-8">
            <h2 class="title-block-type-windows">Входная одностворчатая металлопластиковая дверь с сэндвич панелью</h2>
            <span class="small-title">Размер 1720 х 1350 мм, Цена от <span class="min-price"><?=$price_obj->odnastvorchataya_s_sendvich->min?></span> грн до <span class="max-price"><?=$price_obj->odnastvorchataya_s_sendvich->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-8">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-8" role="tabpanel" aria-labelledby="<?=$key_w?>-type-8">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/8-vkhodnaya-odnostvorchataya-metalloplastikovaya-dver-s-sendvich-panelyu.29198d45.png" class="vertical-doors img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-windows-type-9">
            <h2 class="title-block-type-windows">Входная одностворчатая металлопластиковая дверь с перемычкой и фрамугой</h2>
            <span class="small-title">Размер 900 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->odnastvorchataya_s_framogoy->min?></span> грн до <span class="max-price"><?=$price_obj->odnastvorchataya_s_framogoy->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-9">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-9" role="tabpanel" aria-labelledby="<?=$key_w?>-type-9">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/9-vkhodnaya-odnostvorchataya-metalloplastikovaya-dver-s-peremychkoy-i-framugoy.110a17fe.png" class="vertical-doors img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-windows-type-10">
            <h2 class="title-block-type-windows">Входная одностворчатая металлопластиковая дверь с фрамугой и сэндвич панелью</h2>
            <span class="small-title">Размер 900 х 2600 мм, Цена от <span class="min-price"><?=$price_obj->odnastvorchataya_s_framogoy_sendvich->min?></span> грн до <span class="max-price"><?=$price_obj->odnastvorchataya_s_framogoy_sendvich->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-10">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->odnastvorchataya_s_framogoy_sendvich as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-10" role="tabpanel" aria-labelledby="<?=$key_w?>-type-10">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/10-vkhodnaya-odnostvorchataya-metalloplastikovaya-dver-s-framugoy-i-sendvich-panelyu.d25aa543.png" class="vertical-doors img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->odnastvorchataya_s_framogoy_sendvich->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Виды конструкций пластиковых входных дверей</h2>
         <p>Входные пластиковые двери состоят из нескольких элементов:</p>
         <ol>
            <li>Полотна. Дверная полость заполняется материалом для повышенной теплоизоляции.</li>
            <li>Профильная система. Стальной армирующий профиль обеспечивает устойчивость и прочность конструкции.</li>
            <li>Стеклопакет. Для изготовления используются специальные типы стекла – триплекс.</li>
            <li>Механизмы затвора. Размещаются по периметру пластикового полотна, обеспечивают плотный прижим по всему изделию.</li>
            <li>Фурнитура – замки, ручки, доводчики, петли.</li>
            <li>Порог. Изготавливается из различных металлических сплавов. Для герметичности в пороге имеется специальный резиновый уплотнитель.</li>
         </ol>
         <p>В зависимости от конструкции входные металлопластиковые двери для частного дома бывают одностворчатыми и двухстворчатыми. В двухстворчатых конструкциях размер створок зависит от ширины дверного проема. Одна створка рабочая, а вторая – открывается при необходимости перемещения крупногабаритного предмета.</p>
         <h2 class="title-post">Основные характеристики и особенности</h2>
         <p>По типу открывания дверь бывает распашная или раздвижная. Распашные конструкции предусматривают открывание внутрь/наружу помещения или одновременно две створки в одну сторону. У внутренних входных дверей из пластика имеется штапик, фиксирующий стеклопакет, в наружных – штапик располагается внутри.</p>
         <p>В зависимости от вида открывания механизм раздвижных моделей бывает:</p>
         <ul>
            <li>· роликовый;</li>
            <li>· кассетный;</li>
            <li>· по принципу “книжки”;</li>
            <li>· по принципу “гармошки”.</li>
         </ul>
         <p>Роликовый и кассетный механизмы являются универсальными. Принцип работы основывается на плавном передвижении конструкции по направляющим роликам. Однако в отличие от роликового в кассетном типе плотно закрывается полотно, не оставляя зазоров.</p>
         <p>Механизм “книжка” и “гармошка” подойдут для установки при условии, если есть большой дверной проем, а приближенные стены узкие. В таком случае не будет “лишнего” места для отодвигания створки.</p>
         <p>Большинство раздвижных моделей представлены металлическими или имеют стеклянные вставки. При открывании металлической конструкции створки убираются в специально отведенный проем в стене. Подвесные стальные изделия компактные и многофункциональные.</p>
         <p>Для раздвижных дверных систем используется стекло следующих разновидностей:</p>
         <ul>
            <li>· ламинированное;</li>
            <li>· закаленое;</li>
            <li>· акриловое;</li>
            <li>· армированное.</li>
         </ul>
         <p>Триплекс бывает не только ровным, но и волнистым, с выбитыми полосками или рисунком. Защитное стекло характеризуется прочностью, термостойкостью и звукоизоляцией.</p>
         <p>В отличие от триплекса закаленное и акриловое стекла лучше пропускают свет в помещение. Армированное стекло представляет собой листовое стекло с металлической проволокой. Такая конструкция при разрушении не осыпается, мелкие ячейки не представляют опасности. Армированное стекло может быть прозрачным, цветным и разноцветным.</p>
         <h2 class="title-post">Преимущества</h2>
         <p>Металлопластиковые входные двери славятся рядом преимуществ:</p>
         <ol>
            <li>Надежностью и долговечностью.</li>
            <li>Тепло- и звукоизоляцией.</li>
            <li>Устойчивостью к атмосферным осадкам, высокой влажности, ультрафиолетовым лучам.</li>
            <li>Отсутствием коррозии.</li>
            <li>Возможностью использования противовзломной фурнитуры, различных систем открывания.</li>
            <li>Простотой ухода и легкой чисткой.</li>
            <li>Совместимы с сигнализационной системой.</li>
         </ol>
         <p>В сравнении с конструкциями из других материалов пластиковые входные двери отличаются доступной ценой. Изделие из ПВХ не требует дальнейшей покраски. При правильной эксплуатации не требуется замена и ремонт.</p>
         <p>Недостатки</p>
         <p>Со временем металлопластиковая дверь способна деформироваться. Однако усиление пластиковой конструкции стальным профилем максимально препятствует деформации. Несмотря на высокое качество, дверь из пластика провисает. Предотвратить провисание поможет периодическая регулировка фурнитуры.</p>
         <h2 class="title-post">Как выбрать</h2>
         <p>При покупке входной конструкции из металлопластика, следует учитывать некоторые критерии:</p>
         <ol>
            <li>Высокая степень надежности конструкции достигается за счет применения металлического пятикамерного профиля створки, мощных дверных петлей.</li>
            <li>Рама должна иметь утолщенный каркас, по углам соединенный металлопрофилем.</li>
            <li>При выборе замка предпочтительны засовы, задвигающиеся по всему периметру.</li>
            <li>Стеклопакет в дверном полотне прочнее, чем в конструкции окна.</li>
         </ol>
         <p>При выборе двери со стеклянной вставкой необходимо учитывать, чтобы площадь остекления полотна не превышала 1/3 часть створки.</p>
         <h2 class="title-post">Куда можно установить – квартира и дом</h2>
         <p>В частный дом пластиковые входные двери устанавливаются, когда необходимо сохранить в помещении тепло. Такие двери шумоизоляционные, плотно закрываются, не пропускают сквозняк даже в холодное время года. Они защищают помещение от температурных перепадов, ветровых нагрузок, пыли и влаги.</p>
         <p>Пластиковые изделия могут устанавливаться в качестве входной двери на верандах, балконах, в офисных помещениях, в гаражах, подвалах, в проходах между комнатами.</p>
         <p>Двери из металлической конструкции монтируются в частных владениях: коттеджах, домах, дачах.</p>
         <p>Мы предлагаем купить входные пластиковые двери для частного дома по приемлемой цене в Киеве и области. Наша компания готова предложить различные модели от производителей с гарантией европейского качества и обслуживания. Узнать цены на изделия можно в прайсе или, позвонив по телефону.</p>
      </div>
   </section>
