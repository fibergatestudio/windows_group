...
<div class="main page-aluminum-product">
   ...
   <section class="section-top-page">
      <div class="container">
         ...
         <h2 class="title-section">Алюминиевый зимний сад купить в Киеве</h2>
         <div class="block-img-flout clearfix">
            <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/zimnie-sady.83154f2f.jpg" class="img-fluid" alt="photo-product"></div>
             <p>
                 Зимний сад является не только оранжерей, но и местом для отдыха. В домашнем уголке приятно окунуться в расслабляющую атмосферу после трудовых будней. Наша компания «Виндовс Груп» предлагает заказать алюминиевый зимний сад в Киеве и Киевской области по лучшей цене.
             </p>
             <p>
                 Использование алюминиевого профиля позволяет применять различные способы остекления – от небольших окон до массивных светопрозрачных
                 вставок. Панорамное остекление обеспечивает максимальное освещение постройки. Дополнительно большие окна используются в качестве
                 раздвижных дверей.
             </p>
             <p> Размеры зимнего сада подбираются с учетом снятых параметров в помещении, где планируется установка конструкции.</p>
         </div>
   ...
   <section class="section-preference">
      <div class="container">
         <h2 class="title-section">Преимущества Алюминиевых Зимних Садов</h2>
   ...
   <section class="section-text">
      <div class="container">
         <h2 class="title-section">Особенности</h2>
          <p>
              При строительстве оранжереи часто выбирается алюминиевый профиль. Алюминий отличается легкостью и устойчивостью форм. Прозрачные герметичные стены пропускают большое количество солнечного света в помещение, тем самым позволяя экономить на электроэнергии и отоплении.
          </p>
      </div>
   </section>
   ...
   <section class="block-portfolio">
    ...
    <section class="section-post section-post-windows section-other-type-windows">
        <div class="container">
            <h2 class="title-section">Преимущества  зимниx садов</h2>
            <div class="text-custom-page">
                <p> Оранжерея из алюминиевого профиля характеризуется несколькими преимуществами:</p>
                <ul>
                    <li>·         устойчивостью к коррозии;</li>
                    <li>·         возможностью круглогодичного выращивания растений;</li>
                    <li>·         защитой от негативных внешних факторов;</li>
                    <li>·         стойкостью к высоким и низким температурам;</li>
                    <li>·         отличной светопропускной способностью;</li>
                    <li> ·         пожароустойчивостью.</li>
                </ul>
                <p>
                    При заказе оранжереи в «Windows Group», вы получаете готовую конструкцию из качественных материалов, и ее профессиональную установку.
                </p>
                <h2 class="title-post">Сферы использования</h2>
                <p>Зимний сад используется на следующих объектах:</p>
                <ul>
                    <li>·         в жилых помещениях;</li>
                    <li>·         в административных зданиях;</li>
                    <li>·         в государственных учреждениях;</li>
                    <li>·         в салонах и офисах;</li>
                    <li>·         в спортивных клубах и торгово-развлекательных центрах.</li>
                </ul>
                <p>
                    Конструкция изготавливается в качестве отдельной постройки или пристройки к основному зданию. Популярный вариант размещения оранжереи – в лоджии или на мансардном этаже дома.
                </p>
                <h2 class="title-post"> Стоимость и как купить</h2>
                <p> Стоимость алюминиевого зимнего сада под ключ зависит от нескольких факторов:</p>
                <ul>
                    <li>·         типа конструкции;</li>
                    <li>·         фурнитуры;</li>
                    <li>·         типа стеклопакета;</li>
                    <li>·         способы открывания створок;</li>
                    <li>·         условий эксплуатации;</li>
                    <li>·         цветового исполнения и декора изделия.</li>
                </ul>
                <p>
                    Компания «Windows Group» предлагает купить алюминиевый зимний сад по цене от производителя. Мы предлагаем широкий выбор продукции с гарантией качества и лучшего обслуживания. Узнать цены на изделия можно на сайте или, позвонив по телефону.
                </p>
            </div>
        </div>
    </section>
