...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
            <h1 class="title-post">Межкомнатные пластиковые двери в Киеве</h1>
            <p class="text-custom-page">
             Современный рынок предлагает огромное количество разных видов межкомнатных пластиковых дверей.
                 Существующая классификация разделяет изделия по конструкционным особенностям и параметрам
                 совместимости с интерьером. Поэтому, купить пластиковые двери – означает совершить грамотный выбор
                 по доступной цене от производителя.
             </p>
         </div>
         ...
         <?php 
            ...
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'dvery_mezkomnatnie' ");
            $price_obj = json_decode($result_params[0]->data);
         
         ?>
         
         <div class="block-windows-type-1">
            <h2 class="title-block-type-windows">Межкомнатная металлопластиковая дверь</h2>
            <span class="small-title">Размер 800 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->mezkomnatnie->min?></span> грн до <span class="max-price"><?=$price_obj->mezkomnatnie->max?></span> грн</span>
            <ul class="nav nav-tabs" id="myTab-open" role="tablist">
               ...
               <li class="nav-item"><a class="nav-link" id="kbe-open-tab" data-toggle="tab" href="#kbe-open" role="tab" aria-controls="kbe-open" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/kbe-logo-1.0d5c807a.svg" class="img-fluid" alt="photo"></a></li>
               <li class="nav-item"><a class="nav-link" id="opentek-open-tab" data-toggle="tab" href="#opentek-open" role="tab" aria-controls="opentek-open" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
            ...
            <div class="tab-content" id="myTabContent-open">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->mezkomnatnie as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-open" role="tabpanel" aria-labelledby="<?=$key_w?>-open">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/1-mezhkomnatnaya-metalloplastikovaya-dver.85875d55.png" class="vertical-doors img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->mezkomnatnie->$key_w;
                              $j = 0;
         ...
         <!-- <div class="block-windows-type-2">
            <h2 class="title-block-type-windows">Раздвижные межкомнатные металлопластиковые двери</h2>
            ...
            <div class="tab-content" id="myTabContent">
               <div class="tab-pane fade show active" id="wds" role="tabpanel" aria-labelledby="wds">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/2-razdvizhnyye-mezhkomnatnyye-metalloplastikovyye-dveri.201a15de.png" class="vertical-doors-3 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
               ...
               <div class="tab-pane fade" id="windoffs" role="tabpanel" aria-labelledby="windoffs-tab"></div>
               <div class="tab-pane fade" id="viknaland" role="tabpanel" aria-labelledby="viknaland-tab"></div>
               <div class="tab-pane fade" id="rehau" role="tabpanel" aria-labelledby="rehau-tab"></div>
               <div class="tab-pane fade" id="salamander" role="tabpanel" aria-labelledby="salamander-tab"></div>
               <div class="tab-pane fade" id="kbe" role="tabpanel" aria-labelledby="kbe-tab"></div>
               <div class="tab-pane fade" id="opentek" role="tabpanel" aria-labelledby="opentek"></div>
               <div class="tab-pane fade" id="veka" role="tabpanel" aria-labelledby="veka-tab"></div>
               <div class="tab-pane fade" id="aluplast" role="tabpanel" aria-labelledby="aluplast-tab"></div>
            </div>
         </div>
         <div class="block-windows-type-3">
            <h2 class="title-block-type-windows">Раздвижная межкомнатная металлопластиковая дверь</h2>
            <span class="small-title">Размер 750 х 1350 мм, Цена от <span class="min-price">1965</span> грн до <span class="max-price">5027</span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-3">
               <div class="tab-pane fade show active" id="wds-type-3" role="tabpanel" aria-labelledby="wds-type-3">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/3-razdvizhnaya-mezhkomnatnaya-metalloplastikovaya-dver.a878bbd4.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-windows-type-4">
            <h2 class="title-block-type-windows">Межкомнатные металлопластиковые двери со штульпом</h2>
            <span class="small-title">Размер 1200 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->mezkomnatnie_s_shtulpom->min?></span> грн до <span class="max-price"><?=$price_obj->mezkomnatnie_s_shtulpom->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-4">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->mezkomnatnie_s_shtulpom as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-4" role="tabpanel" aria-labelledby="<?=$key_w?>-type-4">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/4-mezhkomnatnyye-metalloplastikovyye-dveri-so-shtulpom.cc63397b.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->mezkomnatnie_s_shtulpom->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Плюсы и минусы межкомнатных пластиковых дверей</h2>
         <p>Наша компания WindowsGroup предлагает пластиковые межкомнатные двери по демократичной цене в Украине для любых помещений. На основе многочисленных достоинств материала и качественного монтажа изделие пользуется востребованностью среди различных слоев населения.</p>
         <p>Ключевые плюсы товара:</p>
         <ul>
            <li>· качественная теплоизоляция препятствует снижению температуры в помещении;</li>
            <li>· звукоизоляционные свойства минимизируют слышимость шума;</li>
            <li>· долговечность и устойчивость к атмосферным факторам воздействия;</li>
            <li>· относительно небольшой вес конструкции;</li>
            <li>· уход за изделием не требует особых усилий и специальных средств;</li>
            <li>· межкомнатные металлопластиковые двери по цене находятся в бюджетном сегменте.</li>
         </ul>
         <p>Основными минусами являются:</p>
         <ul>
            <li>· проблема устранения повреждений, нанесенных механическим путем или вследствие нарушений норм эксплуатации;</li>
            <li>· не подходят под интерьер, подчеркивающий роскошь и богатство;</li>
            <li>· блокируют возможность проникновения воздуха.</li>
         </ul>
         <h2 class="title-post">Особенности и характеристики конструкции</h2>
         <p>Пластиковые межкомнатные двери характеризуются наличием конструкционных нюансов:</p>
         <ol>
            <li>Установка изделия внутри помещения предполагает использование петель оконного типа. Предварительно необходимо рассчитать вес конструкции с заполнением. Максимальная нагрузка для петель – 80 кг.</li>
            <li>«Офисная ручка» в данном варианте не устанавливается. Отлично зарекомендовал себя одноточечный замок, если помещение не требует идеальной герметизации. Его эксплуатация в данном случае более оправдана, чем установка многоточечного замка.</li>
            <li>Что касается порога, то можно установить алюминиевый или пластиковый вариант. В случае цельного покрытия пола в помещениях, разделяемых дверью, порог не обязателен.</li>
            <li>По стационарным размерам ширина изделия не может превышать 850 мм, а высота 2100 мм. Поэтому подбор фурнитуры выполняется исходя из данных параметров.</li>
         </ol>
         <p>Дополнительно дверь заполняется стеклом прозрачного, матового или текстурного свойства. Оригинальностью отличаются различные вставки и орнаменты.</p>
         <h2 class="title-post">Виды межкомнатных пластиковых дверей</h2>
         <p>Межкомнатные металлопластиковые двери имеют несколько классификаций,</p>
         <p>Разделение по назначению:</p>
         <ol>
            <li>Предназначенные для офиса. Характеризуются наличием доводчика, различных форм ручек и ригеля. Перечисленные элементы необходимы для пропуска большого количества людей.</li>
            <li>Устанавливаемые в жилых зданиях. Их конструкция ориентирована на эксплуатацию в квартирах, домах гостиницах и т.д.</li>
         </ol>
         <p>Наиболее важной является классификация по способу открывания:</p>
         <ol>
            <li>Распашные изделия по-прежнему самые популярные. Они открываются традиционным способом. Требуют много места для полноценного открытия. Состоят из одной или двух створок и рамы. Производятся разных размеров, с ориентацией открытия направо или налево.</li>
            <li>Раздвижные двери межкомнатные – изделие, которое находит все больше поклонников. Они экономят полезную площадь помещения при открывании. Раздвигаясь, прячутся в стене или располагаются вдоль нее. Доступны как одно- или двухстворчатые модели. Их крылья движутся на специальных тележках и направляющей, которая крепится вверху дверного проема.</li>
            <li>Складные варианты. Также часто называются сломанными, из-за того, что их крылья разделены на две вертикальные части, которые связаны между собой шарнирами. Они просто открываются в одну сторону, что, к сожалению, уменьшает ширину прохода. Крылья движутся по специальному рельсу с помощью ползунков или тележек. Длина рельса адаптирована к размерам проема и прикреплена к верхней части рамы.</li>
         </ol>
         <p>Индивидуальность товара подчеркивается:</p>
         <ul>
            <li>· наличием или отсутствием декоративных элементов;</li>
            <li>· выбором цветового окраса;</li>
            <li>· внедрением различных дизайнерских решений.</li>
         </ul>
         <p>При выборе подобного изделия на первый план выходят эксплуатационные возможности фурнитуры. На этом необходимо акцентировать внимание при покупке.</p>
         <h2 class="title-post">Как выбрать межкомнатные пластиковые двери</h2>
         <p>Наш специалист всегда порекомендует подходящий тип дверей под определенный интерьер. Важно учесть многие технические детали, чтобы дверь идеально сочеталась с дизайном помещения, но и прослужила длительный срок.</p>
         <p>На что обратить внимание:</p>
         <ol>
            <li>Размеры модели должны согласовываться с проемами в помещении.</li>
            <li>Лучше покупать полный набор одного производителя, чтобы продлить срок эксплуатации.</li>
            <li>Продуманным решением станет повсеместная замена дверей во всем помещении одновременно.</li>
            <li>Качество товара подтверждается сертификатами.</li>
         </ol>
         <p>Если вы хотите, чтобы межкомнатные пластиковые двери по параметру цена/качество удовлетворили ваши запросы, то лучше обратиться к профессионалам в компанию WindowsGroup. На сайте или по контактным телефонам можно заранее обсудить комплектацию и внешний вид товара.</p>
      </div>
   </section>
   <section class="section-other-type-windows">
      <div class="container">
         ...
         <ul class="list-other-type-windows">
            ...
            <li class="item-other-type-windows">
               <div class="block-img-other doors"><img src="<?php bloginfo('template_url') ?>/images/shtulpovye-metalloplastikovye-dveri.bf60a320.jpg" class="pb-lg-4 not-all-img img-fluid" alt="photo"></div>
