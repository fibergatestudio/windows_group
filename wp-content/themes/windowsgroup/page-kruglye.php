...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
             <h1 class="title-post">Круглые ПВХ (пластиковые) окна в Киеве – цены</h1>
             <p class="text-custom-page">Современное строительство не перестает удивлять. Нестандартная оконная конструкция подчеркнет индивидуальность и стиль помещения.
                 Наша компания “Виндовс Груп” предлагает купить круглое окно в Киеве и области по лучшим ценам.
                 Даже самый требовательный покупатель сможет в каталоге выбрать для себя подходящую модель.
                 Мы гарантируем качество от производителя и высокий уровень обслуживания.</p>
         </div>

         <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_krugliye' ");
            $price_obj = json_decode($result_params[0]->data);
         
         ?>
         
         <div class="block-windows-type-1">
            <h2 class="title-block-type-windows">Окно круглое</h2>
            <span class="small-title">Размер 1000 х 1000 мм, Цена от <span class="min-price"><?=$price_obj->krugloye->min?></span> грн до <span class="max-price"><?=$price_obj->krugloye->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-open">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->krugloye as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-open" role="tabpanel" aria-labelledby="<?=$key_w?>-open">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/windows-circle.d26a9511.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->krugloye->$key_w;
                              $j = 0;
         ...
         <div class="block-windows-type-2">
            <h2 class="title-block-type-windows">Окно Круглое с Крестиком Глухое</h2>
            <span class="small-title">Размер 1000 х 1000 мм, Цена от <span class="min-price"><?=$price_obj->krugloye_s_krestikom_gluhoe->min?></span> грн до <span class="max-price"><?=$price_obj->krugloye_s_krestikom_gluhoe->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->krugloye_s_krestikom_gluhoe as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>" role="tabpanel" aria-labelledby="<?=$key_w?>">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/windows-circle-close.2393c2b4.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->krugloye_s_krestikom_gluhoe->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <!-- <div class="block-windows-type-3">
            <h2 class="title-block-type-windows">Окно Круглое с Открытием с Крестиком</h2>
            ...
            <div class="tab-content" id="myTabContent-type-3">
               <div class="tab-pane fade show active" id="wds-type-3" role="tabpanel" aria-labelledby="wds-type-3">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/windows-circle-open.edf0a90e.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-windows-type-4">
            <h2 class="title-block-type-windows">Круглое Окно</h2>
            <span class="small-title">Размер 750 х 1350 мм, Цена от <span class="min-price">1965</span> грн до <span class="max-price">5027</span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-4">
               <div class="tab-pane fade show active" id="wds-type-4" role="tabpanel" aria-labelledby="wds-type-4">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/windows-circle-open-2.45a53804.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
               ...
               <div class="tab-pane fade" id="windoffs-type-4" role="tabpanel" aria-labelledby="windoffs-type-4-tab"></div>
               <div class="tab-pane fade" id="viknaland-type-4" role="tabpanel" aria-labelledby="viknaland-type-4-tab"></div>
               <div class="tab-pane fade" id="rehau-type-4" role="tabpanel" aria-labelledby="rehau-type-4-tab"></div>
               <div class="tab-pane fade" id="salamander-type-4" role="tabpanel" aria-labelledby="salamander-type-4-tab"></div>
               <div class="tab-pane fade" id="kbe-type-4" role="tabpanel" aria-labelledby="kbe-type-4-tab"></div>
               <div class="tab-pane fade" id="opentek-type-4" role="tabpanel" aria-labelledby="opentek-type-4-tab"></div>
               <div class="tab-pane fade" id="veka-type-4" role="tabpanel" aria-labelledby="veka-type-4-tab"></div>
               <div class="tab-pane fade" id="aluplast-type-4" role="tabpanel" aria-labelledby="aluplast-type-4-tab"></div>
            </div>
         </div>
         <div class="block-windows-type-5">
            <h2 class="title-block-type-windows">Круглое Окно с Открыванием</h2>
            <span class="small-title">Размер 750 х 1350 мм, Цена от <span class="min-price">1965</span> грн до <span class="max-price">5027</span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-5">
               <div class="tab-pane fade show active" id="wds-type-5" role="tabpanel" aria-labelledby="wds-type-5">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/windows-circle-open-3.cde4d7c6.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
               ...
               <div class="tab-pane fade" id="windoffs-type-5" role="tabpanel" aria-labelledby="windoffs-type-5-tab"></div>
               <div class="tab-pane fade" id="viknaland-type-5" role="tabpanel" aria-labelledby="viknaland-type-5-tab"></div>
               <div class="tab-pane fade" id="rehau-type-5" role="tabpanel" aria-labelledby="rehau-type-5-tab"></div>
               <div class="tab-pane fade" id="salamander-type-5" role="tabpanel" aria-labelledby="salamander-type-5-tab"></div>
               <div class="tab-pane fade" id="kbe-type-5" role="tabpanel" aria-labelledby="kbe-type-5-tab"></div>
               <div class="tab-pane fade" id="opentek-type-5" role="tabpanel" aria-labelledby="opentek-type-5-tab"></div>
               <div class="tab-pane fade" id="veka-type-5" role="tabpanel" aria-labelledby="veka-type-5-tab"></div>
               <div class="tab-pane fade" id="aluplast-type-5" role="tabpanel" aria-labelledby="aluplast-type-5-tab"></div>
            </div>
         </div> -->
         <div class="block-windows-type-6">
            <h2 class="title-block-type-windows">Круглое Окно с Открыванием на Половину</h2>
            <span class="small-title">Размер 600 х 600 мм, Цена от <span class="min-price"><?=$price_obj->krugloye_s_otkrivaniem_napolovinu->min?></span> грн до <span class="max-price"><?=$price_obj->krugloye_s_otkrivaniem_napolovinu->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-6">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->krugloye_s_otkrivaniem_napolovinu as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-6" role="tabpanel" aria-labelledby="<?=$key_w?>-type-6">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/windows-circle-open1-2.8af9d8da.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->krugloye_s_otkrivaniem_napolovinu->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <!-- <div class="block-windows-type-7">
            <h2 class="title-block-type-windows">Круглое Окно с Открыванием на Две Половины</h2>
            <span class="small-title">Размер 750 х 1350 мм, Цена от <span class="min-price">1965</span> грн до <span class="max-price">5027</span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-7">
               <div class="tab-pane fade show active" id="wds-type-7" role="tabpanel" aria-labelledby="wds-type-7">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/windows-circle-open2-2.35b67778.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
               ...
               <div class="tab-pane fade" id="windoffs-type-7" role="tabpanel" aria-labelledby="windoffs-type-7-tab"></div>
               <div class="tab-pane fade" id="viknaland-type-7" role="tabpanel" aria-labelledby="viknaland-type-7-tab"></div>
               <div class="tab-pane fade" id="rehau-type-7" role="tabpanel" aria-labelledby="rehau-type-7-tab"></div>
               <div class="tab-pane fade" id="salamander-type-7" role="tabpanel" aria-labelledby="salamander-type-7-tab"></div>
               <div class="tab-pane fade" id="kbe-type-7" role="tabpanel" aria-labelledby="kbe-type-7-tab"></div>
               <div class="tab-pane fade" id="opentek-type-7" role="tabpanel" aria-labelledby="opentek-type-7-tab"></div>
               <div class="tab-pane fade" id="veka-type-7" role="tabpanel" aria-labelledby="veka-type-7-tab"></div>
               <div class="tab-pane fade" id="aluplast-type-7" role="tabpanel" aria-labelledby="aluplast-type-7-tab"></div>
            </div>
         </div> -->
         <div class="block-windows-type-8">
            <h2 class="title-block-type-windows">Круглое Окно Глухое</h2>
            <span class="small-title">Размер 600 х 600 мм, Цена от <span class="min-price"><?=$price_obj->krugloye_gluhoe->min?></span> грн до <span class="max-price"><?=$price_obj->krugloye_gluhoe->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-8">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->krugloye_gluhoe as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-8" role="tabpanel" aria-labelledby="<?=$key_w?>-type-8">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/windows-circle-close-2.c91c597f.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->krugloye_gluhoe->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
   ...
   <section class="section-buy-this-product">
      <div class="container">
         ...
         <ul class="list-top-product">
                ...
                <li class="block-item-product">
                    <span class="title-header">Защита окон от взлома</span>
                    <a href="<?=get_bloginfo('home')?>/uslugi/zashchita-okon-ot-vzloma/"><img src="<?php bloginfo('template_url') ?>/images/additional-item-4.9455f857.png" class="WDS-logo img-fluid" alt="photo"></a>
                    <p>Защитите надежно свой дом при помощи усиленной фурнитуры и профиля</p>
                </li>
            </ul>
      </div>
   </section>
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Круглые окна в интерьере</h2>
         <p>Круглые окна в доме привлекут внимание и станут «изюминкой» вашего интерьера. Оригинальная форма оконной конструкции может быть дополнена следующими элементами декора:</p>
         <ul>
            <li>· свободно висящие шторы в пол;</li>
            <li>· легкий тюль;</li>
            <li>· шторная композиция с подхватами;</li>
            <li>· австрийские шторы с геометрическими узорами;</li>
            <li>· короткие кружевные занавески.</li>
         </ul>
         <p>Выделить круглую форму евроокна на мансарде можно, воспользовавшись легкой разноцветной шторкой с подхватами на декоративных крючках. Для любителей классического стиля подойдут жалюзи плиссе.</p>
         <h2 class="title-post">Дизайн круглых окон</h2>
         <p>Круглые окна ПВХ могут украшаться ламинацией, витражами или фальш-планками.</p>
         <p>Ламинирование – покрытие рамы специальными пленками. Спросом пользуются окна с имитацией древесины. Пленка придает изделию цвет и фактуру.</p>
         <p>Техника накладывания витража разная, в приоритете рисунки на прозрачном или полупрозрачном стекле. Вставка с витражной росписью устанавливается в стеклопакет посередине, для защиты рисунка от внешних факторов.</p>
         <p>Фальш-планки являются одной из разновидностей декора. Применение фальш-переплета поможет до неузнаваемости изменить облик здания. Профиль накладывается на раму или монтируется внутрь стеклопакета. Фактурное изделие, украшенное витражом, не требует дополнительного текстильного оформления.</p>
         <h2 class="title-post">Особенности</h2>
         <p>Круглые пластиковые окна отличаются высокой функциональностью и светопропускной способностью. Диаметр моделей составляет от 0,72 метра. Евроокна изготавливаются с активными или глухими створками.</p>
         <p>Открывающиеся оконные конструкции имеют горизонтальные и вертикальные створки. Из-за наличия импоста пропуск света снижается. Створки могут открываться полностью или в режиме микро- и проветривания.</p>
         <p>Круглые евроокна также могут быть среднеподвесными. Створки открываются в вертикальном или горизонтальном положении на 180 градусов. Среднеподвесные модели отличаются простым уходом за ними.</p>
         <p>Верхнеподвесные и нижнеподвесные окна характеризуются фрамужным типом. Эти модели открываются внутрь помещения при помощи верхнего или нижнего механизма. Глухие конструкции не открываются, поэтому оснащаются импостом. Данный тип евроокна часто устанавливаются на межкомнатных перегородках для улучшения освещения в комнате.</p>
         <p>Размеры оконных конструкций подбираются с учетом особенностей помещения и осуществленных замеров.</p>
         <h2 class="title-post">Преимущества</h2>
         <p>Круглые окна характеризуются следующими преимуществами:</p>
         <ul>
            <li>· соответствием технических характеристик по ГОСТу;</li>
            <li>· отличной тепло- и шумоизоляцией;</li>
            <li>· безопасностью;</li>
            <li>· противовзломностью.</li>
         </ul>
         <p>Усиленный армированный каркас обеспечивает устойчивость и надежность оконной конструкции.</p>
         <h2 class="title-post">Стоимость</h2>
         <p>Цена круглого окна зависит от ряда факторов:</p>
         <ul>
            <li>· профиля;</li>
            <li>· фурнитуры;</li>
            <li>· стеклопакета;</li>
            <li>· способа декора;</li>
            <li>· дополнительных элементов (отливов, откосов, подоконников).</li>
         </ul>
         <p>Компания “Windows Group” предлагает заказать круглое пластиковое окно в Украине напрямую от производителя. Узнать цены можно на сайте в прайсе или, позвонив по указанному телефону.</p>
      </div>
   </section>
      ...
      <div class="container">
         ...
         <ul class="list-other-type-windows">
            <li class="item-other-type-windows">
               <div class="block-img-other"><img src="<?php bloginfo('template_url') ?>/images/ovalnye-metalloplastikovye-okna.10c91d1c.jpg" class="not-all-img img-fluid" alt="photo"></div>
               <a href="<?=get_bloginfo('home')?>/plastikovye-okna/ovalnye/" class="title-footer">Овальные</a>
            </li>
            <li class="item-other-type-windows">
               <div class="block-img-other"><img src="<?php bloginfo('template_url') ?>/images/hexagon.4ecd1e7b.webp" class="not-all-img img-fluid" alt="photo"></div>
               <a href="<?=get_bloginfo('home')?>/plastikovye-okna/shestiugolnye/" class="title-footer">Шестиугольные</a>
            </li>
            <li class="item-other-type-windows">
               <div class="block-img-other"><img src="<?php bloginfo('template_url') ?>/images/triangle.8b15217a.png" class="not-all-img img-fluid py-3 py-lg-4" alt="photo"></div>
               <a href="<?=get_bloginfo('home')?>/plastikovye-okna/triugolnye/" class="title-footer">Треугольные</a>
            </li>
         </ul>
      </div>
   </section>
