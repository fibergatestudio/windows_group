...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         ...
         <p>Фальш-планки являются одной из разновидностей декора. Применение фальшпереплета поможет до неузнаваемости изменить облик здания. Профиль накладывается на раму или монтируется внутрь стеклопакета. Фактурное изделие, украшенное витражом, не требует дополнительного текстильного оформления.</p>
