...
<div class="main page-windows">
    ...
    <section class="section-calculator">
        <div class="container">
            <div class="top-post-page">
                <h1 class="title-post  mb-lg-3">Пластиковые окна в Ирпене: цена с установкой</h1>
                <p class="text-custom-page">Наша компания предлагает установку <span class="strong-text">пластиковых окон в Ирпене</span>  и других городах Киевской области под ключ. Мы являемся крупнейшим в Украине производителем, а также сотрудничаем с ведущими немецкими, швейцарскими, украинскими брендами, выпускающими качественные, надежные и недорогие ПВХ-конструкции. «Windows Group» не переплачивает посредникам, поэтому мы предлагаем нашим клиентам самые доступные цены на металлопластиковые окна и двери.</p>
            </div>
            <h2 class="title-section">Калькулятор Окон в Ирпене</h2>
    ...
    <section class="section-slider-type-profil">
        ...
        <?php 
            ...
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_v_irpene' ");
    ...
    <section class="section-post section-post-windows post-page-agency">
        <div class="container">
            <h2 class="title-section">Как рассчитать стоимость пластиковых окон с установкой?</h2>
            <p class="mb-2">При расчете стоимости необходимо учитывать цену каждого квадратного метра конструкции, которая зависит от ряда факторов:</p>
            <ul class="list-style-disc">
                <li>размеры и конфигурация оконной системы (глухая, откидная);</li>
                <li>конструкция – если она нестандартная, к примеру, арочная, стоимость металлопластиковых окон будет выше, по сравнению со стандартной прямоугольной;</li>
                <li>сложность демонтажа и установки, с учетом типа дома, расходов монтажной пены, наличия лифта;</li>
                <li>комплектация и дополнительное оснащение профильной системы.</li>
            </ul>
            <p class="mb-2">Подробнее о критериях, влияющих на цену пластиковых окон:</p>
            <ol>
                <li>Тип профиля или качество пластика, из которого выполнено ПВХ-изделие. Профили REHAU стоят дороже бюджетных отечественных аналогов, но их стоимость обусловлена высоким качеством и долговечностью. Чем больше толщина профильной системы и количество камер, уплотнителей, тем сложнее технологии используются при производстве. Соответственно, это повлияет и на стоимость.</li>
                <li>Нестандартный цвет. Цена ламинированного одностороннего или двухстороннего покрытия будет выше, по сравнению с классическим белым пластиковым окном. Чтобы придать необычности интерьеру, мы ламинируем раздвижные оконные системы в любой цвет – коричневый, серый, бежевый, с зеленым оттенком и т. д.</li>
                <li>Количество створок. Дешевле обойдутся оконные рамы, в которых больше глухих створок. Рекомендуется комплектовать пластиковые окна поворотно-откидными конструкциями, чем классическими поворотными. Такие створки более удобны, а их цена не намного выше.</li>
                <li>Стеклопакет. Чем он толще, тем выше стоимость оконного модуля. Двухкамерные оконные стеклопакеты – один из самых распространенных и востребованных вариантов. Также в продаже представлены тонированные и ударопрочные модели – идеальные для квартир на первых этажах. Теплые стеклопакеты с подогревом, энергосберегающие и мультифункциональные варианты позволят предотвратить теплопотери.</li>
                <li>Фурнитура. Чтобы окна прослужили долго, на них не стоит экономить. Уточните у менеджера компании, что входит в базовую комплектацию. Чем прочнее оконные ручки и петли, тем дольше прослужит конструкция. В перечень дополнительных услуг входит установка подоконников, отливов, отделка откосов. </li>
            </ol>
            <p class="mb-2">Цена на пластиковые окна с завода в целом зависит от сложности монтажа. Играют роль особенности дома. Установка ПВХ-конструкций в кирпичных зданиях более сложная, чем в панельных сооружениях, и требует высокой квалификации от специалистов. Чтобы просчитать и узнать, сколько стоит установить окна, свяжитесь с нашим менеджером.</p>
            <p class="mb-2">Замерщик компании приедет на объект, чтобы снять замеры и рассчитать стоимость с учетом:</p>
            <ul class="list-style-disc">
                <li>этажности здания;</li>
                <li>размеров оконных проемов;</li>
                <li>неровности стен;</li>
                <li>запаса под материалы.</li>
            </ul>
            <p class="mb-2">Чтобы рассчитать стоимость окна на заказ под ключ, можно воспользоваться онлайн-калькулятором. Укажите форму и конфигурацию ПВХ-конструкции, размеры и тип открытия, дополнительные комплектующие (москитная сетка, откосы и т. д.). На производство и установку пластиковых окон в Ирпене в среднем требуется 2-3 рабочих дня.</p>

            <h2 class="title-post">Как заменить металлопластиковые окна</h2>
            <p class="mb-2">Если вы планируете купить металлопластиковые окна, мы будем сотрудничать по следующей схеме:</p>
            <ol>
                <li>Заказ услуги. Замена окон в Ирпене начинается с оформления заявки.</li>
                <li>Снятие замеров. Специалист компании приедет на объект в удобную для вас дату и время.</li>
                <li>Расчет стоимости монтажа. Цена рассчитывается индивидуально, в соответствии с особенностями проекта. </li>
                <li>Составление договора с клиентом. После предоплаты мы отправляем запрос на завод, где начинается производство ПВХ конструкций. Мы быстро реагируем на индивидуальные заказы, а на нашем складе есть все необходимое для оперативной установки стеклопакетов.  </li>
                <li>Доставка окон и дверей, монтаж. Дата и время установки обязательно согласовываются с заказчиком.</li>
                <li>Гарантия. 10 лет на металлоконструкции и 5 лет – на работы. При правильном и своевременном уходе ПВХ-изделия прослужат не менее 20 лет.</li>
            </ol>
            <p class="mb-2">Чтобы купить металлопластиковые окна на балкон или в комнаты, оставьте заявку или свяжитесь с менеджером. Мы предлагаем бесплатную помощь в подборе ПВХ-конструкций для дома и офиса.</p>
            <h2 class="title-post">Виды профильных систем на балкон и для комнат</h2>
            <p class="mb-2">Мы предлагаем установку окон ПВХ на балкон следующих типов:</p>
            <ul class="list-style-disc">
                <li>стандартные – классический вариант для лоджий;</li>
                <li>Г-образные – оконный модуль с одной боковой частью;</li>
                <li>П-образные – для таких конструкций характерны две боковые части, окна которых, как правило, глухие;</li>
                <li>полукруглые – если посмотреть сверху, оконный модуль напоминает полукруг;</li>
                <li>панорамное остекление (французский балкон).</li>
            </ul>
            <p class="mb-2">ПВХ-конструкции для комнат разделяются по форме (прямоугольные, арочные, квадратные окна).
                Также оконные модули классифицируются по типу открывания (глухие, Т-образные, фрамужные, трехстворчатые).
                При покупке необходимо учитывать характеристики профиля и страну-изготовителя – Германия, Швейцария, Украина и т. д.
                К примеру, <a href="https://windowsgroup.com.ua/okna/rehau/"> пластиковые окна Рехау</a> от производителя характеризуются теплоизоляцией, высокой пожароустойчивостью,
                защитой от шума и простотой ухода. Для каждого бренда характерны свои особенности.</p>

            <h2 class="title-post">Причины заказать остекление в Ирпене в «Windows Group»</h2>
            <p class="mb-2">Мы занимаемся не только продажей и установкой, но и изготовлением металлопластиковых окон. При производстве строго выдерживаются стандарты качества, благодаря чему обеспечивается долговечность и невосприимчивость ПВХ-конструкций к серьезным внешним нагрузкам. Сотрудничая с нами, можно недорого заменить окна во всей квартире. На нашем складе – большие запасы профилей от Rehau и других производителей.</p>
            <p class="mb-2">Дополнительные услуги:</p>
            <ul class="list-style-disc">
                <li>установка <a href="https://windowsgroup.com.ua/plastikovye-dveri/razdvizhnye/">раздвижных металлопластиковых дверей в Киеве</a>;</li>
                <li>остекление балконов, лоджий, фасадов, коттеджей;</li>
                <li>тонировка окон;</li>
                <li>установка систем защиты от взлома;</li>
                <li>бронирование стеклопакетов;</li>
                <li>установка защиты от детей и т. д.</li>
            </ul>
            <p class="mb-2">Мы предлагаем самые лояльные цены по Киеву и Украине. «Windows Group» не переплачивает посредникам, поэтому с нами можно быстро, а главное, недорого поменять окна и получить гарантию качества. Для постоянных клиентов предусматриваются скидки, а если не хватает средств на оплату, мы предлагаем рассрочку под 0%. У нас можно заказать металлопластиковые окна с любым индивидуальным вариантом декора, который будет соответствовать особенностям интерьера.</p>
