...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
            <h1 class="title-post">Шестиугольные ПВХ (пластиковые) окна в Киеве – цены</h1>
            <p class="text-custom-page">Сложная оконная конструкция, напоминающая шестиугольник, пользуется популярностью в частном и объектном строительстве.
                Наша компания «Windows Group» предлагает купить шестиугольные окна по выгодным ценам в Киеве и Киевской области.
                В каталоге представлены лучшие модели сотовых окон.</p>
         </div>

         <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_shestiugolniye' ");
            $price_obj = json_decode($result_params[0]->data);
         
         ?>
         
         <div class="block-deadlight">
            <h2 class="title-block-type-windows">Шестиугольное Окна Глухое</h2>
            <span class="small-title">Размер 900 х 900 мм, Цена от <span class="min-price"><?=$price_obj->shestiugolnoye_gluhoe->min?></span> грн до <span class="max-price"><?=$price_obj->shestiugolnoye_gluhoe->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->shestiugolnoye_gluhoe as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>" role="tabpanel" aria-labelledby="<?=$key_w?>">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/hexagonal-type-1.c1a76b5d.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->shestiugolnoye_gluhoe->$key_w;
                              $j = 0;
         ...
         <div class="block-open">
            <h2 class="title-block-type-windows">Шестиугольное Окна с Открыванием</h2>
            <span class="small-title">Размер 900 х 900 мм, Цена от <span class="min-price"><?=$price_obj->shestiugolnoye_otkrivaniem->min?></span> грн до <span class="max-price"><?=$price_obj->shestiugolnoye_otkrivaniem->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-open">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->shestiugolnoye_otkrivaniem as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-open" role="tabpanel" aria-labelledby="<?=$key_w?>-open">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/hexagonal-type-2.78279ff1.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->shestiugolnoye_otkrivaniem->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
      ...
      <div class="container">
         ...
         <ul class="list-top-product">
            ...
            <li class="block-item-product">
               ...
               <p>Безопасность ваших детей - дело первоочередной важности</p>
            </li>
         </ul>
      </div>
   </section>
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Особенности шестиугольных окон</h2>
         <p>Нестандартные окна имеют различную конфигурацию. Модели с рабочей створкой оснащаются поворотным или откидным механизмом открывания. Пластиковые изделия с глухой створкой характеризуются небольшими размерами. В основном монтируются под крышей дома для попадания света. У шестиугольных окон ПВХ возможно расположение ручек и петель снизу, сверху или сбоку.</p>
         <p>Выбирая шестиугольные модели окон, необходимо помнить о профильной системе. Профиль должен быть устойчивым к температурным перепадам и сильным ветровым нагрузкам. Дополнительно обеспечивать шумо- и теплоизоляцию.</p>
         <p>Оптимальный выбор – профиль ПВХ на металлическом каркасе. Благодаря армированию профильная система устойчива к неблагоприятным внешним воздействиям. Чем больше камер в профиле, тем выше технические характеристики оконной конструкции.</p>
         <p>Вторым условием надежности евроокна является фурнитура. Необычная форма изделия предполагает высокую нагрузку на фурнитуру. В особенности, если окно разделяется на несколько функциональных частей. Соединительные элементы должны обеспечивать надежное открывание и закрывание конструкции.</p>
         <h2 class="title-post">Преимущества</h2>
         <p>Сотовые оконные конструкции характеризуются рядом преимуществ:</p>
         <ul>
            <li>· стойкостью к изменениям температуры;</li>
            <li>· сохранением первоначальной формы;</li>
            <li>· устойчивостью к динамическим и статическим нагрузкам;</li>
            <li>· высокой тепло- и звукозащитой.</li>
         </ul>
         <p>Этот тип евроокон полностью соответствуют требованиям традиционных оконных конструкций.</p>
         <h2 class="title-post">Кому подойдут и где лучше использовать</h2>
         <p>Применение шестиугольных евроокон разнообразное. Сотовые евроокна помогут украсить фасад любого здания, сделав его неповторимым и роскошным. С помощью изменения положения внутренних реек можно добиться невероятных дизайнерских вариантов.</p>
         <p>Сотовые оконные конструкции устанавливаются на чердаках, мансардных этажах в домах загородного типа.</p>
         <p>Данные модели часто используются в качестве декоративного архитектурного элемента, для обеспечения естественного освещения помещения. Шестиугольные конструкции также применяются в старых архитектурных зданиях, представляющих историко-культурную ценность.</p>
         <h2 class="title-post">Стоимость</h2>
         <p>Цена шестиугольных окон зависит от нескольких особенностей:</p>
         <ul>
            <li>· вертикального или горизонтального расположения;</li>
            <li>· правильной или вытянутой формы;</li>
            <li>· способа открывания створок;</li>
            <li>· наличия разделителей.</li>
         </ul>
         <p>Наша компания «Виндовс Груп» предлагает заказать шестиугольные пластиковые окна в Киеве по выгодным ценам от производителя. Мы гарантируем широкий выбор товара, гарантию качества и лучшее обслуживание.</p>
      </div>
   </section>
      ...
      <div class="container">
         ...
         <ul class="list-other-type-windows">
            <li class="item-other-type-windows">
               <div class="block-img-other p-0"><img src="<?php bloginfo('template_url') ?>/images/triangle.8b15217a.png" class="p-4 p-lg-5 img-fluid" alt="photo"></div>
