...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
            <h1 class="title-post">Офисные двери в Киеве</h1>
            <p class="text-custom-page">Наша компания “Windows Group” предлагает купить офисные двери на заказ в Киеве и области по лучшим ценам от производителя.
                На сайте в каталоге представлены различные модели готовых межкомнатных дверных изделий.</p>
         </div>

        <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'dvery_v_ofis' ");
            $price_obj = json_decode($result_params[0]->data);
         
        ?>
         
         <div class="block-windows-type-1">
            <h2 class="title-block-type-windows">Штульповые металлопластиковые двери</h2>
            <span class="small-title">Размер 1400 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->v_ofis_1->min?></span> грн до <span class="max-price"><?=$price_obj->v_ofis_1->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-open">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->v_ofis_1 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-open" role="tabpanel" aria-labelledby="<?=$key_w?>-open">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/1-shtulpovyye-metalloplastikovyye-dveri.4f30b85a.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->v_ofis_1->$key_w;
                              $j = 0;
         ...
         <div class="block-windows-type-2">
            <h2 class="title-block-type-windows">Двухстворчатые металлопластиковые двери с сэндвич панелью</h2>
            <span class="small-title">Размер 1800 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->v_ofis_2->min?></span> грн до <span class="max-price"><?=$price_obj->v_ofis_2->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->v_ofis_2 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>" role="tabpanel" aria-labelledby="<?=$key_w?>">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/2-dvustvorchatyye-metalloplastikovyye-dveri-s-sendvich-panelyu.00463b56.png" class="vertical-doors-2 img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->v_ofis_2->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-3">
            ...
            <span class="small-title">Размер 2700 х 2100 мм, Цена от <span class="min-price"><?=$price_obj->v_ofis_3->min?></span> грн до <span class="max-price"><?=$price_obj->v_ofis_3->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-3">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->v_ofis_3 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-3" role="tabpanel" aria-labelledby="<?=$key_w?>-type-3">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/3-dvustvorchatyye-panoramnyye-metalloplastikovyye-dveri-s-dvumya-steklyannymi-oknami-po-bokam.9460dbba.png" class="img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->v_ofis_3->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-4">
            <h2 class="title-block-type-windows">Одностворчастая металлопластиковая панорамная дверь с перемычкой в офис</h2>
            <span class="small-title">Размер 800 х 2000 мм, Цена от <span class="min-price"><?=$price_obj->v_ofis_4->min?></span> грн до <span class="max-price"><?=$price_obj->v_ofis_4->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-4">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->v_ofis_4 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-4" role="tabpanel" aria-labelledby="<?=$key_w?>-type-4">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/4-odnostvorchataya-metalloplastikovaya-dver-s-peremychkoy-v-ofis.a7399f2e.png" class="vertical-doors img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->v_ofis_4->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-5">
            <h2 class="title-block-type-windows">Одностворчастая металлопластиковая дверь с сэндвич панелью для офиса</h2>
            <span class="small-title">Размер 800 х 2000 мм, Цена от <span class="min-price"><?=$price_obj->v_ofis_5->min?></span> грн до <span class="max-price"><?=$price_obj->v_ofis_5->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-5">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->v_ofis_5 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-5" role="tabpanel" aria-labelledby="<?=$key_w?>-type-5">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/5-odnostvorchataya-metalloplastikovaya-dver-s-sendvich-panelyu-dlya-ofisa.cd360f3c.png" class="vertical-doors img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->v_ofis_5->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-6">
            <h2 class="title-block-type-windows">Одностворчастая металлопластиковая дверь с фрамугой в офис</h2>
            <span class="small-title">Размер 800 х 2700 мм, Цена от <span class="min-price"><?=$price_obj->v_ofis_6->min?></span> грн до <span class="max-price"><?=$price_obj->v_ofis_6->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-6">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->v_ofis_6 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-6" role="tabpanel" aria-labelledby="<?=$key_w?>-type-6">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/6-odnostvorchataya-metalloplastikovaya-dver-s-framugoy-v-ofis.110a17fe.png" class="vertical-doors img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->v_ofis_6->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
         ...
         <div class="block-windows-type-7">
            <h2 class="title-block-type-windows">Одностворчастая металлопластиковая дверь с фрамугой и сэндвич панелью для офиса</h2>
            <span class="small-title">Размер 800 х 2700 мм, Цена от <span class="min-price"><?=$price_obj->v_ofis_7->min?></span> грн до <span class="max-price"><?=$price_obj->v_ofis_7->max?></span> грн</span>
            ...
            <div class="tab-content" id="myTabContent-type-7">
               ...
               <?php 
               $k = 0;
               foreach ($price_obj->v_ofis_7 as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>

               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-type-7" role="tabpanel" aria-labelledby="<?=$key_w?>-type-7">
                  <div class="table-tab">
                     <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/7-odnostvorchataya-metalloplastikovaya-dver-s-framugoy-i-sendvich-panelyu-dlya-ofisa.d25aa543.png" class="vertical-doors img-type-windows img-fluid" alt="photo"></div>
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
                        ...
                        <tbody>
                           ...
                           <tr>
                              <?php
                              $this_obj = $price_obj->v_ofis_7->$key_w;
                              $j = 0;
                              foreach ($this_obj as $value) {
                                 $j++;
                              }                             
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Преимущества и недостатки офисных дверей</h2>
         <p>Перед приобретением офисных пластиковых дверей, следует учесть их достоинства и недостатки.</p>
         <p>К преимуществам дверной конструкции относятся:</p>
         <ul>
            ...
            <li>· возможность применения противовзломной фурнитуры и различных типов остекления;</li>
            <li>· простота ухода.</li>
         </ul>
         <p>Межкомнатные двери для офиса имеют недостаток в виде низкой герметичности изделия из-за некачественного монтажа. Наши специалисты готовы выехать на объект по предварительной заявке и грамотно произвести монтаж.</p>
         <h2 class="title-post">Особенности</h2>
         <p>Двери для офисных помещений классифицируются по типу заполнения, форме, особенностям конструкции, способу декорирования.</p>
         <p>Надежную шумоизоляцию обеспечивают глухие дверные модели. Полотна заполняются контурным резиновым уплотнителем, не имеют стеклянных вставок. Также спросом пользуются конструкции с частичным или цельным остеклением.</p>
         <p>По форме популярны классические прямоугольные белые офисные двери. Дополнительно на рынке представлены полукруглые, арочные, одностворчатые и двустворчатые модели. Выбор формы зависит от размера проема и особенностей комнат.</p>
         <p>По конструктивным особенностям популярностью пользуются распашные офисные двери. Данные модели отличаются надежностью, удобством эксплуатации. Кассетные, роликовые и двери-купе характеризуются значительной экономией свободной площади в помещении.</p>
         <p>Цвет и текстура изделия определяются в процессе изготовления конструкции. Для декора дверных конструкций может использоваться краска. Благодаря применению технологии ламинации модели могут имитироваться под различный природный материал. Одним из распространенных типов являются офисные межкомнатные двери под дерево. Данный вид отделки не ограничен по расцветке.</p>
         <p>После монтажа изменить цветовые характеристики и рисунок не удастся. Поэтому перед заказом следует выбрать цвет и фактуру будущего изделия.</p>
         <h2 class="title-post">Кому подойдут</h2>
         <p>Для установки распашных дверных конструкций требуется свободная площадь. В офисах с небольшим пространством используются раздвижные входные офисные двери. Это дверные модели типа купе, кассетного или роликового вида. Сэкономят пространство в офисе складные дверные модели. Данный тип применяется в нестандартных комнатах: гардеробная, коридор, столовая.</p>
         <h2 class="title-post">Как выбрать профиль</h2>
         <p>При покупке дверей для офиса важно обращать внимание не только на внешний вид, но и на используемый профиль.</p>
         <p>При выборе профиля необходимо учитывать следующее:</p>
         <ol>
            <li>Не стоит покупать изделия, изготовленные из дешевого пластикового профиля. Некачественный пластик представляет опасность здоровью. Знак качества товара подтверждается сертификатом.</li>
            <li>Тип ПВХ-профиля и количество воздушных камер. От данных показателей зависит уровень звукоизоляции дверной конструкции. Трех- или четырехкамерный профиль подходит для качественной шумоизоляции.</li>
            <li>Проверить функциональность фурнитуры. Необходимо оценить все элементы: дверные петли, доводчики, ручки, замки.</li>
         </ol>
         <p>Приобретение низкокачественных моделей может доставить различные проблемы при использовании. Отличное решение – приобрести изделия на армированном металлическом каркасе. Благодаря армированию конструкция становится жестче и прочнее.</p>
         <h2 class="title-post">Цены на офисные окна</h2>
         <p>Итоговая цена офисных дверей складывается с учетом факторов:</p>
         <ul>
            <li>· тип материала;</li>
            <li>· разновидность конструкции;</li>
            <li>· тип остекления.</li>
            <li>· фурнитуры;</li>
            <li>· способа декорирования;</li>
            <li>· услуг доставки и установки.</li>
         </ul>
         <p>Узнать ориентировочную стоимость ПВХ изделий в Украине можно на сайте нашей копмании «Виндовс Груп» или позвонить по телефону.</p>
      </div>
   </section>
