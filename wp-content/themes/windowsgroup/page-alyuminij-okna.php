<?php
/* Template Name: PageAlyuminijOkna */
get_header();
?>

<div class="main page-aluminum-product">
   <section class="section-welcome-page bg-aluminum-windows">
      <div class="container">
   ...
   <section class="section-top-page">
      <div class="container">
         ...
         <h2 class="title-section">Алюминиевые окна в Киеве</h2>
         <div class="block-img-flout clearfix">
            <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/alyuminievye-okna.04000dca.jpg" class="img-fluid" alt="photo-product"></div>
             <p>
                 Алюминий используется в различных отраслях промышленности и в строительстве. Окна из этого материала известны своими уникальными свойствами и соответствуют высоким требованиям, предъявляемым к современным конструкциям. Наша компания WindowsGroup предлагает купить алюминиевые окна в Киеве и области по лучшей цене от производителя.
             </p>
         </div>
         <ul class="list-type-standart-lux">
            <li class="item">
               <span class="item-header">Standard</span>
               <div class="img-block"><img src="<?php bloginfo('template_url') ?>/images/standart-profil.54c83c1f.jpg" class="img-standart img-fluid" alt="photo-product"></div>
               <span class="item-price-custom"><span>от <span class="sum">2500 </span>грн / м2</span></span>
               <ul class="info">
                  <li>Профиль рамы <span class="strong-text">57 мм.</span></li>
                  <li>Стеклопакет <span class="strong-text">32 мм.</span></li>
                  <li>Сопротивление теплопередачи <span class="strong-text">0.61 м2 С/Вт.</span></li>
                  <li><span class="strong-text">2-я</span> температурная зона.</li>
                  <li>Звукоизоляция <span class="strong-text">до 33 дБ.</span></li>
                  <li>Фурнитура: <span class="strong-text">Турция, Италия.</span></li>
                  <li>Гарантия <span class="strong-text">1 год.</span></li>
               </ul>
               <button class="btn btn-custom-project">Заказать</button>
            </li>
            <li class="item">
               <span class="item-header">Premium</span>
               <div class="img-block"><img src="<?php bloginfo('template_url') ?>/images/premium-profil.1c80d663.png" class="img-fluid" alt="photo-product"></div>
               <span class="item-price-custom"><span>от <span class="sum">3900 </span>грн / м2</span></span>
               <ul class="info">
                  <li>Профиль рамы <span class="strong-text">62 мм.</span></li>
                  <li>Стеклопакет <span class="strong-text">44 мм.</span></li>
                  <li>Сопротивление теплопередачи <span class="strong-text">0.8 м2 С/Вт.</span></li>
                  <li><span class="strong-text">2-я</span> температурная зона.</li>
                  <li>Звукоизоляция <span class="strong-text">до 43 дБ.</span></li>
                  <li>Фурнитура: <span class="strong-text">Греция, Беларусь.</span></li>
                  <li>Гарантия <span class="strong-text">5 год.</span></li>
               </ul>
               <button class="btn btn-custom-project">Заказать</button>
            </li>
            <li class="item">
               <span class="item-header">Lux</span>
               <div class="img-block"><img src="<?php bloginfo('template_url') ?>/images/lux-profil.ba1230cb.jpg" class="img-fluid" alt="photo-product"></div>
               <span class="item-price-custom"><span>от <span class="sum">4500 </span>грн / м2</span></span>
               <ul class="info">
                  <li>Профиль рамы <span class="strong-text">00 мм.</span></li>
                  <li>Стеклопакет <span class="strong-text">00 мм.</span></li>
                  <li>Сопротивление теплопередачи <span class="strong-text">0.0 м2 С/Вт.</span></li>
                  <li><span class="strong-text">2-я </span>температурная зона.</li>
                  <li>Звукоизоляция <span class="strong-text">до 00 дБ.</span></li>
                  <li>Фурнитура:<span class="strong-text"> Греция, Беларусь.</span></li>
                  <li>Гарантия <span class="strong-text">0 год.</span></li>
               </ul>
               <button class="btn btn-custom-project">Заказать</button>
            </li>
         </ul>
   ...
   <section class="section-preference">
      <div class="container">
         <h2 class="title-section">Преимущества Окон из Алюминия</h2>
         <ul class="list-preference">
            <li>
               <div class="block">
                  <i class="icon icon-block icon-form-pre"></i> <span class="title">Вариативность форм и размеров</span>
                  <p>Алюминиевый профиль пластичен, что позволяет реализовать различные конструкции, соответствующие архитектурным и/или дизайнерским решениям)</p>
               </div>
            </li>
            <li class="li-preference-small">
               <div class="block">
                  <i class="icon icon-block icon-painting"></i> <span class="title">Возможность покраски в любой цвет</span>
                  <p>Большой ассортимент цветов и привлекательная внешность, а также возможность придать стильный декоративный эффект</p>
               </div>
            </li>
            <li class="li-preference-small">
               <div class="block">
                  <i class="icon icon-block icon-strength"></i> <span class="title">Повышенная прочность</span>
                  <p>Степень прочности алюминия во много раз выше, чем у ПВХ материалов и он в 23 раза более жесткий</p>
               </div>
            </li>
            <li class="li-preference-small">
               <div class="block">
                  <i class="icon icon-block icon-plant"></i> <span class="title">Экологичность</span>
                  <p>В составе металла нет вредных компонентов и примесей, алюминий безопасен для здоровья в любых условиях эксплуатации</p>
               </div>
            </li>
            <li class="li-preference-small">
               <div class="block">
                  <i class="icon icon-block icon-security"></i> <span class="title">Безопасность</span>
                  <p>Высокие показатели прочности и пожаробезопасности для защиты от проникновения в помещение и от огня</p>
               </div>
            </li>
            <li>
               <div class="block">
                  <i class="icon icon-block icon-feather"></i> <span class="title">Легкость</span>
                  <p>Профиль из алюминия легче чем изделия из армированного ПВХ. Это обуславливает невысокие нагрузки на несущие стеновые конструкции</p>
               </div>
            </li>
            <li class="li-preference-small">
               <div class="block">
                  <i class="icon icon-block icon-outline"></i> <span class="title">Простота в обслуживании</span>
                  <p>Окна из алюминия не требуют ухода. Благодаря низкому электростатическому напряжению на поверхности металла не скапливаются частицы грязи и пыли</p>
               </div>
            </li>
            <li>
               <div class="block">
                  <i class="icon icon-block icon-pre-window"></i> <span class="title">Устойчивость материала</span>
                  <p>Алюминий устойчив к большим температурам, агрессивным химическим веществам, осадкам</p>
               </div>
            </li>
         </ul>
      </div>
   ...
   <section class="section-text">
      <div class="container">
         <h2 class="title-section">Характеристики изделия</h2>
          <p>Алюминиевые окна купить в нашей компании следует за ряд важных технических характеристик:</p>
          <ol class="list-decor-circle">
              <li>Огнестойкость. Материал не горит, а температура его плавления составляет 660°C, что примерно в 5 раз больше, чем у пластика.</li>
              <li>Жесткость. Благодаря данному параметру обеспечивается стабильность форм при сборке оконной конструкции.</li>
              <li>Теплоизоляция. Створки плотно стыкуются и препятствуют проникновению холода.</li>
              <li>Способность принимать плавные формы. Радиус изгиба позволяет создать модели различных геометрических форм по индивидуальному заказу.</li>
          </ol>
      </div>
   </section>
   <section class="section-type-alum-profile section-profile-type">
      <div class="container">
         <h2 class="title-section">Характеристики Алюминиевого Профиля</h2>
         <ul class="list-type-alum">
            <li class="item-type-alum-profile">
               <div class="header color-gradient-blue">Холодный алюминиевый профиль</div>
               <div class="img-block"><img src="<?php bloginfo('template_url') ?>/images/cold-profil.016f441b.png" class="img-fluid" alt="photo-product"></div>
                  ...
                  <li class="profile-type-item">
                     <ul class="profile-type-preferences">
                        <li>
                           <h6>Теплоизоляция</h6>
                           <div class="progress">
                              <div class="progress-bar" role="progressbar" style="width: 30%;" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"><span>30%</span></div>
                           </div>
                        </li>
                        <li>
                           <h6>Шумоизоляция</h6>
            ...
            <li class="item-type-alum-profile">
               <div class="header color-gradient-red">Теплый алюминиевый профиль</div>
               <div class="img-block"><img src="<?php bloginfo('template_url') ?>/images/hot-profil.7af27cb0.jpg" class="img-fluid" alt="photo-product"></div>
               <ul class="profile-type-list">
                  <li class="profile-type-item">
                     <ul class="profile-type-preferences">
                        <li>
   ...
   <section class="section-color-selection">
      <div class="container">
         <h2 class="title-section">Покраска в Любой Цвет</h2>
         <div class="block-prev-color-selection clearfix">
            <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/img-color-selection.433feb67.png" class="img-fluid" alt="photo-product"></div>
             <p class="text-float">Чтобы ваш алюминиевый профиль идеально вписывался в дизайн помещения, достаточно его покрасить, что превратит его в главный элемент вашего интерьера. Покраска решит не только эстетические задачи, но и ряд технических увеличив срок службы профиля:</p>
             <ul class="text-float list-decor-circle">
                 <li>Устойчивость к царапинам;</li>
                 <li>Ударопрочность, влагостойкость и светостойкость;</li>
                 <li>Выбор широкой гаммы цветов;</li>
         ...
         <div class="block-color-selection">
            ...
            <div class="block-colors">
               <div class="block-yellow-colors">
                  <h2 class="title-block">Желтые тона</h2>
               ...
               <div class="block-orange-colors">
                  <h2 class="title-block">Оранжевые тона</h2>
               ...
               <div class="block-red-colors">
                  <h2 class="title-block">Красные тона</h2>
               ...
               <div class="block-purple-colors">
                  <h2 class="title-block">Фиолетовые тона</h2>
               ...
               <div class="block-blue-colors">
                  <h2 class="title-block">Синие тона</h2>
               ...
               <div class="block-green-colors">
                  <h2 class="title-block">Зеленые тона</h2>
               ...
               <div class="block-gray-colors">
                  <h2 class="title-block">Серые тона</h2>
               ...
               <div class="block-brown-colors">
                  <h2 class="title-block">Коричневые тона</h2>
               ...
               <div class="block-black-colors">
                  <h2 class="title-block">Черные и белые тона</h2>
   ...
   <section class="section-scheme-works">
      <div class="container">
         ...
         <ul class="list-scheme-works aluminum-windows d-md-none">
            <li class="">
            ...
            <li class="">
               ...
               <p>Договоримся на удобное для вас время и дату для замера</p>
            </li>
            <li class="">
               ...
               <p>Перед началом выполнения заказа мы подробно смоделируем и визуализируем ваше изделие с учётом всех ваших пожеланий</p>
            </li>
            <li class="">
               <div class="block-scheme-works"><i class="icon-scheme-works icon-contract"></i> <span class="number-scheme-works">4</span></div>
               <span class="title">Просчёт и Заключение Договора</span>
               <p>Наш специалист просчитает стоимость заказа и мы заключим с вами договор</p>
            </li>
            <li class="">
               ...
               <p>В среднем изготовление конструкций из алюминия занимает 5-7 рабочих дней</p>
            </li>
            <li class="">
               ...
               <p>Заранее сообщим вам о готовности изделия и договоримся о монтаже на удобную для вас дату и время</p>
            </li>
            <li class="">
               <div class="block-scheme-works"><i class="icon-scheme-works assurance"></i> <span class="number-scheme-works">7</span></div>
               <span class="title">Гарантия</span>
               <p>Дадим гарантию на каждое изделие до 30 лет</p>
            </li>
         </ul>
         <ul class="list-scheme-works-lg aluminum-windows d-none d-md-flex">
            <li class="">
               <span class="title">Заявка</span>
               <p class="mx-lg-5">Позвоните нам или оставьте заявку на сайте</p>
               <div class="block-scheme-works"><i class="icon-scheme-works request"></i> <span class="number-scheme-works">1</span></div>
            </li>
            <li class="">
               <span class="title">Моделирование и Визуализация</span>
               <p class="px-lg-0">Перед началом выполнения заказа мы подробно смоделируем и визуализируем ваше изделие с учётом всех ваших пожеланий</p>
               <div class="block-scheme-works"><i class="icon-scheme-works icon-monitor"></i> <span class="number-scheme-works">3</span></div>
            </li>
            <li class="">
               <span class="title">Выполнение Заказа</span>
               <p class="mx-lg-4">В среднем изготовление конструкций из алюминия занимает 5-7 рабочих дней</p>
               <div class="block-scheme-works"><i class="icon-scheme-works performance"></i> <span class="number-scheme-works">5</span></div>
            </li>
            <li class="">
               <span class="title">Гарантия</span>
               <p class="mx-lg-5">Дадим гарантию на каждое изделие до 30 лет</p>
               <div class="block-scheme-works"><i class="icon-scheme-works assurance"></i> <span class="number-scheme-works">7</span></div>
            </li>
            <li class="">
               <div class="block-scheme-works"><i class="icon-scheme-works sample"></i> <span class="number-scheme-works">2</span></div>
               <span class="title mt-3">Замер</span>
               <p class="mx-lg-2">Договоримся на удобное для вас время и дату для замера</p>
            </li>
            <li class="">
               <div class="block-scheme-works"><i class="icon-scheme-works icon-contract"></i> <span class="number-scheme-works">4</span></div>
               <span class="title mt-3">Просчёт и Заключение Договора</span>
               <p>Наш специалист просчитает стоимость заказа и мы заключим с вами договор</p>
            </li>
            <li class="">
               <div class="block-scheme-works"><i class="icon-scheme-works delivery"></i> <span class="number-scheme-works">6</span></div>
   ...
   <section class="block-portfolio">
      <div class="container">
         ...
         <ul class="slider-portfolio-present">
            <li>
               <a href="#" class="block-img"><img src="<?php bloginfo('template_url') ?>/images/alyuminij-okna-dveri-project-1.jpg" class="img-fluid" alt="photo-product1"></a>
               <div class="footer-item-catalog">
                  <div class="price"><span class="text">Стоимость от</span> <span>99 000</span> <span class="text">грн</span></div>
               </div>
               <a href="#" class="block-hover"><span class="hover-more"><span>Подробнее</span></span></a>
            </li>
            <li>
               <a href="#" class="block-img"><img src="<?php bloginfo('template_url') ?>/images/alyuminij-okna-dveri-project-2.jpg" class="img-fluid" alt="photo-product1"></a>
               <div class="footer-item-catalog">
            ...
            <li>
               <a href="#" class="block-img"><img src="<?php bloginfo('template_url') ?>/images/alyuminij-okna-dveri-project-3.jpg" class="img-fluid" alt="photo-product1"></a>
               <div class="footer-item-catalog">
                  <div class="price"><span class="text">Стоимость от</span> <span>44 200</span> <span class="text">грн</span></div>
               </div>
               <a href="#" class="block-hover"><span class="hover-more"><span>Подробнее</span></span></a>
            </li>
            <li>
               <a href="#" class="block-img"><img src="<?php bloginfo('template_url') ?>/images/alyuminij-okna-dveri-project-4.png" class="img-fluid" alt="photo-product1"></a>
               <div class="footer-item-catalog">
                  <div class="price"><span class="text">Стоимость от</span> <span>35 900</span> <span class="text">грн</span></div>
               </div>
               <a href="#" class="block-hover"><span class="hover-more"><span>Подробнее</span></span></a>
            </li>
         </ul>
    ...
    <section class="section-post section-post-windows section-other-type-windows">
        <div class="container">
            <h2 class="title-section">Преимущества алюминиевых окон</h2>
            <div class="text-custom-page">
                <p>
                    Главным достоинством алюминия является его легкость и долговечность. В результате оконные рамы минимально подвергаются механическим повреждениям.
                </p>
                <p>Алюминиевые окна – это комплекс эксплуатационных преимуществ:</p>
                <ol>
                    <li>Пластичность позволяет формировать изделия различных нестандартных размеров.</li>
                    <li>Рамы надежно защищены от коррозии анодированием или порошковым покрытием.</li>
                    <li>Являются хорошим утеплителем, потому что в их конструкции используются современные теплоизоляционные материалы.</li>
                    <li>Не требуют специального ухода и обслуживания. Отличаются длительным сроком службы.</li>
                    <li>Алюминиевые модели не зарастает плесенью, устойчивы к влаге, снегу и яркому солнечному свету.</li>
                    <li>Доступны в широкой цветовой гамме.</li>
                </ol>

                <h2 class="title-post">Виды алюминиевых окон</h2>
                <p>
                    Алюминиевые оконные профили делятся на две группы: теплые и холодные. Холодные профили имеют минимальную теплоизоляцию и могут использоваться на коммерческих или общественных объектах. Часто их заказывают для остекления балконов и лоджий, где основная задача – не пропустить поток холодного воздуха.
                </p>
                <p>
                    Теплые профили используются для применения в жилых зданиях. Эти конструкции являются более сложными, но характеризуются гораздо лучшей изоляцией, чем холодные профили. Теплые профили состоят из двух алюминиевых секций, которые соединены между собой термической вставкой.
                </p>
                <p>
                    Алюминиевые окна в Киеве часто необходимы для крупногабаритного и тяжелого остекления. Наша компания гарантирует прочности конструкций, установленных опытными специалистами.
                </p>
                <h2 class="title-post">Окрашивание алюминиевых окон</h2>
                <p>Как покрасить алюминий?</p>
                <p>Существует простая пошаговая инструкция:</p>
                <p>Этап 1. Предварительно необходимо оценить состояние профиля и объем работ.</p>
                <p>Этап 2. Если покрытие в плохом состоянии, предыдущий лакокрасочный слой требует удаления.
                    Можно использовать наждачную бумагу или угловую шлифовальную машину.
                    Если покрытие в порядке, достаточно протереть пыль, а затем помыть профиль водой и мягким моющим средством.</p>
                <p>Этап 3. Перед покраской лучше провести тестирование на небольшой поверхности, которую не слишком заметно.
                    Если появились какие-либо нежелательные эффекты, лучше полностью удалить предыдущее покрытие.</p>
                <p>Этап 4. Покраску производить на основе рекомендаций производителя.</p>

                <p>В результате получится совершенно новая на вид рама.</p>
                <h2 class="title-post"> Где устанавливают конструкции</h2>
                <p> Широкие потребительские запросы позволяют использовать окна из алюминия в различных сферах строительства:</p>
                <ol>
                    <li>Балконное остекление. Повышает уровень энергоэффективности помещения.
                        К тому же алюминиевые окна по цене несущественно отличаются от пластиковых.</li>
                    <li>Остекление веранд и террас. Легкими конструкциями оборудуют открытые площадки кафе и торговых точек.</li>
                    <li>Возведение межкомнатных перегородок в административных зданиях.</li>
                    <li>Фасадное остекление. Современная архитектура ориентирована на закрытие фасадов стеклопакетами.</li>
                    <li>Ленточное остекление. С его помощью выделяют отдельные зоны фасада или целые этажи.</li>
                    <li>Панорамные алюминиевые окна предназначены для конструкций со значительными размерами световых проемов.</li>
                </ol>
                <h2 class="title-post">Изготовление и монтаж</h2>
                <p>Как происходит изготовление товара:</p>
                <ol>
                    <li>Производится замер будущей конструкции.</li>
                    <li>Составляется проект и карты раскроя.</li>
                    <li>В производственном цеху начинается процесс изготовления.</li>
                    <li>Раскрой профилей требует работы квалифицированного мастера на специализированном станке.</li>
                    <li>Обязательно проводится сверление и фрезеровка профилей, с последующей продувкой.</li>
                    <li>Все элементы соединяются друг с другом, заканчивающаяся установкой фурнитуры.</li>
                    <li> В последнюю очередь устанавливаются стеклопакеты.</li>
                </ol>
                <h2 class="title-post">Советы по уходу</h2>
                <p>
                    Окна из алюминиевого профиля не требуют особого обслуживания. Время от времени достаточно протирать окна моющим средством и водой. Чаще всего производитель рекомендует чистящие средства, которые будут наиболее подходящими для больших загрязнений. Нельзя использовать кислоту или уксус для очистки алюминиевых окон.
                </p>
                <p>
                    Наша компания Виндовс Груп предлагает широкий выбор окон из алюминиевого профиля по выгодным ценам. Узнать стоимость можно на сайте или позвонив по телефону.
                </p>
            </div>
        </div>
    </section>
   <section class="section-other-section windows">
      <div class="container">
         <h2 class="title-section">Другие Изделия из Алюминия</h2>
         <ul class="list">
            <li>
               <a href="<?=get_bloginfo('home')?>/alyuminij/dveri/">
                  <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/alyuminievye-dveri.91979347.jpg" class="img-door img-fluid" alt="product"></div>
                  <span class="block-title">Алюминиевые<br/>двери</span>
               </a>
            </li>
            <li>
               <a href="<?=get_bloginfo('home')?>/alyuminij/fasady/">
                  <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/alyuminievye-fasady.74465f08.jpg" class="img-fluid" alt="product"></div>
                  <span class="block-title">Алюминиевые<br/>фасады</span>
               </a>
            </li>
            <li>
               <a href="<?=get_bloginfo('home')?>/alyuminij/peregorodki/">
                  <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/alyuminievye-peregorodki.ab4682aa.jpg" class="img-fluid" alt="product"></div>
                  <span class="block-title">Алюминиевые<br/>перегородки</span>
               </a>
            </li>
            <li>
               <a href="<?=get_bloginfo('home')?>/alyuminij/zimnie-sady/">
                  <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/zimnie-sady.83154f2f.jpg" class="img-fluid" alt="product"></div>
                  <span class="block-title">Зимние<br/>сады</span>
               </a>
            </li>
         </ul>
      </div>
