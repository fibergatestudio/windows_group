...
<div class="main page-windows">
    ...
    <section class="section-table-price">
        <div class="container">
            <div class="top-post-page">
                <h1 class="title-post">ПВХ (пластиковые) окна в Киеве – цены</h1>
                <p class="text-custom-page">На современном рынке представлен широкий выбор оконных производителей. Однако не всегда стоимость соответствует качеству. Мы предлагаем отличное предложение - купить пластиковые окна в Windows Group по выгодной цене в Киеве и области.</p>
                <p class="text-custom-page">В нашем ассортименте представлены различные конструкции от ведущих брендов. Окна изготовлены по современным европейским стандартам с постоянным контролем качества. Мы предлагаем приобрести металлопластиковые оконные конструкции от производителя по доступным ценам. Сертифицированное качество и лучшее обслуживание клиента гарантировано.</p>
            </div>
            
        <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'plastikoviye_okna' ");
    ...
    <section class="section-group-button">
        <div class="container">
            <ul class="list-button">
                <li><button class="btn btn-call-measurer icon icon-measuring-tape">Вызвать замерщика</button></li>
                <li><button class="btn btn-call-me icon icon-mobile-phone">Перезвоните мне</button></li>
                <li><button class="btn btn-get-discount icon icon-percentage-discount">Получить скидку</button></li>
            </ul>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <ul class="list-top-product">
                <li class="block-item-product">
                    <h6 class="title-header">Подоконники</h6>
                ...
                <li class="block-item-product">
                    <h6 class="title-header">Москитные сетки</h6>
                ...
                <li class="block-item-product">
                    <h6 class="title-header">Защита окон от взлома</h6>
        ...
        <div class="container d-md-flex">
            <div class="block-form-page-windows">
                ...
                <form class="form-page-windows free-measurement-form">
                    ...
                    <input type="hidden" name="your-message" value="БЕСПЛАТНЫЙ ЗАМЕР">
    ...
    <section class="section-post section-post-windows">
        <div class="container">
            <span class="title-section">Особенности Конструкции Наших Окон</span>
            <p class="mb-1">Конструкция <span class="strong-text">металлопластиковых окон</span> обладает абсолютными достоинствами в отличие от других материалов. Сложно найти аналоги, которые могли бы сравниться с металлической профильной системой. Чтобы понять конструкцию, необходимо рассмотреть ее детально.</p>
            <p class="mb-1">Оконный блок состоит из элементов:</p>
            <ul>
                <li>· стеклопакета;</li>
                <li>· профиля;</li>
                <li>· фурнитуры;</li>
                <li>· уплотняющей прокладки.</li>
            </ul>
            <p class="mb-1">По количеству створок, расположению <span class="strong-text">пластиковые окна</span> бывают одинарными, спаренными и раздельными. Благодаря створкам оконные конструкции фиксируются в разных направлениях: откидываются, вращаются вокруг вертикальной либо горизонтальной оси. С внешней стороны створки присутствует отлив, необходимый для защиты от влаги между рамой и створкой. В раму стеклопакет закрепляется при помощи штапиков. При изготовлении стеклопакетов используется энергоэффективный профиль ПВХ, имеющий специальную конструкцию и уплотнение. Внутри профиль содержит камеры, в одной из них имеется арматура оцинкованного листа. Использование армированной конструкции дает возможность стеклопакету быть устойчивым и сопротивляться ветровым нагрузкам.</p>
            <h2 class="title-post">Как выбрать пластиковые окна</h2>
            <p class="mb-1"></p>
            <p>На правильный выбор влияет несколько аспектов: выбор бренда, профильной системы, фурнитуры и уплотнителя, армирования, разновидности стекла. При выборе пластикового окна необходимо в первую очередь обратить внимание на профильную систему. Грамотно выбранный профиль – залог надежности и долговечности всей оконной конструкции. Арматура поддерживает оконную и дверную конструкцию в заданной форме.</p>
            <p>В выборе фурнитуры важно подходить ответственно. Частое открывание и закрывание способно вывести из строя любую оконную конструкцию.</p>
            <p>Также нужно подобрать качественный и надежный стеклопакет. От него зависит не только звукоизоляция, но и сохранение тепла в помещении. Использование некачественного стекла может вывести из строя даже самый лучший профиль и фурнитуру. Рекомендуется выбирать одно-, двухкамерные стеклопакеты по стандарту ГОСТ: с толщиной стекла не меньше 4 мм. Дополнительно учитывается качество уплотнителя, необходимого для герметизации рамы и стекла со створками.</p>
            <p>При покупке важно учесть все детали, чтобы не получить некачественный товар. Поэтому наша компания предлагает исключительно оригинальные <span class="strong-text">пластиковые окна от производителя в Киеве.</span></p>
            <h2 class="title-post">Сколько стоят пластиковые окна</h2>
            <p>На стоимость влияет несколько критериев:</p>
            <ol>
                <li>Выбор марки, вида стеклопакета.</li>
                <li>Разновидность профиля.</li>
                <li>Тип открывания створок.</li>
                <li>Использование противовзломной фурнитуры.</li>
                <li>Выбор декоративных опций.</li>
            </ol>
            <p class="mb-1">Наша компания предлагает купить по выгодной стоимости с доставкой <span class="strong-text">лучшие металлопластиковые окна в Украине.</span> Цены представлены на сайте в прайсе. Также узнать цену можно, позвонив по номеру телефона или через онлайн-чат.</p>
            <h2 class="title-post">Преимущества нашей компании</h2>
            <p class="mb-1">Мы представляем сертифицированный товар с гарантией европейского качества. Выполняем заказы в срок, индивидуально по нужным размерам. Наша компания предлагает своим клиентам следующие преимущества:</p>
            <ol>
                <li><span class="strong-text">Заказать окна в Киеве</span> по стандарту ГОСТ (высокий уровень звукоизоляции, теплопроводности, воздухообмена и противовзломности).</li>
                <li>Наши специалисты могут произвести демонтаж старого окна и установку нового.</li>
                <li>Оплата возможна любым удобным способом.</li>
                <li>Вы получите максимальное качественное обслуживание.</li>
                <li>При заказе прилагаются все необходимые документы.</li>
            </ol>
            <h2 class="title-post">Этапы установки окон</h2>
            <p class="mb-1">Установка осуществляется в несколько этапов:</p>
            <ol>
                <li>Снятие размера окна на объекте у клиента.</li>
                <li>Изготовление конструкции по индивидуальному заказу.</li>
                <li>Установка стеклопакета.</li>
            </ol>
            <p>На замере наш специалист выявляет возможные неровности проема, чтобы изготовить точный размер будущей конструкции. Замерщик определяет, какой крепеж будет монтироваться в окно. После чего с клиентом заключается официальный договор.</p>
            <p>Чтобы <span class="strong-text">купить металлопластиковые окна в Киеве</span>, следует обратиться к нашему менеджеру. Специалист проконсультирует в выборе оконной конструкции и просчитает предварительную стоимость вашего заказа.</p>
        </div>
    </section>
