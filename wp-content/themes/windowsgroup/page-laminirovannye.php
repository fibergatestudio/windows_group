...
<div class="main page-windows page-type-windows">
   ...
   <section class="section-table-price">
      <div class="container">
         <div class="top-post-page">
            <h1 class="title-post">Ламинированные ПВХ (пластиковые) окна в Киеве – цены</h1>
            <p class="text-custom-page">Ламинирование придает окнам стильность и необычность. Ламинация востребована при остеклении различных типов зданий.
                Популярны окна с имитацией разных древесных пород.
                Наша компания “Виндовс Груп” предлагает купить кламинированные окна высокого качества по выгодным ценам в Киеве и области.</p>
         </div>

         <?php 
            
            global $wpdb;
            $result_params = $wpdb->get_results("SELECT * FROM `{$wpdb -> prefix}window_prices` WHERE `page_name` = 'okna_laminirovannye' ");
               ...
               foreach ($price_obj->okno_gluhoe as $key_w => $value_w) {
                  if (is_object($value_w)) { ?>
                     ...
                     <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>" role="tabpanel" aria-labelledby="<?=$key_w?>">
                        <div class="table-tab">
                           <img src="<?php bloginfo('template_url') ?>/images/windows-close-lamin.52b9a7b5.png" class="img-type-lamin img-fluid" alt="photo">
         ...
         <div class="block-open">
            ...
            <div class="tab-content" id="myTabContent-open">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-open" role="tabpanel" aria-labelledby="<?=$key_w?>-open">
                  <div class="table-tab">
                     <img src="<?php bloginfo('template_url') ?>/images/windows-open-lamin.1fc2bbb7.png" class="img-type-lamin img-fluid" alt="photo">
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-DoubleOneOpening">
            ...
            <ul class="nav nav-tabs" id="myTab-DoubleOneOpening" role="tablist">
               ...
               <li class="nav-item"><a class="nav-link" id="opentek-DoubleOneOpening-tab" data-toggle="tab" href="#opentek-DoubleOneOpening" role="tab" aria-controls="opentek" aria-selected="false"><img src="<?php bloginfo('template_url') ?>/images/openteck-logo-1.c0ec51c2.svg" class="openteck-logo img-fluid" alt="photo"></a></li>
            ...
            <div class="tab-content" id="myTabContent-DoubleOneOpening">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-DoubleOneOpening" role="tabpanel" aria-labelledby="<?=$key_w?>-DoubleOneOpening">
                  <div class="table-tab">
                     <img src="<?php bloginfo('template_url') ?>/images/two-windows-oneopen-lamin.9647c009.png" class="img-type-lamin-2 img-fluid" alt="photo">
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-DoubleDoubleOpening">
            ...
            <div class="tab-content" id="myTabContent-DoubleDoubleOpening">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-DoubleDoubleOpening" role="tabpanel" aria-labelledby="<?=$key_w?>-DoubleDoubleOpening">
                  <div class="table-tab">
                     <img src="<?php bloginfo('template_url') ?>/images/two-windows-twoopen.1855dc3c.png" class="img-type-lamin-2 img-fluid" alt="photo">
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-DoubleT-OneOpening">
            ...
            <div class="tab-content" id="myTabContent-DoubleT-OneOpening">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-DoubleT-OneOpening" role="tabpanel" aria-labelledby="<?=$key_w?>-DoubleT-OneOpening">
                  <div class="table-tab">
                     <img src="<?php bloginfo('template_url') ?>/images/t-two-windows-oneopen-lamin.61577faa.png" class="img-type-lamin-2T img-fluid" alt="photo">
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-DoubleT-DoubleOpening">
            ...
            <div class="tab-content" id="myTabContent-DoubleT-DoubleOpening">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-DoubleT-DoubleOpening" role="tabpanel" aria-labelledby="<?=$key_w?>-DoubleT-DoubleOpening">
                  <div class="table-tab">
                     <img src="<?php bloginfo('template_url') ?>/images/t-two-windows-twoopen-lamin.972d0c3b.png" class="img-type-lamin-2T img-fluid" alt="photo">
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-ThreeOneOpening">
            ...
            <div class="tab-content" id="myTabContent-ThreeOneOpening">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-ThreeOneOpening" role="tabpanel" aria-labelledby="<?=$key_w?>-ThreeOneOpening">
                  <div class="table-tab">
                     <img src="<?php bloginfo('template_url') ?>/images/three-part-window.4d4c49a5.png" class="img-type-lamin-3 img-fluid" alt="photo">
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-ThreeDoubleOpening">
            ...
            <div class="tab-content" id="myTabContent-ThreeDoubleOpening">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-ThreeDoubleOpening" role="tabpanel" aria-labelledby="<?=$key_w?>-ThreeDoubleOpening">
                  <div class="table-tab">
                     <img src="<?php bloginfo('template_url') ?>/images/three-part-window-two.574ede62.png" class="img-type-lamin-3 img-fluid" alt="photo">
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
         ...
         <div class="block-ThreeT-OneOpening">
            ...
            <div class="tab-content" id="myTabContent-ThreeT-OneOpening">
               ...
               <div class="tab-pane fade show <?=($k===0)?'active':''?>" id="<?=$key_w?>-ThreeT-OneOpening" role="tabpanel" aria-labelledby="<?=$key_w?>-ThreeT-OneOpening">
                  <div class="table-tab">
                     <img src="<?php bloginfo('template_url') ?>/images/three-part-window-two-t.eb0b4cc8.png" class="img-type-lamin-3T img-fluid" alt="photo">
                     <table class="table-windows table-price-windows">
                        <thead>
                           <tr>
                              <td>Профиль</td>
      ...
      <div class="container">
         ...
         <ul class="list-top-product">
            ...
            <li class="block-item-product">
               ...
               <p>Сделайте пространство безопасным для здоровья и жизни ваших детей</p>
            </li>
         </ul>
      </div>
   </section>
   ...
   <section class="section-post section-post-windows">
      <div class="container">
         <h2 class="title-section">Виды ламинированных окон</h2>
         <p>Ламинация повторяет не только цвет, но и структуру разных материалов. Благодаря коэкструзии пластиковый материал имитирует натуральные деревянные изделия. Данная технология позволяет декорировать окна с учетом всех тонкостей стиля.</p>
         <p>Общая толщина многослойной пленки составляет 0,2 мм. Акриловая основа придает покрытию цвет и устойчивость к перегреву. Верхний слой обеспечивает блеск и защитный барьер от внешнего воздействия.</p>
         <p>Различают следующие виды ламинированных окон:</p>
         <ul>
            <li>· внутреннее одностороннее;</li>
            <li>· наружное одностороннее;</li>
            <li>· с двух сторон (внутри и снаружи);</li>
            <li>· в массе.</li>
         </ul>
         <p>Внутри ламинированного окна с одной стороны прикрепляется пленка на часть, развернутую в комнату. Данный вид ламинации позволяет комбинировать профили с различным интерьером.</p>
         <p>Наружная ламинация применяется в редких случаях. Оконная конструкция украшается так, чтобы подчеркнуть фасад здания.</p>
         <p>На двустаронние ламинированные окна ПВХ пленка наносится на наружную и внутреннюю части. Оконная конструкция может декорироваться пленкой разных цветов. Двусторонние ламинированные изделия по цене значительно выше аналогичных пластиковых конструкций.</p>
         <p>Ламинирование в массе – оклейка профиля с двух сторон и по торцу полимерной пленкой. Применение данного способа позволяет создать стиль в одном тоне. Единственным недостатком ламинации в массе является оформление только в коричневом цвете.</p>
         <p>Дополнительно ламинируются и стекла. При обработке стекла усиливается его ударопрочность и устойчивость.</p>
         <h2 class="title-post">Преимущества</h2>
         <p>Ламинированные пластиковые окна характеризуются следующими преимуществами:</p>
         <ul>
            <li>· надежностью;</li>
            <li>· долговечностью;</li>
            <li>· защитой от выцветания;</li>
            <li>· безопасностью;</li>
            <li>· устойчивостью к повреждениям;</li>
            <li>· влагостойкостью;</li>
            <li>· возможностью использования любого цвета;</li>
            <li>· простой эксплуатацией и уходом.</li>
         </ul>
         <p>В наших каталогах представлены оконные конструкции с ламинацией разной фактуры и цвета. Вы сможете подобрать изделие под любое интерьерное решение.</p>
         <h2 class="title-post">Кому подойдут</h2>
         <p>Ламинированные окна ПВХ применяются не только в мегаполисах, но и загородном строительстве. Оконные конструкции являются защитой от холода, звука и пыли. Цветные евроокна придают фасаду здания роскошный облик, сохраняя его первоначальный архитектурный вид.</p>
         <p>При выборе ламинированного окна следует обратить внимание на цвет:</p>
         <ol>
            <li>Для детской спальни подходят неяркие тона, для декора взрослой спальни – темные оттенки.</li>
            <li>Габаритные серые окна подчеркнут минималистичность стиля.</li>
            <li>Для небольших оконных конструкций предпочтительнее использовать теплые цвета.</li>
            <li>Темные тона не рекомендуется применять во фронтальной части здания из-за мрачного дизайна и быстрого нагрева рамы.</li>
         </ol>
         <p>Самыми востребованными древесными оттенками являются натуральный, портовый и мореный дуб, антик белый, махагон. Эти цвета обладают схожи с природными материалами. Универсальные зеленые и голубые окраски используются в любом типе построек.</p>
         <h2 class="title-post">Уход за ламинированными оконными конструкциями</h2>
         <p>Ухаживать за ламинированными оконами несложно. Главное правило – не использовать агрессивные моющие средства. Рекомендуется мыть стеклопакет специальным средством, предназначенным для очистки стекол. Запрещается тереть стеклопакеты и профиль грубыми щетками и губками из-за риска появления царапин и потертостей.</p>
         <h2 class="title-post">Стоимость</h2>
         <p>Цена ламинированного окна зависит от нескольких факторов:</p>
         <ul>
            <li>· модели и формы конструкции;</li>
            <li>· фурнитуры;</li>
            <li>· контурного уплотнителя;</li>
            <li>· механизма открывания;</li>
            <li>· декора (ручек, накладок на петли);</li>
            <li>· используемого стекла в стеклопакете;</li>
            <li>· типа ламинации;</li>
            <li>· дополнительных элементов (рольставни, жалюзи, решетки, подоконники, откосы, отливы, москитные сетки).</li>
         </ul>
         <p>Компания “Windows Group” предлагает заказать ламинированные пластиковые окна под дерево по лучшей стоимости от производителя в Украине. Узнать предварительную стоимость пластиковых оконных конструкций можно на сайте или позвонить по указанному телефону.</p>
      </div>
   </section>
   <section class="section-other-type-windows">
      <div class="container">
         ...
         <ul class="list-other-type-windows">
            ...
            <li class="item-other-type-windows"><img src="<?php bloginfo('template_url') ?>/images/ecern-windows.d7b8ef07.png" class="img-fluid" alt="photo"> <a href="<?=get_bloginfo('home')?>/plastikovye-okna/erkernye/" class="title-footer">Эркерные</a></li>
