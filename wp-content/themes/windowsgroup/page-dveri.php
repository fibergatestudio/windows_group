...
<div class="main page-aluminum-product">
   ...
   <section class="section-top-page">
      <div class="container">
         ...
         <h2 class="title-section">Алюминиевые двери в Киеве</h2>
         <div class="block-img-flout clearfix">
            <div class="block-img"><img src="<?php bloginfo('template_url') ?>/images/alyuminievye-dveri.91979347.jpg" class="img-door-top img-fluid" alt="photo-product"></div>
                 <p>
                     Алюминиевые двери – современное технологичное решение для зданий с высокими потребностями энергоэффективности. Наша компания «Windows Group» предлагает купить алюминиевые двери в Киеве и области по лучшей цене от производителя.
                 </p>
         </div>
         <ul class="list-type-standart-lux">
            <li class="item">
               ...
               <span class="item-price-custom"><span>от <span class="sum">3800 </span>грн / м2</span></span>
               <ul class="info">
            ...
            <li class="item">
               ...
               <span class="item-price-custom"><span>от <span class="sum">6500 </span>грн / м2</span></span>
               <ul class="info">
            ...
            <li class="item">
               ...
               <span class="item-price-custom"><span>от <span class="sum">7200 </span>грн / м2</span></span>
               <ul class="info">
   ...
   <section class="section-preference">
      <div class="container">
         <h2 class="title-section">Преимущества Дверей из Алюминия</h2>
   ...
   <section class="section-text">
      <div class="container">
         <h2 class="title-section">Характеристики</h2>
          <p>Дверные конструкции отличаются низкой массой, повышенной прочностью.
              Изделия из алюминия дешевле по цене, чем модели со стальной рамой. Однако это не снижает их надежности.
              Благодаря электростатическому напылению в комбинации с оксидной алюминиевой пленкой,
              наружная конструкция устойчива к атмосферному влиянию.
              Благодаря гибкому материалу изготавливаются любой формы и с разными механизмами открывания. Большой выбор цветов и оттенков позволяет воплотить в реальность интересные дизайнерские решения.
          </p>
      </div>
   </section>
   ...
   <section class="section-scheme-works">
    ...
    <section class="section-post section-post-windows section-other-type-windows">
        <div class="container">
            <h2 class="title-section">Преимущества алюминиевых дверей в Киеве</h2>
            <div class="text-custom-page">
                <p>Обустройство жилого помещения трудно представить без дверной конструкции. Двери из алюминия славятся преимуществами:</p>
                <ul>
                    <li>·         эстетичностью;</li>
                    <li>·         отсутствием негативного влияния на человека и окружающую среду;</li>
                    <li>·         прочностью и длительным сроком эксплуатации;</li>
                    <li>·         износоустойчивостью к температурным изменениям, высокой влажности, коррозии;</li>
                    <li>·         высоким уровнем шумозащиты;</li>
                    <li>·         простым уходом.</li>
                </ul>
                <p>За счет использования оригинальной фурнитуры алюминиевым конструкциям не требуется ремонт.</p>
                <h2 class="title-post">Виды алюминиевых дверей</h2>
                <p>Дверная конструкция различается по виду открывания механизма:</p>
                <ul>
                    <li>·         распашная;</li>
                    <li>·         маятниковая;</li>
                    <li>·         откатно-раздвижная.</li>
                </ul>
                <p>Стандартная распашная модель представляют собой полотно, смонтированное в коробку.
                    Конструкция открывается в определенную сторону, первоначально предусмотренную производителем, и применяется
                    в качестве входных или межкомнатных дверей.</p>
                <p>Маятниковые конструкции открываются/закрываются по обе стороны крепежа, расположенного на полу и потолке.
                    Механизм открывается наружу и внутрь.
                    Дополнительно маятниковая система оснащается доводчиком, посредством которого дверь после движения возвращается в изначальное положение.</p>
                <p>  Откатно-раздвижные изделия представляют собой двери-купе.
                    Открывание полотна происходит посредством перемещения полотна по роликовому механизму в сторону.
                    В некоторых дверных системах применяется безпороговое крепление, при котором дверь фиксируется и передвигается
                    при помощи верхней направляющей. Система удобная в использовании, позволяет освободить проем.</p>
                <p> Откатно-раздвижные модели оснащаются электронными доводчиками, открывающими конструкцию автоматически.
                    Кроме обычного дверного полотна применяется сборная и створчатая дверь. Такое устройство позволяет минимизировать площадь помещения.</p>
                <h2 class="title-post"> Где устанавливают</h2>
                <p>Двери из алюминиевого профиля устанавливаются в:</p>
                <ul>
                    <li>·         жилых помещениях;</li>
                    <li>·         кинотеатре;</li>
                    <li>·         концертном зале;</li>
                    <li>·         офисе;</li>
                    <li>·         торговых точках.</li>
                </ul>
                <p>
                    Конструкции, установленные при входе, имеют повышенную устойчивость. При большой проходимости здания возможен монтаж карусельного дверного типа с несколькими полотнами. Такое изделие обеспечивает защиту от холода и сквозняков.
                </p>
                <h2 class="title-post">Изготовление и монтаж</h2>
                <p>   Алюминиевые двери производятся из двух видов профиля: холодного и теплого.
                    При изготовлении конструкции холодного типа применяется профиль без применения термовставки.
                    Виды профиля различаются по ширине. Цена на алюминиевые двери зависит от используемого типа профиля.</p>
                <p>Холодные модели характеризуются низкой теплоизоляцией в особенности при отрицательной температуре.
                    Остекление конструкций осуществляется по системе холодного остекления.</p>
                <p>
                    Этот тип применяется в неотапливаемых помещениях. Обычно конструкция используется для межкомнатного перехода, при условии постоянной одинаковой температуры и отсутствия сохранения тепла. К примеру, на летней террасе, веранде, в беседках.
                </p>
                <p>
                    Теплые модели алюминиевых дверей производятся с применением профиля с теплоизолирующей вставкой. Теплые изделия монтируются в местах, где необходима теплоизоляция. Профессиональный монтаж – залог долговечности изделия. Самостоятельная установка не гарантирует герметичность конструкции.
                </p>
                <p>
                    Компания Виндовс Груп предлагает заказать алюминиевые двери в Киеве по цене с доставкой, монтажом и гарантией. Узнать стоимость можно на сайте  или, позвонив по указанному телефону.
                </p>
            </div>
        </div>
    </section>
